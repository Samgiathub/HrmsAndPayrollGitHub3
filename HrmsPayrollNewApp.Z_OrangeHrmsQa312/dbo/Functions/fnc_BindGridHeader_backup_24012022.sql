create function [dbo].[fnc_BindGridHeader_backup_24012022]()        
returns varchar(max)        
as        
BEGIN      
...
declare @PivotColDedVar as NVARCHAR(MAX)          
  ...
  select @lResult3 = @lResult3 + '<tr><th width="10%">Section</th><th width="10%">Goal</th><th width="10%">SubGoal</th><th width="10%">Type</th>'+ isnull(@PivotColDedVar,'') +' G1' + isnull(@PivotColDedVar2,'') + 'G2'+'<th>Target</th></tr>'        
