--select [dbo].[F_GET_AGE] ('2005-05-01 00:00:00.000','2006-06-30 00:00:00.000','Y','M')
--select [dbo].[F_GET_AGE] ('2008-06-01 00:00:00.000','2011-05-31 00:00:00.000','Y','M')

CREATE FUNCTION [dbo].[F_GET_AGE] 
	(
...
AS
		...
		--declare @Age int
		  ...
		  return cast(@Ayr as varchar(5))+'.'+ case when @Am < 10 then '0' + cast(@Am as varchar(5)) else cast(@Am as varchar(5)) END
