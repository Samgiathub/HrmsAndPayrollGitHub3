...
CREATE FUNCTION [dbo].[F_Get_Claim_Types_backup_mehul_09122021_latest]
(
	@Emp_ID		numeric,
	@Cmp_ID		numeric,
	@For_Date	DATETIME
...
BEGIN 
	...
	select @gradeid = Grd_ID from T0080_EMP_MASTER where Emp_ID = @Emp_ID and Cmp_ID = @Cmp_ID
