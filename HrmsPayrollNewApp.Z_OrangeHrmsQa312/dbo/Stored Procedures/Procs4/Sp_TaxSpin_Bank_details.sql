...
CREATE PROCEDURE [dbo].[Sp_TaxSpin_Bank_details]      
@Cmp_ID AS INT          
 ,@Emp_Id AS INT          
...
,( '="' + RIGHT('' + CONVERT(VARCHAR, i.Inc_Bank_AC_No), 15)+ '"') AS [Account Number]    
 ...
 ,CASE 
  ...
  INNER JOIN T0040_BANK_MASTER b WITH (NOLOCK) ON I.Bank_Id = b.Bank_Id and b.Bank_Name = 'Axis'   OR b.Bank_Name = 'Axis Bank'  
