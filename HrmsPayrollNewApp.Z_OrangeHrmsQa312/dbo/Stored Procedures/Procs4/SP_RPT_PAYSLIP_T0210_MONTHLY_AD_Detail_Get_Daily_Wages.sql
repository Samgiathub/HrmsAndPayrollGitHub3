...
CREATE PROCEDURE [dbo].[SP_RPT_PAYSLIP_T0210_MONTHLY_AD_Detail_Get_Daily_Wages]
 @Cmp_ID   numeric        
,@From_Date  datetime        
,@To_Date   datetime        
,@Branch_ID  numeric        
...
,@Sal_Type  numeric =0      
,@Salary_Cycle_id numeric = NULL -- Added By Gadriwala Muslim 21082013
...
SET ARITHABORT ON       
 ...
 Select Emp_full_Name,Grd_Name,Comp_Name,Branch_Address,EMP_CODE,Type_Name,Dept_Name,Desig_Name,(AD_Name + ' (' + isnull(ADM.ad_mode,'Rs.') + ') ')as AD_Name ,AD_LEVEL ,
 MAD.Emp_ID,Mad.Cmp_ID,Mad.AD_ID,Mad.Sal_Tran_ID,MAD.AD_Description,Mad.AD_Amount, dbo.F_Remove_Zero_Decimal(MAd.AD_Actual_Amount) as AD_Actual_Amount,Mad.AD_Calculated_Amount,MAD.For_Date,Mad.For_Date,
 MAd.M_AD_Flag,MAD.Loan_Id,MAd.Def_ID,BM.Branch_ID,E.Alpha_Emp_Code        
  ...
  WHERE E.Cmp_ID = @Cmp_Id   and Month(For_date) =Month(@To_Date) and Year(For_date) = Year(@To_Date)  --and For_date >=@From_Date and For_date <=@To_Date        
