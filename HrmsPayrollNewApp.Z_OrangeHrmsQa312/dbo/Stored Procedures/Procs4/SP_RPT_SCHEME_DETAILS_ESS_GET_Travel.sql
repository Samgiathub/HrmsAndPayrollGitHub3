    -- exec SP_RPT_SCHEME_DETAILS_ESS_GET_Travel @Cmp_ID=270,@From_Date='2024-01-05 14:44:24',@To_Date='2024-01-05 14:44:24',@Branch_ID=0,@Cat_ID=0,@Grd_ID=0,@Type_ID=0,@Dept_ID=0,@Desig_ID=0,@Emp_ID=0,@Constraint='30067'	
      
CREATE PROCEDURE [dbo].[SP_RPT_SCHEME_DETAILS_ESS_GET_Travel]      
  @Cmp_ID  Numeric      
 ,@From_Date  Datetime      
 ,@To_Date  Datetime      
 ,@Branch_ID  Numeric       
