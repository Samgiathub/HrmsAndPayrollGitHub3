...
CREATE PROCEDURE [dbo].[SP_Mobile_HRMS_WebService_DASHBOARD_test]
	@Emp_ID numeric(18,0),
	@Cmp_ID numeric(18,0)
AS
...
EXEC Mobile_HRMS_SP_RPT_EMP_IN_OUT_MUSTER_HOME_GET_TEST @Cmp_ID = @Cmp_ID,@From_Date = @FromDate,@To_Date = @ToDate,@Branch_ID=@Branch_ID,
