...
CREATE PROCEDURE [dbo].[SP_RPT_EMP_LOAN_PAYMENT_SUMMARY_GET]
 @Cmp_ID 		numeric
,@From_Date 	datetime
,@To_Date 		datetime
,@Branch_ID 	numeric
...
AS
	...
	Select MLD.*,Emp_full_Name,Grd_Name,EMP_CODE,Type_Name,Dept_Name,Desig_Name,LOAN_NAME
			,Loan_apr_amount,Loan_Apr_pending_amount
		 From T0210_MONTHLY_LOAN_PAYMENT MLD WITH (NOLOCK) Inner join 
			  T0120_LOAN_APPROVAL LA WITH (NOLOCK) ON MLD.LOAN_APR_ID = LA.LOAN_APR_ID INNER JOIN 
