CREATE PROCEDURE [dbo].[SP_RPT_EMP_INOUT_RECORD_GET_06042021] 
	@Cmp_ID			numeric,      
	@From_Date		DATETIME,      
	@To_Date		DATETIME ,      
	@Branch_ID		numeric   ,      
									...
									if exists (select 1 from ##TCol)
										begin
											set @qry = 'SELECT  ROW_NUMBER() OVER(
														...
														,Branch_Name,BM.Comp_Name, BM.Branch_Address,DM.Desig_Dis_No,vs.Vertical_Name,sv.SubVertical_Name
														...
														,TC.HOD_Details
														,BM.Branch_Name
														,Qry_Reporting.Emp_Full_Name as Imm_Supervisor
