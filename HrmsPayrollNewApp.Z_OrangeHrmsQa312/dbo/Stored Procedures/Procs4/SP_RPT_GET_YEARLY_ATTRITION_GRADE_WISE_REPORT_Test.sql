...
CREATE PROCEDURE [dbo].[SP_RPT_GET_YEARLY_ATTRITION_GRADE_WISE_REPORT_Test]
	 @CMP_ID 		NUMERIC
	,@FROM_DATE 	DATETIME
	,@TO_DATE 		DATETIME
	,@BRANCH_ID 	NUMERIC
...
-- FROM #YEARLY_ATTRITION_REPORT					
	...
	INSERT INTO Test123
	SELECT * FROM #GRAPH_CHART

	If @Graph =1
			
			SELECT * FROM Test123
		--SELECT MONTH_NAME,ATTRITION_VALUE FROM Test123 --where SORTING_NO > =month(@FROM_DATE) and SORTING_NO<=month(@TO_DATE)
