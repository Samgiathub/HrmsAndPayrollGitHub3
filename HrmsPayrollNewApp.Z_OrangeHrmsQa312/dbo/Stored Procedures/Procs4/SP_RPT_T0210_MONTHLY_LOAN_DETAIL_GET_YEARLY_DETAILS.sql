...
CREATE PROCEDURE [dbo].[SP_RPT_T0210_MONTHLY_LOAN_DETAIL_GET_YEARLY_DETAILS]
 @Cmp_ID 		numeric
,@From_Date 	datetime
,@To_Date 		datetime
--,@Branch_ID 	numeric
...
if @Segment_Id = 0 
  ...
  set @SubVertical_Id= Null */
	...
	exec SP_RPT_FILL_EMP_CONS_MULTIDROPDOWN @Cmp_ID,@From_Date,@To_Date,@Branch_ID,@Cat_ID,@Grd_ID,@Type_ID,@Dept_ID,@Desig_ID,@Emp_ID,@constraint,0,@Salary_Cycle_id,@Segment_Id,@Vertical_Id,@SubVertical_Id,'',0,0,0,'0',0,0
	--================================================================================================================================================================================================
	if @Report_Type=''
	begin
		...
		Select distinct (select Alpha_Emp_Code from T0080_emp_Master Where emp_id=MLD.Emp_ID) as Alpha_Emp_Code,MLD.For_Date
		,MLD.Adv_Closing
		...
		--------------------------------------------------------------------------------------------------------------------------------
		 select  E.alpha_Emp_code as Alpha_Emp_code ,e.Emp_full_Name
		 ,DM.Dept_Name
		
		 ,Sum(LQry.Loan_Closing) as Loan_Pending_Amount
		 ,ap1.Adv_Closing
		 ,(Sum(LQry.Loan_Closing)+ap1.Adv_Closing)as 'Total Pending Amount'
			...
			(select I.Emp_Id , Grd_ID,Cmp_ID,Branch_ID,Cat_ID,Desig_ID,Dept_ID,Type_ID,Increment_effective_Date from dbo.T0095_Increment I WITH (NOLOCK) inner join 
				...
				group by E.alpha_Emp_code,e.Emp_full_Name,DM.Dept_Name,Ap1.Alpha_Emp_Code,ap1.Adv_Closing--,LM.LOAN_NAME
