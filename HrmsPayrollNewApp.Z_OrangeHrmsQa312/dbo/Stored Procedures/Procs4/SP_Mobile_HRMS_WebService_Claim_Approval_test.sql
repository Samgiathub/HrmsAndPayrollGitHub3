...
CREATE PROCEDURE [dbo].[SP_Mobile_HRMS_WebService_Claim_Approval_test]
...
ELSE IF @Type='AD' -- GET CLAIM APPROVAL DETAILS 
		BEGIN
					...
					SELECT distinct Emp_ID,CMP_ID,CLAIM_APP_ID,CLAIM_ID,FOR_DATE,CLAIM_NAME,PETROL_KM,TOTALAMOUNT
