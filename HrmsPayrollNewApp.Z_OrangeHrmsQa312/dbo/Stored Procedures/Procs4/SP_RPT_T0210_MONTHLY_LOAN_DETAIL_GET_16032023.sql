...
Create PROCEDURE [dbo].[SP_RPT_T0210_MONTHLY_LOAN_DETAIL_GET_16032023]
 @Cmp_ID 		numeric
,@From_Date 	datetime
,@To_Date 		datetime
,@Branch_ID 	numeric
	...
	--================================================================================================================================================================================================
		...
		,cm.Cmp_Address
			...
			(select I.Emp_Id , Grd_ID,Cmp_ID,Branch_ID,Cat_ID,Desig_ID,Dept_ID,Type_ID,Increment_effective_Date from dbo.T0095_Increment I WITH (NOLOCK) inner join 
				...
				group by E.alpha_Emp_code,e.Emp_full_Name,DM.Dept_Name,Ap1.Alpha_Emp_Code,ap1.Adv_Closing,cm.Cmp_name,cm.Cmp_Address--,LM.LOAN_NAME
	--=========================================================================================================================
		END	
