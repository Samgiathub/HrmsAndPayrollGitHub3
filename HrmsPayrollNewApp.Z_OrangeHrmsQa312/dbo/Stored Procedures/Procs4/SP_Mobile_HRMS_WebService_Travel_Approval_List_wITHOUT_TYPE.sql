...
CREATE PROCEDURE [dbo].[SP_Mobile_HRMS_WebService_Travel_Approval_List_wITHOUT_TYPE]
	@Cmp_Id int,
	@Emp_ID	Numeric(18,0),
														...
														If @Rpt_level = 1
															Begin
																...
																'Select LAD.Travel_Application_ID, ' + Cast(@Scheme_ID As Varchar(3)) + ' As Scheme_ID, ''' + @Leave + ''' As Leave , '  +   cast(@Rpt_level as VARCHAR(2)) +
																	 ' From V0100_TRAVEL_APPLICATION_Without_TravelType LAD
					...
					Begin
						...
						Insert INTO #Travel
							Select distinct	
								...
								,LAD.Desig_Name, LAD.Alpha_Emp_code,Application_Date,LAD.Application_Status
								,LAD.Travel_Set_Application_id,LAD.travel_approval_id as Travel_approval_id
								,isnull(Qry1.rpt_level + 1,'1') As Rpt_Level, TLAP.Scheme_ID, SL.Final_Approver,SL.Is_Fwd_Leave_Rej,Travel_Type_Name,Travel_Type_Id,emp.Grd_ID
								From V0100_TRAVEL_APPLICATION_Without_TravelType LAD
				...
				Else
					Begin
						...
						Insert INTO #Travel
							Select distinct	
								LAD.Emp_ID, LAD.Emp_Full_Name, LAD.Supervisor,LAD.Travel_Application_ID, LAD.Application_Code ,LAD.Branch_Name
								,LAD.Desig_Name, LAD.Alpha_Emp_code,convert(varchar,Application_Date,103) as Application_Date,LAD.Application_Status
								,LAD.Travel_Set_Application_id,LAD.travel_approval_id as Travel_approval_id
								,isnull(Qry1.rpt_level + 1,'1') As Rpt_Level,'0' as Scheme_ID, '1' as Final_Approver, '0' as Is_Fwd_Leave_Rej,Travel_Type_Name,Travel_Type_Id,emp.Grd_ID
							From V0100_TRAVEL_APPLICATION_Without_TravelType LAD
