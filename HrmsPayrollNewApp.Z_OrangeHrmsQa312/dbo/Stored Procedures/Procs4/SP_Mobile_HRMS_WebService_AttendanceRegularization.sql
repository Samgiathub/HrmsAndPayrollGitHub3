CREATE PROCEDURE [dbo].[SP_Mobile_HRMS_WebService_AttendanceRegularization]    
...
ELSE IF @Type = 'T' -- My Team Attendance    
 ...
 Select     
 E.R_Emp_ID,T.emp_id,I.Increment_ID,I.Branch_ID,E.Reporting_Method,I.Sales_Code,T.Date_Of_Join,I.CTC--,T.Desig_Id -- Added by Divyaraj Kiri on 16/01/2024    
 INTO #Emp_Cons    
 FROM T0080_EMP_MASTER  T WITH (NOLOCK)    
   ...
   INNER JOIN (    
      SELECT INCREMENT_ID,I.Emp_ID,I.Cmp_ID,I.Branch_ID , I.Sales_Code,I.CTC--,I.Desig_Id -- Added by Divyaraj Kiri on 16/01/2024    
