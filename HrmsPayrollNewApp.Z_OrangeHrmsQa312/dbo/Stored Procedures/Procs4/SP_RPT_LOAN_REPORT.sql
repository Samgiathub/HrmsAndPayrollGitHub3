...
CREATE PROCEDURE [dbo].[SP_RPT_LOAN_REPORT]
...
SET ARITHABORT ON
 ...
 if @Constraint <> ''      
  ...
  End      
	...
	Select EL.Loan_Number,EL.Loan_Apr_Date,EL.Loan_Apr_Installment_Amount,LM.Loan_name ,E.Emp_Code, cast( E.Emp_Code as varchar) + ' - '+E.Emp_Full_Name as Emp_Full_Name,E.Emp_Full_Name as Emp_Full_Name_only,Emp_superior      
  ...
  WHERE E.Cmp_ID = @Cmp_Id   AND loan_apr_Date >= @From_Date and Loan_Apr_Date <= @To_Date
