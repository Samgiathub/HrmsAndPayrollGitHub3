...
CREATE PROCEDURE [dbo].[SP_RPT_EMP_INSURANCE_RECORD_GET_bkRB200624]
	 @Cmp_ID		numeric
	,@From_Date		datetime
	,@To_Date		datetime 
	--,@Branch_ID		numeric   = 0
	...
	CREATE TABLE #Emp_Cons -- Ankit 08092014 for Same Date Increment
	 (      
	   ...
	   Increment_ID numeric    
	 	...
	 	exec SP_RPT_FILL_EMP_CONS_MULTIDROPDOWN @Cmp_ID,@From_Date,@To_Date,@Branch_ID,@Cat_ID,@Grd_ID,@Type_ID,@Dept_ID,@Desig_ID,@Emp_ID,@constraint,0,0,'',@Vertical_Id,@SubVertical_Id,'',@New_Join_emp,@Left_Emp,0,'0',0,0,@Bank_ID  --Change By Jaina 1-10-2015
