...
Create PROCEDURE [dbo].[SP_RPT_Attandance_Regularization_Get_bkronak160424]
	 @Cmp_ID 		numeric
	,@From_Date		datetime
	,@To_Date 		datetime
	,@Branch_ID		numeric
		...
		begin
			...
			Else
				Begin			
						...
						select VLM.*,BM.Branch_Name,Cm.Cmp_Name ,cm.cmp_address,@From_Date as P_From_Date,@To_Date as P_To_Date
		...
		begin
			...
			Else
				Begin	
					...
					LEFT JOIN T0080_EMP_MASTER EM WITH (NOLOCK) ON SD.APP_EMP_ID = EM.EMP_ID
