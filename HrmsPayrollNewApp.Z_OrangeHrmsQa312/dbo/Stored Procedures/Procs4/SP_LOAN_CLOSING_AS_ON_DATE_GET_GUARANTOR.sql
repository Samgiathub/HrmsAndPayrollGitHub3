...
-- =============================================
-- Author:		<Ankit>
-- Create date: <08042014,,>
-- Description:	<Description,,>
-- =============================================

CREATE PROCEDURE [dbo].[SP_LOAN_CLOSING_AS_ON_DATE_GET_GUARANTOR]
	 @Cmp_ID		numeric
	,@To_Date		datetime 
	,@Branch_ID		numeric   = 0
	,@Cat_ID		numeric  = 0
...
AS
	...
	if @Constraint <> ''
		...
		Insert into @Loan_closing (Cmp_ID ,Emp_Id,Loan_Id,Loan_Apr_Id,Loan_Issue,For_Date,Loan_Return,Loan_Closing)
		select Cmp_ID , Emp_ID ,Loan_Id ,Loan_Apr_ID , Loan_Apr_Amount , @To_Date ,0 ,0 From dbo.T0120_Loan_Approval WITH (NOLOCK)
