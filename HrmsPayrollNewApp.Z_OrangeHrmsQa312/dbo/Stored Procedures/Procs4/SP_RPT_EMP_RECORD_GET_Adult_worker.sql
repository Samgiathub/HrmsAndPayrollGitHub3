CREATE PROCEDURE SP_RPT_EMP_RECORD_GET_Adult_worker
  @Cmp_ID  numeric        
 ,@From_Date  datetime        
 ,@To_Date  datetime         
...
BEGIN
print 123
  EXEC SP_EMP_SALARY_Constraint @Cmp_ID, @From_Date,@To_Date,0,@Cat_ID,@Grd_ID,@Type_ID,@Dept_ID ,@Desig_ID,@Emp_ID,@Salary_Cycle_id ,@Branch_ID,@Segment_ID,@Vertical_Id,@SubVertical_Id,@subBranch_Id,@Constraint --addedby mansi 
