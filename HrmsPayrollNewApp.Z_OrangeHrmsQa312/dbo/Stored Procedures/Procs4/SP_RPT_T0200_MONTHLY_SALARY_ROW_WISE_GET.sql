...
CREATE PROCEDURE [dbo].[SP_RPT_T0200_MONTHLY_SALARY_ROW_WISE_GET]
  @Cmp_ID		numeric  
 ,@From_Date	datetime  
 ,@To_Date		datetime  
 ,@Branch_ID	numeric  
...
SET ARITHABORT ON 
 ...
 if @Constraint <> ''  
  ...
  Insert into @Emp_Salary ( Cmp_ID,Emp_ID,Sal_Tran_ID,Increment_ID,Sal_Month,Sal_Year,Salary_Amount,Allowance_1,Allowance_2,Allowance_3,Allowance_4,Allowance_5,Allowance_6,  
         ...
         Adv_Amount,Loan_Amount,Deduction_1,Deduction_2,Deduction_3,Deduction_4,Deduction_5 ,Other_Dedu_Amount,Net_Amount,Sal_cal_Days,Total_claim_Amount,Total_Dedu_Amount,P_Day,Ab_Day,Holiday,Weekoff_Day,OT_Amount,Total_Leave_Days )  
