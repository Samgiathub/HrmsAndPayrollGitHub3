CREATE PROCEDURE [dbo].[SP_RPT_EMP_ATTENDANCE_MUSTER_GET_Backup_Divyaraj_23072024]
	 @Cmp_ID 		numeric
	,@From_Date		datetime
	,@To_Date 		datetime
	,@Branch_ID		numeric
	...
	if @Late_Early_Ded_Combine = 1
			...
			begin
					...
					begin
							...
							exec rpt_Late_Early_Mark_Combine_Deduction @Cmp_ID,@From_Date,@To_Date,@Branch_ID,@Cat_ID,@Grd_ID,@Type_ID,@Dept_ID,@Desig_ID,@Emp_ID
							,@constraint,1
