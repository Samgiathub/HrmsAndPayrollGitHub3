...
CREATE PROCEDURE [dbo].[SP_Rpt_Pay_Bill_Report]
	@Cmp_ID Numeric(18),
	@From_Date Datetime,
	@To_Date Datetime,
	@Dept_ID Numeric(18)
...
SET ARITHABORT ON
	...
	open Cur_Rport_Head
		...
		Select AD.To_Date,AD.Dept_ID,DM.Dept_Name,HM.Report_Header_Name,AD.AD_ID,AD.AD_Sort_Name,AD.Report_ID,AD.Employee_Type,
		AD.Flag,AD.AD_Amount,AD.Total_Amt,AD.Sorting_No,AD.Gross_Amt,AD.Recoveries_Amt From #Allowance_Details AD 
		...
		Select DISTINCT AD.To_Date,AD.Dept_ID,DM.Dept_Name,HM.Report_Header_Name,AD.AD_ID,AD.AD_Sort_Name,AD.Report_ID,'' as Employee_Type,
		AD.Flag,Qry.AD_Amount,Qry.Total_Amt,'' as Sorting_No From #Allowance_Details AD
		Inner JOIN(SELECT SUM(AD.AD_Amount) as AD_Amount,SUM(AD.Total_Amt) as Total_Amt , AD_ID,AD_Sort_Name,Dept_ID,Report_ID 
		           From #Allowance_Details AD where Report_ID = 1 
		           GROUP BY AD_ID,AD_Sort_Name,Dept_ID,Report_ID) as Qry
		ON Qry.AD_ID = AD.AD_ID and Qry.Report_ID = AD.Report_ID
		Inner JOIN T0030_Report_Header_Master HM WITH (NOLOCK) ON AD.Report_ID = HM.Report_Id
		Inner JOIN T0040_DEPARTMENT_MASTER DM WITH (NOLOCK) ON DM.Dept_Id = AD.Dept_ID 
		where AD.Report_ID = 1 and AD.AD_Amount <> 0 order BY AD.AD_ID DESC
		
		Select AD.To_Date,AD.Dept_ID,DM.Dept_Name,HM.Report_Header_Name,AD.AD_ID,AD.AD_Sort_Name,AD.Report_ID,'' as Employee_Type,
		AD.Flag,SUM(AD.AD_Amount) as AD_Amount ,SUM(AD.Total_Amt) as Total_Amt ,AD.Sorting_No From #Allowance_Details AD 
		Inner JOIN T0030_Report_Header_Master HM WITH (NOLOCK) ON AD.Report_ID = HM.Report_Id
		Inner JOIN T0040_DEPARTMENT_MASTER DM WITH (NOLOCK) ON DM.Dept_Id = AD.Dept_ID 
		where AD.Report_ID = 2 and AD.AD_Amount <> 0
		Group BY AD.To_Date,AD.Dept_ID,DM.Dept_Name,HM.Report_Header_Name,AD.AD_ID,AD.AD_Sort_Name,AD.Report_ID,
		AD.Flag,AD.Sorting_No order by Total_Amt
		
		Select AD.To_Date,AD.Dept_ID,DM.Dept_Name,HM.Report_Header_Name,AD.AD_ID,AD.AD_Sort_Name,AD.Report_ID,'' as Employee_Type,
		AD.Flag,SUM(AD.AD_Amount) as AD_Amount ,SUM(AD.Total_Amt) as Total_Amt,AD.Sorting_No From #Allowance_Details AD 
		Inner JOIN T0030_Report_Header_Master HM WITH (NOLOCK) ON AD.Report_ID = HM.Report_Id
		Inner JOIN T0040_DEPARTMENT_MASTER DM WITH (NOLOCK) ON DM.Dept_Id = AD.Dept_ID 
		where AD.Report_ID = 3 and AD.AD_Amount <> 0
		Group BY AD.To_Date,AD.Dept_ID,DM.Dept_Name,HM.Report_Header_Name,AD.AD_ID,AD.AD_Sort_Name,AD.Report_ID,
		AD.Flag,AD.Sorting_No order by Total_Amt
		...
		--Select AD.To_Date,AD.Dept_ID,DM.Dept_Name,HM.Report_Header_Name,AD.AD_ID,AD.AD_Sort_Name,AD.Report_ID, '' as Employee_Type,
		--AD.Flag,SUM(AD.AD_Amount) as AD_Amount,SUM(AD.Total_Amt) as Total_Amt,AD.Sorting_No From #Allowance_Details AD 
		--Inner JOIN T0030_Report_Header_Master HM ON AD.Report_ID = HM.Report_Id
		--Inner JOIN T0040_DEPARTMENT_MASTER DM ON DM.Dept_Id = AD.Dept_ID 
		--where AD.Report_ID = 10  and AD.AD_Amount <> 0
		--Group BY AD.To_Date,AD.Dept_ID,DM.Dept_Name,HM.Report_Header_Name,AD.AD_ID,AD.AD_Sort_Name,AD.Report_ID,
		--AD.Flag,AD.Sorting_No
		
		Select DISTINCT AD.To_Date,AD.Dept_ID,DM.Dept_Name,HM.Report_Header_Name,0 as AD_ID,AD.AD_Sort_Name,AD.Report_ID,'' as Employee_Type,
		AD.Flag,SUM(Qry.AD_Amount) as AD_Amount,Qry.Total_Amt,'' as Sorting_No From #Allowance_Details AD
		Inner JOIN(SELECT SUM(AD.AD_Amount) as AD_Amount,SUM(AD.Total_Amt) as Total_Amt , AD_ID,AD_Sort_Name,Dept_ID,Report_ID 
		           From #Allowance_Details AD where Report_ID = 10 
		           GROUP BY AD_ID,AD_Sort_Name,Dept_ID,Report_ID) as Qry
		ON Qry.AD_ID = AD.AD_ID and Qry.Report_ID = AD.Report_ID
		Inner JOIN T0030_Report_Header_Master HM WITH (NOLOCK) ON AD.Report_ID = HM.Report_Id
		Inner JOIN T0040_DEPARTMENT_MASTER DM WITH (NOLOCK) ON DM.Dept_Id = AD.Dept_ID 
		...
		Inner JOIN T0030_Report_Header_Master HM WITH (NOLOCK) ON AD.Report_ID = HM.Report_Id
		Inner JOIN T0040_DEPARTMENT_MASTER DM WITH (NOLOCK) ON DM.Dept_Id = AD.Dept_ID 
		where AD.Report_ID = 11 and AD.AD_Amount <> 0
		Group BY AD.To_Date,AD.Dept_ID,DM.Dept_Name,HM.Report_Header_Name,AD.AD_ID,AD.AD_Sort_Name,AD.Report_ID,
		AD.Flag,AD.Sorting_No order by Total_Amt
		...
		Inner JOIN T0030_Report_Header_Master HM WITH (NOLOCK) ON AD.Report_ID = HM.Report_Id
		Inner JOIN T0040_DEPARTMENT_MASTER DM WITH (NOLOCK) ON DM.Dept_Id = AD.Dept_ID 
		where AD.Report_ID = 6 and AD.AD_Amount <> 0
		Group BY AD.To_Date,AD.Dept_ID,DM.Dept_Name,HM.Report_Header_Name,AD.AD_ID,AD.AD_Sort_Name,AD.Report_ID,
		AD.Flag,AD.Sorting_No order by Total_Amt
		...
		Inner JOIN T0030_Report_Header_Master HM WITH (NOLOCK) ON AD.Report_ID = HM.Report_Id
		Inner JOIN T0040_DEPARTMENT_MASTER DM WITH (NOLOCK) ON DM.Dept_Id = AD.Dept_ID 
		where AD.Report_ID = 12 and AD.AD_Amount <> 0
		Group BY AD.To_Date,AD.Dept_ID,DM.Dept_Name,HM.Report_Header_Name,AD.AD_ID,AD.AD_Sort_Name,AD.Report_ID,
		AD.Flag,AD.Sorting_No order by Total_Amt
		...
		Inner JOIN T0030_Report_Header_Master HM WITH (NOLOCK) ON AD.Report_ID = HM.Report_Id
		Inner JOIN T0040_DEPARTMENT_MASTER DM WITH (NOLOCK) ON DM.Dept_Id = AD.Dept_ID 
		where AD.Report_ID = 8 --and AD.AD_Amount <> 0
		Group BY AD.To_Date,AD.Dept_ID,DM.Dept_Name,HM.Report_Header_Name,AD.AD_ID,AD.AD_Sort_Name,AD.Report_ID,
		AD.Flag,AD.Sorting_No order by Total_Amt
