...
CREATE PROCEDURE [dbo].[Sp_TaxSpin_Bank_details_BK010225]      
@Cmp_ID AS INT          
 ,@Emp_Id AS INT          
...
BEGIN          
 ...
 BEGIN          
  SELECT CASE           
   ...
   ---,cast(i.Inc_Bank_AC_No as varchar(50)) AS [Account No]        
     --,RIGHT('000000000000000' + CONVERT(VARCHAR, i.Inc_Bank_AC_No), 10) AS [Account No]      
 ,( '="' + RIGHT('000000000000000' + CONVERT(VARCHAR, i.Inc_Bank_AC_No), 15)+ '"') AS [Account No]    
   ,NULL AS [Email]          
   ,NULL AS [Email Body]          
