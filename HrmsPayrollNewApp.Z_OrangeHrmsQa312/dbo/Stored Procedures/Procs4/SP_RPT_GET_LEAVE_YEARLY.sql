...
CREATE PROCEDURE [dbo].[SP_RPT_GET_LEAVE_YEARLY]
	 @Cmp_ID 		NUMERIC
	,@FROM_Date 	datetime
	,@To_Date 		datetime
	,@Branch_ID 	NUMERIC
...
SET ARITHABORT ON
	...
	SELECT  YS.*,LM.lEave_Code,ELB.Leave_Opening,ELB.Leave_Encash_Days,ELB.Leave_Closing,Grd_NAme,Dept_Name,Comp_name,Branch_Address,Desig_Name,Branch_NAme,VS.Vertical_Name
	,SV.SubVertical_Name,SB.SubBranch_Name,Type_Name,
