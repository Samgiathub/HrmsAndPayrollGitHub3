...
CREATE PROCEDURE [dbo].[P0040_CLAIM_MASTER_09122021]
	  @Claim_ID numeric(18) output
	 ,@Cmp_ID numeric(18,0)
	 ,@Claim_Name varchar(50)
	 ,@Claim_Max_Limit numeric(18,2)
		...
		begin
			...
			if exists (Select Claim_ID  from T0040_claim_master WITH (NOLOCK) Where Upper(Claim_Name) = Upper(@Claim_Name)and Cmp_ID = @Cmp_ID) 
				...
				begin
					...
					Claim_ForMonth,Age_Wise_Limit,Unit_Id,Bill_Id,Claim_ApplicableOnceBasedOnLimit,Grade_Age_Limit,After_Joining_Days) 
					...
					@ClaimMonth,@AgeWiseLimit,@UnitId,@BillTypeId,@ApplicableBasedOnLimit,@GradeAgeLimit,@AfterJoiningDays)
