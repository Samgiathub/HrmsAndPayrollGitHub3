--USE [Orange_Hrms_QA_312]

---exec P0000_Default_Form_New 1
create PROCEDURE [dbo].[P0000_Default_Form_New_Changes_backup_08052024]
...
--INSERT INTO [dbo].[T0000_DEFAULT_FORM]([Form_ID], [Form_Name], [Under_Form_ID], [Sort_ID], [Form_Type], [Form_url], [Form_Image_url], [Is_Active_For_menu], [Alias])values(6042, N'Employee', -1, 65, 1, N'Employee_Tracking.aspx', @Employee_Img, 1, N'Employee')
...
INSERT INTO [dbo].[T0000_DEFAULT_FORM]([Form_ID], [Form_Name], [Under_Form_ID], [Sort_ID], [Form_Type], [Form_url], [Form_Image_url], [Is_Active_For_menu], [Alias])values(6066, N'Leave Carry Forward', 6057, 94, 1, N'Leave_Carry_Forward.aspx', @Leave_Img, 0, N'Leave Carry Forward') --Change by ronakk 25122023 IsActive =0
...
INSERT INTO [dbo].[T0000_DEFAULT_FORM]([Form_ID], [Form_Name], [Under_Form_ID], [Sort_ID], [Form_Type], [Form_url], [Form_Image_url], [Is_Active_For_menu], [Alias])values(6092, N'Performance Detail', 6088, 139, 1, N'Salary_Employee_Performance.aspx',@Salary_Img, 0, N'Performance Detail') --Change by ronakk 27122023
...
INSERT INTO [dbo].[T0000_DEFAULT_FORM]([Form_ID], [Form_Name], [Under_Form_ID], [Sort_ID], [Form_Type], [Form_url], [Form_Image_url], [Is_Active_For_menu], [Alias])values(6096, N'Salary Daily', 6170, 143, 1, N'Salary_Daily_Wages.aspx', @Salary_Img, 0, N'Salary Daily') --Change by ronakk 27122023
...
INSERT INTO [dbo].[T0000_DEFAULT_FORM]([Form_ID], [Form_Name], [Under_Form_ID], [Sort_ID], [Form_Type], [Form_url], [Form_Image_url], [Is_Active_For_menu], [Alias])values(6936, N'In-Out Summary', 6702, 174, 1, NULL, NULL, 1, N'In-Out Summary')---added by mansi 09-08-2023
...
INSERT INTO [dbo].[T0000_DEFAULT_FORM]([Form_ID], [Form_Name], [Under_Form_ID], [Sort_ID], [Form_Type], [Form_url], [Form_Image_url], [Is_Active_For_menu], [Alias])values(7020, N'Performance Detail', 7019, 331, 1, N'Employee_performance.aspx',@Salary_Img,0, N'Performance Detail') ---Change by ronakk 27122023
...
if not exists (select Form_id from T0000_DEFAULT_FORM WITH (NOLOCK) where  Form_name = 'Register With Settlement My#')  
	begin
...
if not exists (select Form_id from T0000_DEFAULT_FORM WITH (NOLOCK) where  Form_name = 'Timesheet Summary My#') 
	begin
...
if not exists (select Form_id from T0000_DEFAULT_FORM WITH (NOLOCK) where  Form_name = 'Gate Pass Entry')  
	begin
...
If not exists (select Form_id from T0000_DEFAULT_FORM WITH (NOLOCK) where  Form_name = 'Loan Approval' And Form_ID > 7000 and Form_ID < 7500)	
	Begin
		Select @Menu_id1 = isnull(MAX(Form_id),0) + 1 from T0000_DEFAULT_FORM WITH (NOLOCK) where Form_ID > 7000 and Form_ID < 7500
		INSERT INTO [dbo].[T0000_DEFAULT_FORM]([Form_ID], [Form_Name], [Under_Form_ID], [Sort_ID], [Form_Type], [Form_url], [Form_Image_url], [Is_Active_For_menu], [Alias])
...
if not exists (select Form_id from T0000_DEFAULT_FORM WITH (NOLOCK) where  Form_name = 'Employee Company Transfer' And Form_ID > 6700 and Form_ID < 6999) 
	begin
...
if not exists (select Form_id from T0000_DEFAULT_FORM WITH (NOLOCK) where  Form_name = 'Optional Holiday' And Form_ID > 6700 and Form_ID < 6999) 
	begin
...
If not exists (select Form_id from T0000_DEFAULT_FORM WITH (NOLOCK) where  Form_name = 'Employee Shift Rotation Superior' And Form_ID > 7000 and Form_ID < 7500)	
	Begin
		Select @Menu_id1 = isnull(MAX(Form_id),0) + 1 from T0000_DEFAULT_FORM WITH (NOLOCK) where Form_ID > 7000 and Form_ID < 7500
		INSERT INTO [dbo].[T0000_DEFAULT_FORM]([Form_ID], [Form_Name], [Under_Form_ID], [Sort_ID], [Form_Type], [Form_url], [Form_Image_url], [Is_Active_For_menu], [Alias])
...
if not exists (select Form_id from T0000_DEFAULT_FORM WITH (NOLOCK) where  Form_name = 'Hrms Customize Report' And Form_ID > 6700 and Form_ID < 6999) 
	...
	if not exists (select Form_id from T0000_DEFAULT_FORM WITH (NOLOCK) where  Form_name = 'Meter Reading')
	begin
		select @Menu_id1 = isnull(MAX(Form_id),0) + 1 from T0000_DEFAULT_FORM WITH (NOLOCK) where Form_ID > 6000  and Form_ID < 6499  
		INSERT INTO [dbo].[T0000_DEFAULT_FORM]([Form_ID], [Form_Name], [Under_Form_ID], [Sort_ID], [Form_Type], [Form_url], [Form_Image_url], [Is_Active_For_menu], [Alias],[Sort_Id_check])
...
--------------------------- Ess Mobile Application Form Id from 10000 to 10200  Add by Prakash Patel 26092014 ------------------------------------------------------------------- 
		...
		--	END
			...
			--End by Divyaraj Kiri on 27072023
...
if not exists (select Form_id from T0000_DEFAULT_FORM WITH (NOLOCK) where  Form_name = 'Travel Account - Desk' And Form_ID > 6000 and Form_ID < 6500)
begin    
	select @Menu_id1 = isnull(MAX(Form_id),0) + 1 from T0000_DEFAULT_FORM WITH (NOLOCK) where Form_ID > 6000 and Form_ID < 6500
	INSERT INTO [dbo].[T0000_DEFAULT_FORM]([Form_ID], [Form_Name], [Under_Form_ID], [Sort_ID], [Form_Type], [Form_url], [Form_Image_url], [Is_Active_For_menu], [Alias],[Sort_Id_Check])
...
SELECT  @SubmenuId = Form_id FROM T0000_DEFAULT_FORM WITH (NOLOCK) WHERE  Form_name = 'Privileges/Scheme Assign' And Form_ID > 6000 and Form_ID < 6500 
...
if not exists (select Form_id from T0000_DEFAULT_FORM WITH (NOLOCK) where  Form_name = 'Project Allocation Report#' and Form_ID > 7500 and Form_ID < 7999  )  
	begin
...
if not exists (select Form_id from T0000_DEFAULT_FORM WITH (NOLOCK) where  Form_name = 'Timesheet Summary' and Form_ID > 7500 and Form_ID < 7999  )  
	begin
...
--		SELECT @Under_Form_Id_LeaveApplicationReport = Form_ID,@Sort_Id=Sort_Id FROM T0000_DEFAULT_FORM  WITH (NOLOCK) where  Form_name = 'Leave Reports' 
...
End	
		...
		SELECT @Under_Form_Id_IDCard = Form_ID,@Sort_Id=Sort_Id FROM T0000_DEFAULT_FORM  WITH (NOLOCK)
				where  Form_name = 'Privileges/Scheme Assign' 
