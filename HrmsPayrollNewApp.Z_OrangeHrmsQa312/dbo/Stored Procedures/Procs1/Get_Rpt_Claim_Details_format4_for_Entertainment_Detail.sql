 --exec Emp_Details_Form_A @Company_Id=119,@From_Date='2020-01-01 00:00:00',@To_Date='2020-01-31 00:00:00',@Branch_ID='',@Cat_ID='',@Grade_ID='',@Type_ID='',@Dept_ID='',@Desig_ID='',@Emp_ID=0,@Constraint='18412#14938',@Report_Type='ESIC'                  
    -- exec Get_Rpt_Claim_Details_format4_for_Entertainment_Detail @cmp_Id=203,@From_Date='2021-01-01 00:00:00',@To_Date='2021-12-31 00:00:00',@Branch_ID='',@Grade_ID='',@Type_ID='',@Dept_ID='',@Desig_ID='',@Emp_ID=0,@Constraint='',@Cat_ID='',@Segment_ID='0',@Vertical='0',@SubVertical='0'            
...
CREATE PROCEDURE Get_Rpt_Claim_Details_format4_for_Entertainment_Detail                        
   @Cmp_ID NUMERIC                              
  ,@From_Date  DATETIME                          
  ,@To_Date   DATETIME                          
  ,@Branch_ID  VARCHAR                 
...
--   set @Salary_Cycle_id = null              
 ...
 ,cd.Claim_Apr_Amount,        
  ...
  ,cd.Claim_Apr_Dtl_ID,cd.Claim_NoofPerson,cd.Claim_Apr_Date,cd.Claim_App_ID     
  ,ce.ec_NoOfEntertained,ce.ec_Amount,ce.ec_Date  
  ,[dbo].[F_GET_FINANCIAL_YEAR](cd.Claim_Apr_Date) as financial_yr
   ...
   inner join T0130_CLAIM_APPROVAL_DETAIL CD with (NoLock) on CD.Emp_ID=EM.Emp_ID    
    left join T0110_Claim_Entertainment CE with (NoLock) on CE.ec_ClaimAppId=cd.Claim_App_ID    
