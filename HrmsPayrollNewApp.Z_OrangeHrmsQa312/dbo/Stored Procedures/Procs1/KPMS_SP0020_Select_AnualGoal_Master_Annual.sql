...
CREATE PROCEDURE [dbo].[KPMS_SP0020_Select_AnualGoal_Master_Annual]           
(          
@Cmp_ID INT,          
@GS_Id INT,          
...
BEGIN          
 ...
 BEGIN          
  ...
  <div class="col-md-2" group="headersection"><input type="text" name="Section_1" class="form-control txtSectionName" placeholder="Section A" value="' + Section_Name + '" /></div>         
  ...
  <th width="5%">Action</th></tr></thead><tbody class="tblParentGoal">' + dbo.[fnc_GetSectionInnerResultForEditData_Annual](@Cmp_ID,GSS_SectionId) + '</tbody></table></div></div></div></div>'            
