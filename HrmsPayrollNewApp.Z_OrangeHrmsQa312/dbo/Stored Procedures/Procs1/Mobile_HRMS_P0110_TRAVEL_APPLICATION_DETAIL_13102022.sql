...
create PROCEDURE [dbo].[Mobile_HRMS_P0110_TRAVEL_APPLICATION_DETAIL_13102022]
...
SET ARITHABORT ON
	...
	If (UPPER(@Tran_Type) = 'I' or UPPER(@Tran_Type) = 'U' or UPPER(@Tran_Type) = 'M')
		Begin
			...
			--SELECT * FROM V0100_TRAVEL_APPLICATION WHERE Travel_Application_ID = @Travel_App_Detail_ID
