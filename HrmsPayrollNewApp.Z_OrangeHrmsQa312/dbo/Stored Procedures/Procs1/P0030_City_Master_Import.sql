...
CREATE PROCEDURE [dbo].[P0030_City_Master_Import] 
	 @Cmp_Id		NUMERIC(18,0)
	,@City_Name   VARCHAR(100)			
	,@State   varchar(100)
	,@Country varchar(100)	-- Added by Divyaraj Kiri on 11/10/2024
...
SET ARITHABORT ON
	...
	-- Start by Divyaraj Kiri on 11/10/2024
		if @Country = '' 
		Begin
			SET @Log_Status=1
			INSERT INTO dbo.T0080_Import_Log VALUES (@Row_No,@Cmp_Id,0,'Country Name Doesn''t exists',@State,'Enter proper Country Name',GETDATE(),'City Master',@GUID)
			RETURN	
		End
	-- End by Divyaraj Kiri on 11/10/2024
