...
-- =============================================
  -- exec [dbo].[P0001_Get_BirthdayList] '',121
CREATE PROCEDURE [dbo].[P0001_Get_BirthdayList]
	@date as varchar(max) = '',
	@Cmp_id int
AS
...
BEGIN
	...
	AND ENC.EMAIL_NTF_SENT = 1 AND UPPER(EFS.EMAIL_TYPE) = 'BIRTH DAY' AND ISNULL(CAT.Chk_Birth,1) = 1  and em.Cmp_ID=@Cmp_id
