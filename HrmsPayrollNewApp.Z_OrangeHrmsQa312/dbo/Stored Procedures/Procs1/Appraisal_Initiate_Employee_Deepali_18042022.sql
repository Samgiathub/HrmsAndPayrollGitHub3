...
Create  PROCEDURE [dbo].[Appraisal_Initiate_Employee_Deepali_18042022]
	 @cmp_Id  numeric(18,0) 
...
SELECT E.Emp_ID,E.Emp_Full_Name,E.Alpha_Emp_Code,E.Date_Of_Join,IE.Dept_ID,IE.Desig_Id,IE.Branch_ID,IE.Grd_ID,E.cmp_id,DM.Emp_id,(E.Alpha_Emp_Code+'-'+E.Emp_Full_Name) ,GE.Emp_ID,E.Emp_Superior, (select Alpha_Emp_Code+'-'+Emp_Full_Name from T0080_EMP_MASTER where emp_id = E.Emp_Superior)
