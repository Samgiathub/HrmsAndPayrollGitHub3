 --exec Emp_Details_Form_A @Company_Id=119,@From_Date='2020-01-01 00:00:00',@To_Date='2020-01-31 00:00:00',@Branch_ID='',@Cat_ID='',@Grade_ID='',@Type_ID='',@Dept_ID='',@Desig_ID='',@Emp_ID=0,@Constraint='18412#14938',@Report_Type='ESIC'                  
    ...
    -- exec Get_Rpt_Claim_Details_format4_for_EquimentMaintenance @cmp_Id=203,@From_Date='2019-01-01 00:00:00',@To_Date='2021-12-01 00:00:00',@Branch_ID='',@Grade_ID='',@Type_ID='',@Dept_ID='',@Desig_ID='',@Emp_ID=0,@Constraint='',@Cat_ID='',@Segment_ID='0',@Vertical='0',@SubVertical='0'                  
...
CREATE PROCEDURE Get_Rpt_Claim_Details_format4_for_EquimentMaintenance_Detail                        
   @Cmp_ID NUMERIC                                    
  ,@From_Date  DATETIME                                
  ,@To_Date   DATETIME                                
  ,@Branch_ID  VARCHAR                       
...
IF @Branch_ID = 0                      
 ...
 IF @Constraint <> ''                                
   ...
   ,bm.Branch_Address,bm.Branch_Name,com.Cmp_Name,com.Cmp_Address,bm.Comp_Name,@From_Date as P_From_date ,@To_Date as P_To_Date        
        ,format((cd.Claim_Apr_Date),'MMMM') as Month_Nm  
  ,g.Grd_Name  
   ...
   and cd.Claim_Apr_Date between    @From_Date and @To_Date and cm.Claim_Report_Def_Id=13    
   --and  Claim_Name like '%18_Equipment Maintenance%' or Claim_Name like '%Equipment Maintenance%'        
