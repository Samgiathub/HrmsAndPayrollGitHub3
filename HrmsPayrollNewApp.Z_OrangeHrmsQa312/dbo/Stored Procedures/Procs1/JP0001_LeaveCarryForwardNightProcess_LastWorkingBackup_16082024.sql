...
create PROCEDURE [dbo].[JP0001_LeaveCarryForwardNightProcess_LastWorkingBackup_16082024]  
...
,Advance_Leave_Recover_balance,Is_Advance_Leave_Balance,Month,Year,GETDATE() from T0001_LEAVECF_NightProcess
...
DECLARE @Cmp_id as int = 0
	...
	Declare @CF_Type varchar(30)	------- Add By Jignesh Patel 09-Sep-2021------------
	...
	DECLARE @CF_To_Date		AS DATETIME
			...
			where Cmp_Id = 13 -- Cmp_id
			--and emp_Id in (299,300,301,302,303,304,305,306) --762,299,
			...
			BEGIN
				...
				BEGIN	
					...
					BEGIN
						--select  @@IDENTITY
					--	select *  from   T0001_LEAVECF_NightProcess where LEAVE_CF_ID = @@IDENTITY
