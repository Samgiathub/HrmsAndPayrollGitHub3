...
-- =============================================
CREATE  PROCEDURE [dbo].[GET_Emp_Maker_Checker_Privilege_Import]
...
SET ARITHABORT ON
	...
	select * from #TEMP_data_1 
		where tab_Name='Employee' 
		and (Right_Name='Employee' 
			 --or Right_Name='Employee Nominees'
			 --or  Right_Name= 'Employee FamilyMember'
			 --or  Right_Name= 'Reporting Manager'
			 --or  Right_Name= 'Qualification'
			 --or  Right_Name= 'Experience'
			 or  Right_Name= 'Earn/Ded Data')
