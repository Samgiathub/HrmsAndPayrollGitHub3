...
CREATE PROCEDURE [dbo].[P_Common_Home_Pages_New_Joining_Details]
   @Cmp_ID numeric(18,0),
...
*/			
	...
	Set @Qry = 'insert into #New_Joining
			...
			WHERE
				Date_Of_Join Between cast(CAST( DATEADD(DAY,-30,GETDATE()) as varchar(11)) AS datetime) and GETDATE() and
