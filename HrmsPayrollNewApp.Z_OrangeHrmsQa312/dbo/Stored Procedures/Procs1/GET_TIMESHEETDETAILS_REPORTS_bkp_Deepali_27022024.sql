...
create PROCEDURE [dbo].[GET_TIMESHEETDETAILS_REPORTS_bkp_Deepali_27022024]
@Cmp_ID Numeric(18,0),
@Fromdate Datetime,
@Todate Datetime,
	...
	Begin
		...
		Begin 
			...
			--format(convert(date,substring(GT.Timesheet_Period,14,24),103),'dd-MM-yyyy') as 'To date' ,Ps.Project_Status as 'Status'
				...
				-- Old Query - Week start date and end date - commented by Deepali - 20032024 - start
			--format(convert(date,substring(GT.Timesheet_Period,0,11),103),'dd-MM-yyyy')  as 'From Date',
			--format(convert(date,substring(GT.Timesheet_Period,14,24),103),'dd-MM-yyyy') as 'To date' ,
		    -- Old Query - Week start date and end date - commented by Deepali - 20032024 - end

			-- New Query - Week start date and end date - commented by Deepali - 20032024 - start
		
			 format(convert(date,substring(GT.Timesheet_Period,0,11),103),'dd-MM-yyyy')  as 'From Date',
			format(convert(date,substring(GT.Timesheet_Period,14,24),103),'dd-MM-yyyy') as 'To date' ,
	
			 Ps.Project_Status as 'Status'
			-- New Query - Week start date and end date - commented by Deepali - 20032024 - end
