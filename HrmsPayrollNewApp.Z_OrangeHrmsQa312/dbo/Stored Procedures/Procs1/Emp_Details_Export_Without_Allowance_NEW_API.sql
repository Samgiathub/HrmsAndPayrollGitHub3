...
--exec Emp_Details_Export_Without_Allowance_NEW_API 0,'12/09/2021','13/09/2021'
CREATE PROCEDURE [dbo].[Emp_Details_Export_Without_Allowance_NEW_API]    
  @Company_Id int    
    ...
    SELECT I.Emp_Id
     FROM dbo.T0095_INCREMENT I WITH (NOLOCK)  
      INNER JOIN (SELECT MAX(Increment_Id) AS Increment_Id, Emp_ID   --Changed by Hardik 10/09/2014 for Same Date Increment  
          ...
          WHERE (cast(System_Date as date) between @From_Date and @To_Date) --AND Cmp_ID = @Company_ID  
          GROUP BY emp_ID  
 ...
 (  
  ...
  E_AD_AMOUNT  [NUMERIC] (18,4)     
   ...
   BEGIN
		UPDATE INC  
		 ...
		 DECLARE @Status_C VARCHAR(10)   
			...
			--E.Blood_Group
			----,E.Emp_Dress_Code as Dress_Code,E.Emp_Shirt_Size as Shirt_Size  
			----,E.Emp_Pent_Size as Pent_Size,E.Emp_Shoe_Size as Shoe_Size,E.Emp_Canteen_Code as Canteen_Code
		 ...
		 --  , e.Old_Ref_No,e.Dealer_Code, ISNULL(ccm.Center_Name,'') AS Cost_Center_Name, @Status_C AS Status  
		 ...
		 --  --,E.Extra_AB_Deduction,Early_Dedu_Type as Early_deduction_Type  
		 ...
		 --  --,( '="' + E.DBRD_Code + '"') as DBRD_Code,E.CCenter_Remark AS CostCenter_Remark,Fix_OT_Hour_Rate_WD as Fix_OT_Hours_Rate_WeekDay
		 --  --,Fix_OT_Hour_Rate_WO_HO as Fix_OT_Hours_Rate_Wo_Ho  
   ...
   BEGIN -- With Company
		 ...
		 --  --,E.CompOff_Min_hrs As Minimum_CompOff_Hours,Case When E.Image_Name like '0.jpg' then '' else e.Image_Name End as Image_Name  
		 --  --,case when isnull(E.Is_Lwf,0) =0 then 'No' else 'Yes' end LWF  
		 --  --,Case When ISNULL(E.Salary_Depends_on_Production,0) = 1 then 'Yes' Else 'No' END as Salary_Depends_on_Production 
		 --  --,isnull(SM.State_Name,'') as Branch_State_Name 
		 --  ,Inc_Qry.Salary_Basis_On as Salary_On,CUM.Curr_Name as Currency
		 --  --,E.Extra_AB_Deduction,Early_Dedu_Type as Early_deduction_Type  
		 --  --,E.Emp_PF_Opening,E.Yearly_Leave_Days,E.Yearly_Leave_Amount,E.Yearly_Bonus_Per,E.Yearly_Bonus_Amount,Deputation_End_Date,BN1.Bank_BSR_Code  
