 --exec Emp_Details_Form_A @Company_Id=119,@From_Date='2020-01-01 00:00:00',@To_Date='2020-01-31 00:00:00',@Branch_ID='',@Cat_ID='',@Grade_ID='',@Type_ID='',@Dept_ID='',@Desig_ID='',@Emp_ID=0,@Constraint='18412#14938',@Report_Type='ESIC'                  
    ...
    -- exec Get_Rpt_Claim_Details_format4_for_DentalTreatment @cmp_Id=203,@From_Date='2019-01-01 00:00:00',@To_Date='2021-12-01 00:00:00',@Branch_ID='',@Grade_ID='',@Type_ID='',@Dept_ID='',@Desig_ID='',@Emp_ID=0,@Constraint='',@Cat_ID='',@Segment_ID='0',@Vertical='0',@SubVertical='0'                    
...
CREATE PROCEDURE Get_Rpt_Claim_Details_format4_for_DentalTreatment                             
   @Cmp_ID NUMERIC                                      
  ,@From_Date  DATETIME                                  
  ,@To_Date   DATETIME                                  
  ,@Branch_ID  VARCHAR                         
...
IF @Branch_ID = 0                        
 ...
 IF @Constraint <> ''                                  
  BEGIN                                           
    ...
    em.Alpha_Emp_Code  
 --,cd.Claim_Model,cd.Claim_IMEI,cd.Claim_App_Amount,cd.Claim_DateOfPurchase,cd.Claim_ID,                      
 --   cd.Curr_Rate,cd.Claim_Age,cd.Claim_ActualPrice,Cd.Claim_App_Ttl_Amount                
 --   ,cd.Claim_Apr_Amount,                
 --   lTRIM(dbo.F_Number_TO_Word(cd.Claim_Apr_Amount)) as Claim_Apr_Amount_In_Word,                
 --   lTRIM(dbo.F_Number_TO_Word(cd.Claim_App_Amount)) as Claim_App_Amount_In_Word,                  
 --   lTRIM(dbo.F_Number_TO_Word(cd.Claim_App_Ttl_Amount)) as Claim_App_Ttl_Amount_In_Word ,cm.Claim_Terms_Condition                   
