...
CREATE PROCEDURE [dbo].[P0000_Default_Form_New_BackupbyAswini22032024]
...
-- Started by Divyaraj Kiri on 19/02/2024
...
-- Ended by Divyaraj Kiri on 19/02/2024

--END Deepal 04092020


--============================================For SKILL And Certi Master Change by ronakk 24082023 ====================================
...
IF NOT EXISTS (SELECT FORM_ID FROM T0000_DEFAULT_FORM WHERE  FORM_NAME = 'Canteen Exemption Report' AND PAGE_FLAG='AR')
	...
	-- Added by Divyaraj kiri on 06022024
	...
	BEGIN    
		...
		END
	END
	-- Ended by Divyaraj kiri on 06022024
