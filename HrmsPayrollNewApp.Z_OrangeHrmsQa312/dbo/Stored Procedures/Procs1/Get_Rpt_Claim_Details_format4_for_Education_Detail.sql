 --exec Emp_Details_Form_A @Company_Id=119,@From_Date='2020-01-01 00:00:00',@To_Date='2020-01-31 00:00:00',@Branch_ID='',@Cat_ID='',@Grade_ID='',@Type_ID='',@Dept_ID='',@Desig_ID='',@Emp_ID=0,@Constraint='18412#14938',@Report_Type='ESIC'                  
    ...
    -- exec Get_Rpt_Claim_Details_format4_for_Education_Detail @cmp_Id=203,@From_Date='2019-01-01 00:00:00',@To_Date='2021-12-01 00:00:00',@Branch_ID='',@Grade_ID='',@Type_ID='',@Dept_ID='',@Desig_ID='',@Emp_ID=0,@Constraint='',@Cat_ID='',@Segment_ID='0',@Vertical='0',@SubVertical='0'              
...
CREATE PROCEDURE [dbo].[Get_Rpt_Claim_Details_format4_for_Education_Detail]              
   @Cmp_ID NUMERIC                                
  ,@From_Date  DATETIME                            
  ,@To_Date   DATETIME                            
  ,@Branch_ID  VARCHAR                   
...
IF @Branch_ID = 0                  
 ...
 IF @Constraint <> ''                            
     ...
     ,edu.ced_ClassName,edu.ced_EducatinLevel,edu.ced_Id,edu.ced_Name,edu.ced_Quarter,edu.ced_RelationName  
     ,edu.ced_RequestedAmount,edu.ced_SchoolCollegeName,edu.ced_Id,edu.ced_ClaimAppId  
     ...
     left join T0110_Claim_EducationDetails edu with (NoLock) on edu.ced_ClaimAppId=cd.Claim_App_ID  
   ...
   and cd.Claim_Apr_Date between    @From_Date and @To_Date   and  Claim_Name  like '%12_Education Expenses%' or Claim_Name  like '%Education Expenses%'  
  ...
  ELSE       
   BEGIN      
    ...
    ,bm.Branch_Address,bm.Branch_Name,com.Cmp_Name,com.Cmp_Address,bm.Comp_Name,@From_Date as P_From_date ,@To_Date as P_To_Date   
    ,edu.ced_ClassName,edu.ced_EducatinLevel,edu.ced_Id,edu.ced_Name,edu.ced_Quarter,edu.ced_RelationName  
    ,edu.ced_RequestedAmount,edu.ced_SchoolCollegeName,cd.Claim_App_ID  
    from T0080_EMP_MASTER EM                         
    inner join T0130_CLAIM_APPROVAL_DETAIL CD with (NoLock) on CD.Emp_ID=EM.Emp_ID              
    inner join T0040_CLAIM_MASTER CM with (NoLock) on CM.Claim_ID=cd.Claim_ID   
    left join T0110_Claim_EducationDetails edu with (NoLock) on edu.ced_ClaimAppId=cd.Claim_App_ID  
