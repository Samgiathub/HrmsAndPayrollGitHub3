create PROCEDURE [dbo].[Calculate_Time_Difference_samplenew_new11new]
    @Emp_ID int,
    @Cmp_ID int,
    @Date datetime
AS 
BEGIN
    ...
    (
        ...
        TimeDifference30OrMore int,Address_Location varchar(max)
    );

    INSERT INTO @TempTable (Latitude, Longitude,Address_Location, TimeDifferenceLessThan10, TimeDifference10To29, TimeDifference30OrMore)
    SELECT 
