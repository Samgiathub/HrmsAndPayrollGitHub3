 --exec Emp_Details_Form_A @Company_Id=119,@From_Date='2020-01-01 00:00:00',@To_Date='2020-01-31 00:00:00',@Branch_ID='',@Cat_ID='',@Grade_ID='',@Type_ID='',@Dept_ID='',@Desig_ID='',@Emp_ID=0,@Constraint='18412#14938',@Report_Type='ESIC'                  
    ...
    -- exec Get_Rpt_Claim_Details_format4_for_Book @cmp_Id=203,@From_Date='2021-01-01 00:00:00',@To_Date='2021-12-31 00:00:00',@Branch_ID='',@Grade_ID='',@Type_ID='',@Dept_ID='',@Desig_ID='',@Emp_ID=0,@Constraint='',@Cat_ID='',@Segment_ID='0',@Vertical='0',@SubVertical='0'                
...
CREATE PROCEDURE Get_Rpt_Claim_Details_format4_for_Book                     
   @Cmp_ID NUMERIC                                  
  ,@From_Date  DATETIME                              
  ,@To_Date   DATETIME                              
  ,@Branch_ID  VARCHAR                     
 ...
 (                              
  ...
  End                        
    ...
    IF @Constraint <> ''                              
     ...
     cd.Claim_BookName,cd.Claim_Subject,cd.Claim_ActualPrice,cd.Claim_PriceAfterDiscount,cd.Claim_App_Amount,        
     cd.Claim_DateOfPurchase,cd.Claim_ID,cd.Claim_App_ID,                  
