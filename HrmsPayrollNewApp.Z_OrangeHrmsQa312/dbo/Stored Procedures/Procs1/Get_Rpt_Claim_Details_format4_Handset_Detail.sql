 --exec Emp_Details_Form_A @Company_Id=119,@From_Date='2020-01-01 00:00:00',@To_Date='2020-01-31 00:00:00',@Branch_ID='',@Cat_ID='',@Grade_ID='',@Type_ID='',@Dept_ID='',@Desig_ID='',@Emp_ID=0,@Constraint='18412#14938',@Report_Type='ESIC'                  
    -- exec Get_Rpt_Claim_Details_format4 @cmp_Id=119,@From_Date='2019-01-01 00:00:00',@To_Date='2021-12-01 00:00:00',@Branch_ID='',@Grade_ID='',@Type_ID='',@Dept_ID='',@Desig_ID='',@Emp_ID=0,@Constraint='',@Cat_ID='',@Segment_ID='0',@Vertical='0',@SubVertical='0'            
...
CREATE PROCEDURE Get_Rpt_Claim_Details_format4_Handset_Detail                           
   @Cmp_ID NUMERIC                              
  ,@From_Date  DATETIME                          
  ,@To_Date   DATETIME                          
  ,@Branch_ID  VARCHAR                 
...
--   set @Salary_Cycle_id = null              
 ...
 BEGIN                          
    ...
    cd.Curr_Rate,cd.Claim_Age,cd.Claim_ActualPrice,Cd.Claim_App_Ttl_Amount,cd.Claim_Apr_Date,          
    dbo.F_Number_TO_Word(cd.Claim_App_Amount) as Claim_App_Amount_In_Word,cd.Claim_Apr_Date,          
   ...
   --LEFT OUTER JOIN T0040_BANK_MASTER BN WITH (NOLOCK) ON Inc_Qry.Bank_Id = BN.Bank_Id                         
    where   cd.Claim_Status='A' and EM.Cmp_ID=@Cmp_ID                
     and cd.Claim_Apr_Date between    @From_Date and @To_Date  and cm.Claim_Report_Def_Id=1      
     --and cm.Claim_Name like '%Mobile Handset%' --and cd.Claim_ID=89          
     --and  (cm.Claim_Name like '%Mobile Handset%'  or cm.Claim_Name like '%01_Mobille Handset%')      
