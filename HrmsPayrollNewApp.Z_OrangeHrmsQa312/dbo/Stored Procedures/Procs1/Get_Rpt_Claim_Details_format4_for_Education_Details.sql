 --exec Emp_Details_Form_A @Company_Id=119,@From_Date='2020-01-01 00:00:00',@To_Date='2020-01-31 00:00:00',@Branch_ID='',@Cat_ID='',@Grade_ID='',@Type_ID='',@Dept_ID='',@Desig_ID='',@Emp_ID=0,@Constraint='18412#14938',@Report_Type='ESIC'                  
    ...
    -- exec Get_Rpt_Claim_Details_format4_for_Education_Details @cmp_Id=203,@From_Date='2019-01-01 00:00:00',@To_Date='2021-12-01 00:00:00',@Branch_ID='',@Grade_ID='',@Type_ID='',@Dept_ID='',@Desig_ID='',@Emp_ID=0,@Constraint='',@Cat_ID='',@Segment_ID='0',@Vertical='0',@SubVertical='0'                
...
CREATE PROCEDURE [dbo].[Get_Rpt_Claim_Details_format4_for_Education_Details]                
   @Cmp_ID NUMERIC                                  
  ,@From_Date  DATETIME                              
  ,@To_Date   DATETIME                              
  ,@Branch_ID  VARCHAR                     
...
IF @Branch_ID = 0                    
 ...
 IF @Constraint <> ''                              
     ...
     ,edu.ced_RequestedAmount,edu.ced_SchoolCollegeName,edu.ced_ClaimAppId,cd.Claim_App_ID 
	    ,g.Grd_Name
   ...
   and cd.Claim_Apr_Date between    @From_Date and @To_Date  and cm.Claim_Report_Def_Id=6
   --and  Claim_Name  like '%12_Education Expenses%' or Claim_Name  like '%Education Expenses%'    
