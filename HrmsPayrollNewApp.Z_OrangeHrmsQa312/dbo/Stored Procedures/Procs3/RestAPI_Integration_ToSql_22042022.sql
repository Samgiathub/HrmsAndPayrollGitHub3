...
-- =============================================
CREATE PROCEDURE [dbo].[RestAPI_Integration_ToSql_22042022]
...
BEGIN
	...
	DECLARE @Startdate varchar(10) = CONVERT(varchar(10), GetDate()-2, 126)
	...
	(  
		...
		--and EmpCode like '%[0-9]%'
		--AND DayInDate <> '' AND DayInTime <> ''
