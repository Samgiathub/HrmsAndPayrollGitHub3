...
CREATE PROCEDURE [dbo].[SP_Employee_BirthDay_Email]
...
---SET @EMP_NAME= 'RAMESH J SHAH'
			...
			--EXEC [SP_Employee_BirthDay_EMail] 121,'Yogseh.p@orangewebtech.com'
     ...
     --      		 
			...
			--EXEC [SP_Employee_BirthDay_EMail] 121,'Yogesh.p@orangewebtech.com'
			SET @EMP_NAME = ''
			SET @WORK_EMAIL = ''
			SET @BRANCH_NAME = ''
			SET @DESIG_NAME = ''
