...
CREATE PROCEDURE [dbo].[SP_LEAVE_CF_GET]
	@Cmp_ID 		numeric
	,@From_Date		datetime
	,@To_Date 		datetime
	,@Branch_ID		numeric   
...
--end
	...
	--Added by Jaina 16-11-2016
	 select cast(Alpha_Emp_Code as varchar(15)) +' -'+ Emp_full_name as Emp_Full_Name,em.Emp_ID,lc.*,em.Branch_ID,em.Vertical_ID,em.SubVertical_ID,em.subBranch_ID ,em.Dept_ID  --for filter added by aswini 08/01/2024        
