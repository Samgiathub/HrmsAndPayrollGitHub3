...
CREATE  PROCEDURE [dbo].[Set_Salary_register_Lable_Transfer]
 @Cmp_ID as numeric
,@Month as numeric 
,@Year as numeric 
AS
...
SET ARITHABORT ON
	...
	declare Cur_Dedu   cursor for
		  select  distinct Ad_Sort_Name ,Ad_level  from t0210_monthly_ad_detail WITH (NOLOCK) inner join
			...
			and month(t0210_monthly_ad_detail.For_Date) =  @Month 
				and Year(t0210_monthly_ad_detail.For_Date) = @Year
				and Ad_Active = 1 and AD_Flag = 'D' and ad_not_effect_salary=0
		order by Ad_level 
	open Cur_Dedu
