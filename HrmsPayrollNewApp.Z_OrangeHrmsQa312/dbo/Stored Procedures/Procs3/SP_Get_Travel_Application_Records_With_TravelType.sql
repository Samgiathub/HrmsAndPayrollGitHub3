...
CREATE  PROCEDURE [dbo].[SP_Get_Travel_Application_Records_With_TravelType]
	@Cmp_ID		Numeric(18,0),
	@Emp_ID		Numeric(18,0),
					...
					If @Emp_ID_Cur > 0
						...
						--select * from #tbl_Leave_App
							...
							Select distinct	
									...
									LAD.Emp_ID, LAD.Emp_Full_Name, isnull(LAD.Supervisor,'Admin'),LAD.Travel_Application_ID, LAD.Application_Code,LAD.Branch_Name
