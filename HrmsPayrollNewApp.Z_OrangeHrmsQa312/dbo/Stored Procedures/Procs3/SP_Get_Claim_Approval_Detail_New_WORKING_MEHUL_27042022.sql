...
CREATE PROCEDURE [dbo].[SP_Get_Claim_Approval_Detail_New_WORKING_MEHUL_27042022]  
 @CMP_ID  NUMERIC ,  
...
--where clm.Claim_App_ID=@Claim_App_ID and clm.Cmp_ID=@CMP_ID
		select	CAD.Claim_Apr_Date as for_date,clm_master.Claim_Name as Claim_Type,clm_master.Claim_Name,CAD.Claim_ID,
					...
					isnull(ACAD.Claim_UnitName,'') as UnitName,isnull(ACAD.Claim_UnitFlag,0) as UnitFlag,isnull(ACAD.Claim_ConversionRate,0) as ConversionRate,isnull(ACAD.Claim_FamilyMeberId,0) as RowId,ACAD.Claim_App_Detail_ID
