...
create PROCEDURE [dbo].[SP_Get_Travel_Settlement_Application_Records working_210222]
	@Cmp_ID		Numeric(18,0),
	@Emp_ID		Numeric(18,0),
	...
	(
		...
		inner join (
			...
			Inner Join T0050_Scheme_Detail T1 ON T.Scheme_ID = T1.Scheme_Id 
				where Emp_ID = @AppEmp And Type = 'Travel Settlement'
								 ...
								 If @Emp_ID_Cur > 0
									Begin
										...
										Begin 
											...
											From T0050_Scheme_Detail WITH (NOLOCK)
											Inner Join T0040_Scheme_Master WITH (NOLOCK) ON T0050_Scheme_Detail.Scheme_Id = T0040_Scheme_Master.Scheme_Id
											Where App_Emp_Id = @Emp_ID and rpt_level = @Rpt_level	And T0040_Scheme_Master.Scheme_Type = 'Travel Settlement'
											...
											BEGIN
												SET @string_1 = 'Insert Into #tbl_Scheme_Leave (Scheme_ID, Leave,Is_Fwd_Leave_Rej,is_rpt_manager,rpt_level,Max_Leave_Days,Is_Aprvl_Ovrlimit,Is_RMToRM)
																...
																Where  rpt_level = '+ CAST(@Rpt_level AS VARCHAR(2)) +' and Is_RM = 1 
																	And T0040_Scheme_Master.Scheme_Type = ''Travel Settlement'' and T0040_Scheme_Master.Cmp_Id In  ('+ @Emp_Cmp_Id +')'
										...
										If @Manager_Branch is not null
											Begin
												Insert Into #tbl_Scheme_Leave (Scheme_ID, Leave,Is_Fwd_Leave_Rej,is_branch_manager,rpt_level,Max_Leave_Days,Is_Aprvl_Ovrlimit,Is_HOD,Is_RMToRM)
													...
													From T0050_Scheme_Detail WITH (NOLOCK)
													Inner Join T0040_Scheme_Master WITH (NOLOCK) ON T0050_Scheme_Detail.Scheme_Id = T0040_Scheme_Master.Scheme_Id
													Where rpt_level = @Rpt_level and Is_BM = 1 And T0040_Scheme_Master.Scheme_Type = 'Travel Settlement'
											End
										if @Manager_HOD is not null
											Begin
												Insert Into #tbl_Scheme_Leave (Scheme_ID, Leave,Is_Fwd_Leave_Rej,is_branch_manager,rpt_level,Max_Leave_Days,Is_Aprvl_Ovrlimit,Is_HOD,Is_RMToRM)
													...
													From T0050_Scheme_Detail WITH (NOLOCK)
													Inner Join T0040_Scheme_Master WITH (NOLOCK) ON T0050_Scheme_Detail.Scheme_Id = T0040_Scheme_Master.Scheme_Id
													Where rpt_level = @Rpt_level and Is_HOD = 1 And T0040_Scheme_Master.Scheme_Type = 'Travel Settlement'
								 ...
								 Else
									Begin
											Insert Into #tbl_Scheme_Leave (Scheme_ID, Leave,Is_Fwd_Leave_Rej,rpt_level,Max_Leave_Days,Is_Aprvl_Ovrlimit,Is_HOD,Is_RMToRM)
												...
												From T0050_Scheme_Detail WITH (NOLOCK)
												Inner Join T0040_Scheme_Master WITH (NOLOCK) ON T0050_Scheme_Detail.Scheme_Id = T0040_Scheme_Master.Scheme_Id
												Where T0040_Scheme_Master.Scheme_Type = 'Travel Settlement'
									End
