...
Create PROCEDURE [dbo].[SP_Import_Allowance_Data_backup_110424]
	@Cmp_ID						numeric, 
	@Emp_Id						numeric,
...
--										end
							...
							begin
								...
								Increment_Amount = @Basic_Salary - isnull(Pre_Basic_Salary,0),   -- Added by Gadriwala Muslim 29022015
								...
								Delete  FROM T0100_EMP_EARN_DEDUCTION WHERE INCREMENT_ID = @Increment_Id	--Added by Ramiz After Discussion with Ankit bhai on 13/10/2015
							end
