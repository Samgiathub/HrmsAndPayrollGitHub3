CREATE PROCEDURE [dbo].[SP_Jiffy_Get_Emp_Attendance]
(  
...
BEGIN
  ...
  --Declare @Cmp_ID   numeric = @Cmp_ID
  Declare @From_Date  datetime = @Start_Date
  Declare @To_Date   datetime = @End_Date
  Declare @Branch_ID  numeric = 0
  Declare @Cat_ID   numeric = 0
  Declare @Grd_ID   numeric = 0
  ...
  Declare @Type   numeric = 0  
  Declare @Con_Absent_Days   numeric = 0
  Declare @Cancel_WKOF Numeric = 0
  Declare @P_Branch varchar(max) = '' 
  Declare @P_Department varchar(max) = '' 
  Declare @P_Vertical varchar(max) = '' 
  Declare @P_SubVertical varchar(max) = '' 
  Declare @Leave_Flag Numeric(18,0) = 0   	  
  
 DECLARE @MANUAL_SALARY_PERIOD TINYINT   

  Declare @Emp_ID numeric = 0
  Declare @constraint  varchar(MAX) = ''
  Select @constraint = Emp_ID from T0080_EMP_MASTER WHERE Alpha_Emp_Code = @Alpha_Emp_Code AND Cmp_ID = @Cmp_ID
  ...
  BEGIN  
   ...
   IF @BRANCH_ID IS NULL or @BRANCH_ID = 0  
    BEGIN   
     ...
     SELECT TOP 1 @SAL_ST_DATE  = SAL_ST_DATE ,@MANUAL_SALARY_PERIOD=ISNULL(MANUAL_SALARY_PERIOD ,0),@Late_Early_Ded_Combine = Isnull(Is_Chk_Late_Early_Mark,0)  
   ...
   ELSE  
    BEGIN  
     -- CHANGED BY GADRIWALA MUSLIM 06102016 - REPLACE INNER MAX QUERY TO INNER JOIN MAX QUERY  
     SELECT @SAL_ST_DATE  =SAL_ST_DATE ,@MANUAL_SALARY_PERIOD=ISNULL(MANUAL_SALARY_PERIOD ,0),@Late_Early_Ded_Combine = Isnull(Is_Chk_Late_Early_Mark,0)  
      FROM T0040_GENERAL_SETTING GS WITH (NOLOCK)  INNER JOIN  
      (  
 ...
 (       
  ...
  --,Working_sec_Between_Shift numeric(18) default 0 name -- Commented by Niraj(20062022)
 )      
 ...
 SELECT EMP_ID,Branch_ID,0 FROM #Emp_Cons  
 ...
 *********************************************************************/  
 ...
 --Here Condition is Added By Ramiz on 14/04/2016 after discussion with Hardik Bhai  
  ...
  begin  
   ...
   EXEC SP_GET_HW_ALL @CONSTRAINT=@CONSTRAINT,@CMP_ID=@Cmp_ID, @FROM_DATE=@FROM_DATE, @TO_DATE=@TO_DATE, @All_Weekoff = 0, @Exec_Mode=0  
 --   select * from #EMP_HOLIDAY --where EMP_ID=22359---mansi
	--select * from #Emp_WeekOff --where EMP_ID=22359---mansi
 ...
 */  
 ...
 if (@NotImportedEmp <> '0' AND @NotImportedEmp <> '')  
  BEGIN 
   ...
   Exec dbo.SP_CALCULATE_PRESENT_DAYS @Cmp_ID,@From_Date,@To_Date,@Branch_ID,@Cat_ID,@Grd_ID,@Type_ID,@Dept_ID,@Desig_ID,@emp_ID,@NotImportedEmp,4,'',1,@Report_For = @Report_For  
   TRUNCATE TABLE #Emp_Cons  
...
END   
 ...
 -- Begin  
    ...
    (    
     ...
     WHEN D.P_DAYS IN (0.25, 0.370,0.375, 0.38, 0.125, 0.13,0.120) THEN 'QD'   
     ...
     WHEN D.P_DAYS IN (0.75, 0.625, 0.63,0.670, 0.875, 0.870, 0.88) THEN '3QD'  
     ...
					from dbo.T0140_LEAVE_TRANSACTION LTSUB WITH (NOLOCK)  inner join t0040_leave_master lm WITH (NOLOCK)  on LTSUB.leave_id = lm.leave_id and LTSUB.Cmp_ID=Lm.Cmp_ID
					where lm.Apply_Hourly=1 and Add_In_Working_Hour = 1 group by LTSUB.For_Date,LTSUB.Emp_ID 
				 )LT ON AM.EMP_ID = LT.EMP_ID		
				AND AM.FOR_DATE = LT.FOR_DATE 
				where LT.Leave_Used  >0
				and Am.For_Date >=@From_Date and Am.For_Date <=@To_Date 
		-- Deepal For Lubi 17052022 Add sajid bhai condition add  working hour = 1 
    ...
    */  
    ...
    -- Deepal For Lubi 17052022 Add sajid bhai condition add  working hour = 1 
		...
		set  P_days= 0
		from #Att_Muster AM 
		where Am.For_Date >=@From_Date and Am.For_Date <=@To_Date and Status = 'PL'
	-- Deepal For Lubi 17052022 Add sajid bhai condition add  working hour = 1 
...
---Hardik 08/07/2013 for Mid Joining.. it will show - (Dash) in Register  
    ...
    --- Comment below portion for Cliantha, They want Half Day Absent in Absent Report Also.. Added by Hardik 30/12/2020  
 ...
 Else  
  ...
  --AND ( WO_HO IS NULL OR status = 'HHO' )  
   update #Att_Muster  
...
----PRINT 'STATE 7.2 :' + CONVERT(VARCHAR(20), GETDATE(), 114);  
 ...
 --PRINT 'STATE 9 :' + CONVERT(VARCHAR(20), GETDATE(), 114);  
  ...
  update AM set Status_2 ='*',Late_deduct_Days=els.Late_Deduct_Days  
   from #Att_Muster AM    
   inner join #Late_Early_Deduction els on els.Emp_ID = AM.Emp_Id and am.For_date =els.For_Date   
   where AM.Status <> 'A' and els.Late_Deduct_Days = 0 and am.emp_ID = els.emp_ID   
   and am.For_date =els.For_Date and isnull(leave_count,0) < 1  
    
	  
    
  update AM set Status_2 = 'LC',Late_deduct_Days=els.Late_Deduct_Days from #Att_Muster AM    
   ...
   and am.emp_ID = els.emp_ID and am.For_date =els.For_Date     
   and isnull(leave_count,0) < 1  
     
  
  update AM set Status_2 = 'EC',Early_deduct_Days=els.Early_Deduct_Days from #Att_Muster AM    
   inner join #Late_Early_Deduction els on am.emp_ID = els.emp_ID and am.For_date =els.For_Date   
   where AM.Status <> 'A' and els.Early_Deduct_Days>0  and am.emp_ID = els.emp_ID and am.For_date =els.For_Date     
   and isnull(leave_count,0) < 1  
  ...
  -- where AM.Status <> 'A' and els.Late_Deduct_Days = 0 and leave_count < 1  
  ...
  -- from #Att_Muster AM inner join #Late_Early_Deduction els on am.emp_ID = els.emp_ID and am.For_date =els.For_Date   
  -- where AM.Status <> 'A' and els.Late_Deduct_Days>0 and leave_count < 1  --- Changed by Gadriwala Muslim 24062015  
  ...
  -- from #Att_Muster AM inner join #Late_Early_Deduction els on am.emp_ID = els.emp_ID and am.For_date =els.For_Date   
  -- where AM.Status <> 'A' and els.Early_Deduct_Days>0  and leave_count < 1  
  ...
  If @EXPORT_TYPE = 'Excel'  
   BEGIN  
    ...
    (select e.Emp_Id ,SUM(e.Late_Deduct_Days) Late_Early_Deduct_Days From #Late_Early_Deduction  e  
     ...
     Where e.For_Date>=@From_Date and e.For_Date <=@to_Date and SAM.status <> 'A' and isnull(leave_count,0) < 1  -- Changed by Gadriwala Muslim 24062015  
...
if @Report_For = ''  
 begin  
    --select * from #Emp_WeekOff_Holiday where EMP_ID=22359---mansi
       --- Added by Jignesh 08-Nov-2012  
  
  --- for Insert Retaining Days  - Start --By Deepali 180422--------------------------2651
				declare @curCM_ID as Numeric
				Declare @curemp_id as Numeric
				Declare @curTempDate as datetime
				declare @Days_cnt as numeric
				set @Days_cnt =0
	...
	While @@fetch_status = 0                    
			Begin    
				if((select 1 from T0100_EMP_RETAINTION_STATUS OA  where OA.Emp_Id = @curemp_id and OA.Cmp_Id= @curCM_ID and  CONVERT(VARCHAR(20),CAST(@curTempDate AS DATETIME),101)  between CONVERT(VARCHAR(20),CAST(OA.Start_Date AS DATETIME),101) and CONVERT(VARCHAR(20),CAST(OA.End_Date AS DATETIME),101) and OA.Is_Retain_ON = 0)=1)
					Begin
						update #Att_Muster set Status = 'RT' ,A_Days= 0 , WO_HO_Day = 0 where For_Date = @curTempDate
					    set @Days_cnt = @Days_cnt+1
						--set @TempDate  = DATEADD(day,1,@curTempDate) 
					End
			fetch next from Curs_Retain into @curemp_id,@curCM_ID, @curTempDate
			end
	close Curs_Retain                    
	...
	Update #Att_Muster set Status = ( select count (A_Days) from #Att_Muster where For_Date between @From_Date and @To_Date and A_days= 1 )  where Row_Id = 33 
	Update #Att_Muster set Status = ( select count (WO_HO_Day) from #Att_Muster where For_Date between @From_Date and @To_Date and WO_HO_Day= 1 )  where Row_Id = 35 
	...
	------------------------------------------------------	
						...
						--Insert into #Data (Emp_ID,For_Date,Duration_In_sec,Emp_OT,Emp_OT_min_Limit,Emp_OT_max_Limit,In_Time,Shift_Start_Time,OT_Start_Time,Shift_Change,Chk_By_Superior,IO_Tran_Id,OUT_Time,Flag)
      --                  SELECT @Emp_Id ,@TempDate , 0 , 0 , 0,0 , NULL , NULL , 0 , 0 , 0 , 0 , NULL,999
						--FROM T0100_EMP_RETAINTION_STATUS OA Inner Join #Emp_Cons EC on OA.Emp_Id =  EC.Emp_ID where   OA.Start_Date <= OA.End_Date and IS_RETAIN_ON = 0 and @TempDate between START_DATE and END_DATE
					...
					--end
						...
						--update #Data 
			 		--	Set Flag='998' 
			   --         FROM    #EMP_WEEKOFF_SAL wk, #Data Dt
		    --            WHERE   wk.EMP_ID=@Emp_Id AND wk.For_date = Dt.For_date and Dt.Flag='999'
						
						--update #Data 
			 		--	Set Flag='997' 
			   --         FROM    #EMP_HOLIDAY_SAL wk, #Data Dt
		    --            WHERE   wk.EMP_ID=@Emp_Id AND wk.For_date = Dt.For_date and Dt.Flag='999'
						
	             	----for Insert Retaining Days  - End-  By Deepali 180422------------------------------
					--------------------------------------------------------------------------------------------------------------------------------------						
  ...
  if @Export_Type  = 'EXCEL'  
   begin  
     ...
     where Isnull(Leave_Count,0) > 0 OR Status = 'LWP' -- Added LWP by Hardik 11/11/2020 for SLS client as Half LWP not showing 0.5  
   ...
   */  
   ...
   IF (EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'Dishman')) --Added Condition for Dishman Company show Absent As LWP 30082017  
	...
	Select convert(varchar(50), For_Date, 23) as Date,
	Status as Status
	from #Att_Muster
	WHERE For_Date between @Start_Date and @End_Date
	-- Added by Niraj (02062022)
	
	Insert into API_Hit_Log
	(API_Name, [TimeStamp], Hit_Count_Today, Hit_Count_Total)
	SELECT N'POST​/Api​/Home​/Employee_Attendance' as API_Name,
...
--    T_Day  As Cast(ROUND(P_Day + A_Day + W_Day + H_Day ,0) As Numeric(18,2))    
