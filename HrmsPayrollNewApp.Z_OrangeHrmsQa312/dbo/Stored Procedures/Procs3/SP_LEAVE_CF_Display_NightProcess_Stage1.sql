...
Create PROCEDURE [dbo].[SP_LEAVE_CF_Display_NightProcess_Stage1]  
...
AS  
	...
	IF OBJECT_ID('tempdb..#LEAVE_CF_DETAIL') IS NULL
		BEGIN
			...
			(
				...
				[Grd_ID] [NUMERIC](18, 0) NULL,
				[Type_ID] [NUMERIC](18, 0) NULL,
				[Dept_ID] [NUMERIC](18, 0) NULL,
				[Desig_ID] [NUMERIC](18, 0) NULL,
				[Segment_ID] [NUMERIC](18, 0) NULL,
				[subBranch_ID] [NUMERIC](18, 0) NULL,
				[Vertical_ID] [NUMERIC](18, 0) NULL,
				[SubVertical_ID] [NUMERIC](18, 0) NULL,
	...
	DECLARE @Is_Advance_Leave_Balance NUMERIC(1,0) 
...
--  DECLARE @join_dt DATETIME
	...
	SELECT I.Emp_Id,isnull(I.Branch_ID ,0) as Branch_Id,isnull(I.Grd_ID,0) as Grd_Id,isnull(I.Dept_ID,0) as Dept_Id
	,isnull(I.Desig_Id,0) as Desig_Id ,isnull(I.Cat_ID,0) as Cat_Id,isnull(I.Type_ID,0) as [Type_Id],isnull(I.Segment_ID,0) as Segment_Id
	,isnull(I.subBranch_ID,0) as subBranch_ID,isnull(I.Vertical_ID,0) as Vertical_ID ,isnull(I.SubVertical_ID,0) as SubVertical_ID
	,Emp_Left_Date,Date_Of_Join,IsNull(I.Emp_Fix_Salary,0) 
	FROM	
							...
							( SELECT MAX(I2.INCREMENT_ID) AS INCREMENT_ID, I2.EMP_ID 
                              ...
                              (
                                           SELECT MAX(i3.INCREMENT_EFFECTIVE_DATE) AS INCREMENT_EFFECTIVE_DATE, I3.EMP_ID
											...
											Inner join #EMP_CONS EC on I3.Emp_id = EC.Emp_id and I3.INCREMENT_EFFECTIVE_DATE <= @To_Date
	...
	OPEN curEmp  
	FETCH NEXT FROM curEmp INTO @Emp_ID,@Branch_ID,@Grd_ID,@Dept_Id,@Desig_Id,@Cat_Id,@Type_ID,@Segment_Id,@subBranch_ID,@Vertical_ID,@SubVertical_ID,@Emp_Left_Date,@Date_Of_Join,@Fix_Salary 
															...
															IF @Is_FNF = 1
																BEGIN 
																	INSERT INTO #LEAVE_CF_DETAIL  
																		( Cmp_ID,Branch_ID,Grd_ID,Cat_ID,[Type_ID],Dept_ID,Desig_ID,Segment_ID,subBranch_ID,Vertical_ID,SubVertical_ID, Emp_ID, Leave_ID, CF_For_Date, CF_From_Date, CF_To_Date, CF_P_Days, CF_Leave_Days, CF_Type, Exceed_CF_Days,is_fnf,Advance_Leave_Balance,Advance_Leave_Recover_balance,Is_Advance_Leave_Balance)  
																	VALUES 
																		( @Cmp_ID,@Branch_ID,@Grd_ID,@Cat_ID,@Type_ID,@Dept_ID,@Desig_ID,@Segment_ID,@subBranch_ID,@Vertical_ID,@SubVertical_ID, @Emp_ID, @Leave_ID, @Month_END_Date, @Month_St_Date, @Month_END_Date, isnull(@P_Days,0), @Leave_CF_Days, @Leave_CF_Type, @Exceed_CF_Days,@Is_FNF,(CASE WHEN @Is_Advance_Leave_Balance = 1 THEN @Advance_Leave_Balance ELSE 0 END),(CASE WHEN @Is_Advance_Leave_Balance = 1 THEN @Advance_Leave_Recover_balance ELSE 0 END),@Is_Advance_Leave_Balance)  
																END
															ELSE
																BEGIN
																	INSERT INTO #LEAVE_CF_DETAIL  
																		( Cmp_ID,Branch_ID,Grd_ID,Cat_ID,[Type_ID],Dept_ID,Desig_ID,Segment_ID,subBranch_ID,Vertical_ID,SubVertical_ID, Emp_ID, Leave_ID, CF_For_Date, CF_From_Date, CF_To_Date, CF_P_Days, CF_Leave_Days, CF_Type, Exceed_CF_Days,is_fnf,Advance_Leave_Balance,Advance_Leave_Recover_balance,Is_Advance_Leave_Balance)  																			
																	VALUES 
																		( @Cmp_ID,@Branch_ID,@Grd_ID,@Cat_ID,@Type_ID,@Dept_ID,@Desig_ID,@Segment_ID,@subBranch_ID,@Vertical_ID,@SubVertical_ID, @Emp_ID, @Leave_ID, CASE WHEN @Duration = 'Yearly' THEN @For_Date  ELSE @CF_For_Date END , @Month_St_Date, @Month_END_Date, isnull(@P_Days,0), @Leave_CF_Days, @Leave_CF_Type, @Exceed_CF_Days,@Is_FNF,(CASE WHEN @Is_Advance_Leave_Balance = 1 THEN @Advance_Leave_Balance ELSE 0 END),(CASE WHEN @Is_Advance_Leave_Balance = 1 THEN @Advance_Leave_Recover_balance ELSE 0 END),@Is_Advance_Leave_Balance)  
																END
														END	
													ELSE
														BEGIN
											...
											ELSE
												BEGIN
													...
													INSERT INTO #LEAVE_CF_DETAIL  
														( Cmp_ID,Branch_ID,Grd_ID,Cat_ID,[Type_ID],Dept_ID,Desig_ID,Segment_ID,subBranch_ID,Vertical_ID,SubVertical_ID, Emp_ID, Leave_ID, CF_For_Date, CF_From_Date, CF_To_Date, CF_P_Days, CF_Leave_Days, CF_Type, Exceed_CF_Days,is_fnf,Advance_Leave_Balance,Advance_Leave_Recover_balance,Is_Advance_Leave_Balance)  
													VALUES 
														( @Cmp_ID,@Branch_ID,@Grd_ID,@Cat_ID,@Type_ID,@Dept_ID,@Desig_ID,@Segment_ID,@subBranch_ID,@Vertical_ID,@SubVertical_ID, @Emp_ID, @Leave_ID,CASE WHEN @Duration = 'Yearly' THEN @For_Date  ELSE @CF_For_Date END , @Month_St_Date, @Month_END_Date, isnull(@P_Days,0), isnull(@Leave_CF_Days,0), @Leave_CF_Type, @Exceed_CF_Days,@Is_FNF,(CASE WHEN @Is_Advance_Leave_Balance = 1 THEN @Advance_Leave_Balance ELSE 0 END),(CASE WHEN @Is_Advance_Leave_Balance = 1 THEN @Advance_Leave_Recover_balance ELSE 0 END),@Is_Advance_Leave_Balance)  
													...
													IF 	@CompOff_Closing_Balance > 0 
														BEGIN
															...
															IF @Is_FNF = 1
																BEGIN    
																	INSERT INTO #LEAVE_CF_DETAIL  
																		( Cmp_ID,Branch_ID, Emp_ID, Leave_ID, CF_For_Date, CF_From_Date, CF_To_Date, CF_P_Days, CF_Leave_Days, CF_Type, Exceed_CF_Days,Leave_CompOff_Dates,is_fnf)  
																	VALUES 
																		( @Cmp_ID,@Branch_ID,@Grd_ID,@Cat_ID,@Type_ID,@Dept_ID,@Desig_ID,@Segment_ID,@subBranch_ID,@Vertical_ID,@SubVertical_ID, @Emp_ID, @tran_Leave_ID, @Month_END_Date, @Month_St_Date, @Month_END_Date, isnull(@CompOff_Closing_Balance,0), @CompOff_Closing_Balance, @Leave_CF_Type, @Exceed_CF_Days,@Leave_CompOff_Dates,@Is_FNF)  
																END
															ELSE
																BEGIN 
																	INSERT INTO #LEAVE_CF_DETAIL  
																		( Cmp_ID,Branch_ID, Emp_ID, Leave_ID, CF_For_Date, CF_From_Date, CF_To_Date, CF_P_Days, CF_Leave_Days, CF_Type, Exceed_CF_Days,Leave_CompOff_Dates,is_fnf)  
																	VALUES 
																		( @Cmp_ID,@Branch_ID,@Grd_ID,@Cat_ID,@Type_ID,@Dept_ID,@Desig_ID,@Segment_ID,@subBranch_ID,@Vertical_ID,@SubVertical_ID, @Emp_ID, @tran_Leave_ID,CASE WHEN @Duration = 'Yearly' THEN @For_Date  ELSE @CF_For_Date END , @Month_St_Date, @Month_END_Date, isnull(@CompOff_Closing_Balance,0), @CompOff_Closing_Balance, @Leave_CF_Type, @Exceed_CF_Days,@Leave_CompOff_Dates,@Is_FNF)  
																END
														END
												END
										END	
		...
		BEGIN 
			...
			begin 
					...
					SELECT	--CF.*, 
						...
						IsNull(CF.Branch_ID,0) AS Branch_Id,
						IsNull(CF.Grd_ID,0) AS Grd_ID,
						IsNull(CF.Dept_ID,0) AS Dept_ID,
						IsNull(CF.Desig_ID,0) AS Desig_ID,
						IsNull(CF.Cat_ID,0) AS Cat_ID,
						IsNull(CF.Type_ID,0) AS Type_ID,
						IsNull(CF.Segment_ID,0) AS Segment_ID,
						IsNull(CF.subBranch_ID,0) AS subBranch_ID,
						IsNull(CF.Vertical_ID,0) AS Vertical_ID,
						IsNull(CF.SubVertical_ID,0) AS SubVertical_ID,
