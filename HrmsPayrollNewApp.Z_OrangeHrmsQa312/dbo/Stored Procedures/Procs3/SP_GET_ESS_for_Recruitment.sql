...
-- =============================================
CREATE PROCEDURE [dbo].[SP_GET_ESS_for_Recruitment]
	@Cmp_ID numeric(18,0),  
	@Emp_ID numeric(18,0)
AS
...
BEGIN
		...
		left join T0050_HRMS_Recruitment_Request as hrr on hrr.S_Emp_ID = ep.s_emp_id
		where ep.s_emp_id = @Emp_ID and status = 'H' and ep.cmp_id = @Cmp_ID --and hrr.Rep_EmployeeId != ep.emp_id
END
