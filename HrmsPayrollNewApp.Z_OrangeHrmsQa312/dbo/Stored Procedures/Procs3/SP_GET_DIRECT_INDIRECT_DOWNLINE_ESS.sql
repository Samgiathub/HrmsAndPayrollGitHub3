...
CREATE PROCEDURE [dbo].[SP_GET_DIRECT_INDIRECT_DOWNLINE_ESS]
	@Cmp_ID numeric(18,0),  
	@Emp_ID numeric(18,0),
...
BEGIN
	...
	*/
	...
	IF @ExecuteFor  IN ('', 'BOTH', 'DIRECT')
		...
		WHERE Reporting_Method = 'Direct' and TMP.Emp_ID<>@Emp_ID ---ronakb050224
	...
	*/	
	...
	begin 
		SELECT 111,R_Emp_ID,Emp_id,Emp_Full_Name,Alpha_Emp_Code,Emp_Name_Code,Branch_ID,Dept_ID,branch_name,dept_name,Emp_Full_Name1
			...
			FROM #TMP TMP
		INNER JOIN T0010_COMPANY_MASTER CMP WITH (NOLOCK) on CMP.Cmp_Id=TMP.Cmp_ID
		WHERE Reporting_Method in ('Direct','InDirect') and TMP.Emp_ID<>@Emp_ID ---ronakb050224
	end
END
