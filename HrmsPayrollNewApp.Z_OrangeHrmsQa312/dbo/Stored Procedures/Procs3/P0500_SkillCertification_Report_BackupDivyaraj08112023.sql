...
-- =============================================
CREATE PROCEDURE [dbo].[P0500_SkillCertification_Report_BackupDivyaraj08112023] 
	@Cmp_ID		numeric
	,@From_Date		datetime
	,@To_Date		datetime 
...
SET ARITHABORT ON
		...
		EM.BRANCH_NAME,convert(varchar,EM.Date_Of_Join,103) as Date_Of_Join,convert(varchar,SCM.Created_Date,103) as Created_Date,
		...
		SELECT distinct T.Certi_Detail_Id,E.Emp_Id ,E.Alpha_Emp_Code ,E.Emp_Full_Name  ,E.Department  ,E.Designation  ,		
		E.BRANCH_NAME,convert(varchar,E.Date_Of_Join,103) as Date_Of_Join,T.Created_Date,T.Category_Name,T.SubCat_Name,T.Skill_Level,T.Certificate_Name,T.Exp_Years,		
		T.Is_TrainingAttended,T.Training_Certi_Attachment,T.Is_ExamAttended,T.Exam_Certi_Attachment,T.Descriptions,E.Mobile_No		
			FROM #EMPDETAILS E 
