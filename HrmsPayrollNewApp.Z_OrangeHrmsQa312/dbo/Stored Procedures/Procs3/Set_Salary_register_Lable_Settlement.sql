...
--Created By Girish On 08-AUG-2009
---20/1/2021 (EDIT BY MEHUL ) (SP WITH NOLOCK)---
CREATE  PROCEDURE [dbo].[Set_Salary_register_Lable_Settlement]
 @Cmp_ID as numeric
,@Month as numeric 
,@Year as numeric 
AS
...
SET ARITHABORT ON
	...
	declare Cur_Allow   cursor for
		...
		--and-- month(t0210_monthly_ad_detail.For_Date) =  @Month and Year(t0210_monthly_ad_detail.For_Date) = @Year
		and Ad_Active = 1 and AD_Flag = 'I' and ad_not_effect_salary = 0 And sal_type=1
		order by Ad_level 
