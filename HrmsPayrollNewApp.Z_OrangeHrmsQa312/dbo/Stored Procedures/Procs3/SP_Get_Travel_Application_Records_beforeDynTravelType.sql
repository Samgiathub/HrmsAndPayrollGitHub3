...
-- exec  [dbo].[SP_Get_Travel_Application_Records_beforeDynTravelType] 121,14956,0,N''P','Order by Application_Date desc'

---28/1/2021 (EDIT BY MEHUL ) (SP WITH NOLOCK)---
CREATE PROCEDURE [dbo].[SP_Get_Travel_Application_Records_beforeDynTravelType]
	@Cmp_ID		Numeric(18,0),
	@Emp_ID		Numeric(18,0),
							...
							If @Emp_ID_Cur > 0
									Begin
										...
										--	Where App_Emp_Id = @Emp_ID and rpt_level = @Rpt_level	And T0040_Scheme_Master.Scheme_Type = 'Travel'
											...
											From T0050_Scheme_Detail WITH (NOLOCK)
											Inner Join T0040_Scheme_Master WITH (NOLOCK) ON T0050_Scheme_Detail.Scheme_Id = T0040_Scheme_Master.Scheme_Id
											inner join T0080_DynHierarchy_Value Dy on T0050_Scheme_Detail.Dyn_Hier_Id = DY.DynHierColId 
											and Dy.DynHierColValue = @Emp_ID
											Where (App_Emp_Id = @Emp_ID Or  App_Emp_Id = 0) 
											and rpt_level = @Rpt_level And T0040_Scheme_Master.Scheme_Type = 'Travel'
