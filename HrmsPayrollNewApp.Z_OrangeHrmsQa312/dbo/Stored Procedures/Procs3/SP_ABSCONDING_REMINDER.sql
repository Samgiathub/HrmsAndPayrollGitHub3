CREATE PROCEDURE [dbo].[SP_ABSCONDING_REMINDER]
/* =============================================
							...
							BEGIN
								IF @CUR_STAGE = 'THIRD'
									BEGIN
										...
										--EXEC msdb.dbo.sp_send_dbmail @profile_name = 'DB_Mail_83', @recipients = @EMPL_EMAIL_ID, @subject = 'Termination Letter due to Absenteeism', @body = @Body, @body_format = 'HTML', @copy_recipients = @CC_EMAIL
								...
								ELSE IF @CUR_STAGE = 'SECOND'
									BEGIN
										...
										SELECT @BODY = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(@BODY , '#EmployeeName#' , '' + @EMPL_NAME + ''),'#EmpCode#' , '' + @EMP_CODE +''),'#Branch#','' + @EMPL_BRANCH +''),'#Last_Attended_Date#','' + REPLACE(CONVERT(VARCHAR, @LAST_ATTENDED_DATE, 106) , ' ' , '-') +''),'#Signature#' , '' + @COMPANY_NAME + '')
										EXEC msdb.dbo.sp_send_dbmail @profile_name = @PROFILE, @recipients = @EMPL_EMAIL_ID, @subject = 'Warning Letter Regarding Absenteeism', @body = @Body, @body_format = 'HTML', @copy_recipients = @CC_EMAIL
										--EXEC msdb.dbo.sp_send_dbmail @profile_name = 'DB_Mail_83', @recipients = @EMPL_EMAIL_ID, @subject = 'Warning Letter Regarding Absenteeism', @body = @Body, @body_format = 'HTML',@copy_recipients = @CC_EMAIL
								...
								ELSE IF @CUR_STAGE = 'FIRST'
									BEGIN
										...
										SELECT @BODY = REPLACE(REPLACE(REPLACE(REPLACE(REPLACE(@BODY , '#EmployeeName#' , '' + @EMPL_NAME + ''),'#EmpCode#' , '' + @EMP_CODE +''),'#Branch#','' + @EMPL_BRANCH +''),'#Last_Attended_Date#','' + REPLACE(CONVERT(VARCHAR, @LAST_ATTENDED_DATE, 106) , ' ' , '-') +''),'#Signature#' , '' + @COMPANY_NAME + '')
										EXEC msdb.dbo.sp_send_dbmail @profile_name = @PROFILE, @recipients = @EMPL_EMAIL_ID, @subject = 'Absence Letter Intimation', @body = @Body, @body_format = 'HTML', @copy_recipients = @CC_EMAIL
										--EXEC msdb.dbo.sp_send_dbmail @profile_name = 'DB_Mail_83', @recipients = @EMPL_EMAIL_ID, @subject = 'Absence Letter Intimation', @body = @Body, @body_format = 'HTML', @copy_recipients = @CC_EMAIL
