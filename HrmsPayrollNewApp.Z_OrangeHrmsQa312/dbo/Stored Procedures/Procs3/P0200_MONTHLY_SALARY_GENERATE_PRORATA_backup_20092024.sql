Create PROCEDURE [dbo].[P0200_MONTHLY_SALARY_GENERATE_PRORATA_backup_20092024]    
      ...
      INNER JOIN
               ...
               SET @Extra_audit_Emp_OT_Sec = 0
                  ...
                  WHERE GEN_ID=@GEN_ID    
					...
					select @Absent_after_Cutoff_date,@Arear_Month_cutoff,@Arear_Year_cutoff,@Salary_amount_Arear_cutoff,@Day_Salary_Arear_cutoff
