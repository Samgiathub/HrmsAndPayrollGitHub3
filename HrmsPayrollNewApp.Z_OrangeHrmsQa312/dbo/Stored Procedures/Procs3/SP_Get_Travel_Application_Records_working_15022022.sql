...
create PROCEDURE [dbo].[SP_Get_Travel_Application_Records_working_15022022]
	@Cmp_ID		Numeric(18,0),
	@Emp_ID		Numeric(18,0),
...
SET ARITHABORT ON
	...
	(
		...
		--select * from #Temp12 where AppId Not In (Select Travel_Application_ID From T0115_TRAVEL_LEVEL_APPROVAL where Rpt_Level = 1)
		--select * from #Temp12 where AppId Not In (Select Travel_Application_ID From T0115_TRAVEL_LEVEL_APPROVAL where Rpt_Level = 2)
						...
						WHILE @Rpt_level <= @MaxLevel
							...
							If @Emp_ID_Cur > 0
									Begin
										...
										--if ((select count(1) from #Temp12 where AppId Not In (Select Travel_Application_ID From T0115_TRAVEL_LEVEL_APPROVAL where Rpt_Level = 1 and Approval_Status = 'P')) > 0) and @Rpt_level = 1 
										BEGIN
										...
										--	inner join T0115_Leave_Level_Approval TLA on TLa.Emp_ID = @Emp_ID
