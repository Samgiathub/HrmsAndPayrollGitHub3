...
CREATE PROCEDURE [dbo].[SP_Get_Travel_Application_Records_Report]
	@Cmp_ID		Numeric(18,0),
	@Emp_ID		Numeric(18,0),
		...
		WHILE @@FETCH_STATUS = 0
								 ...
								 If @Emp_ID_Cur > 0
									Begin
										...
										Insert Into #tbl_Scheme_Leave (Scheme_ID, Leave,Is_Fwd_Leave_Rej,is_rpt_manager,rpt_level,Max_Leave_Days,Is_RMToRM)
											...
											Where App_Emp_Id = @Emp_ID and rpt_level = @Rpt_level	And T0040_Scheme_Master.Scheme_Type = 'Travel' and Leave in ('0')
			...
			--select * from #tbl_Scheme_Leave
				If @Emp_ID_Cur > 0
					Begin
						--Insert INTO #Travel
						 select distinct LAD.Application_Code as Application_Code,LAD.Application_Date as Application_Date,LAD.Alpha_Emp_code as Emp_code
									  , LAD.Emp_Full_Name as Emp_Full_Name , LAD.Branch_Name as Branch_Name, isnull(LAD.Supervisor,'Admin') as Manager,LAD.Application_Status as Application_Status
							--Select distinct	
				...
				Else
					...
					--	Insert INTO #Travel
							...
							Select distinct	
								...
								, LAD.Branch_Name as Branch_Name, isnull(LAD.Supervisor,'Admin') as Manager,LAD.Application_Status as Application_Status
							--	LAD.Emp_ID, LAD.Emp_Full_Name, LAD.Supervisor,LAD.Travel_Application_ID, LAD.Application_Code ,LAD.Branch_Name
							--	,LAD.Desig_Name, LAD.Alpha_Emp_code, LAD.Application_Date ,LAD.Application_Status 
							--	,LAD.Travel_Set_Application_id,LAD.travel_approval_id
