...
-- =============================================
CREATE PROCEDURE [dbo].[P0200_Select_FillExitDetails_Backup_Divyaraj_23102024]
		...
		Begin
			...
			If @smpid = 0
				Begin
					...
					E.interview_time,E.Is_process,Email_ForwardTo,DriveData_ForwardTo,EM.Emp_Full_Name,E.Application_Date,isnull(Exit_App_Doc,'')Exit_App_Doc
					...
					Where E.cmp_id = @cmp_id and exit_id = @exit_id 
				End
			Else
				Begin
					Select distinct E.exit_id,E.emp_id,E.cmp_id,E.branch_id,E.desig_id,E.resignation_date,
					E.last_date,E.reason,E.comments,E.status,E.is_rehirable,E.s_emp_id,G.Emp_Superior,E.feedback,E.sup_ack,E.interview_date,
					E.interview_time,E.Is_process,Email_ForwardTo,DriveData_ForwardTo,E.Rpt_Mng_ID,
					...
					Where E.cmp_id = @cmp_id and exit_id = @exit_id     --Left Join Done by Ramiz on 07/01/2015 as exit application was not coming Blank
				End
		End
