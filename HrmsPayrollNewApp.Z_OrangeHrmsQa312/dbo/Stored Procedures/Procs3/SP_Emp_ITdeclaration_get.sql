...
CREATE PROCEDURE [dbo].[SP_Emp_ITdeclaration_get]
...
AS
	...
	if @Constraint <> ''
		...
		select I_Q.* , cast( E.Emp_Code as varchar) + ' - '+E.Emp_Full_Name as Emp_Full_Name,
					Emp_code,Dept_Name,Desig_Name,Type_Name,Grd_Name,Branch_Name,Date_of_Join,Gender
