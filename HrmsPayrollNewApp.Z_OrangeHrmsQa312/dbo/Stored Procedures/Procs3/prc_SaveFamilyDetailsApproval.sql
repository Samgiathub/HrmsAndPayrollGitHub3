-- exec prc_SaveFamilyDetailsApproval
-- drop proc prc_SaveFamilyDetailsApproval
CREATE procedure [dbo].[prc_SaveFamilyDetailsApproval]
@rClaimAppId numeric,
@rClaimAprId numeric,
@rEmpId numeric,
...
begin
	...
	delete from T0110_Claim_Approval_FamilyDetails where Claim_AppId = @rClaimAppId and Claim_EmpId = @rEmpId

	insert into T0110_Claim_Approval_FamilyDetails
	(
		Claim_FamilyMemberId,Claim_AppId,Claim_AprId,ClaimId,Claim_EmpId,Claim_FamilyMemberName,Claim_FamilyRelation,Claim_Age,Claim_Limit,Claim_Amount,cfa_BirthDate,cfa_BillNumber,cfa_BillDate,cfa_BillAmount
	)
	select t_FamilyMemberId,@rClaimAppId,@rClaimAprId,@lClaimId,@rEmpId,t_FamilyMemberName,t_Relation,t_Age,t_Limit,t_Amount,t_BirthDate,t_BillNo,t_BillDate,t_BillAmount from @tbltmp
end