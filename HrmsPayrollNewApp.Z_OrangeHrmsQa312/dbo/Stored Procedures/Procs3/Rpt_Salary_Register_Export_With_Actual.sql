...
CREATE PROCEDURE [dbo].[Rpt_Salary_Register_Export_With_Actual]  
	 @Company_id	numeric  
	,@From_Date		datetime
	,@To_Date 		datetime
	,@Branch_ID		numeric	
...
SELECT     Lt.Emp_ID,Replace(Replace(Replace(Replace(REPLACE(Replace(REPLACE(Replace(REPLACE(replace(Replace(Replace(Replace(Replace(ltrim(rtrim(Leave_Name)),'+','_'),'''','_'),',','_'),'.','_'),'  ',' '),'%',''),'-',' '),'@',''),'(',''),')',''),' ','_'),'__','_'),'__','_'),'/','') Leave_Name 
...
set @ColsPivot_Leave = STUFF((SELECT ',' + QUOTENAME(cast(Replace(Replace(Replace(Replace(REPLACE(Replace(REPLACE(Replace(REPLACE(replace(Replace(Replace(Replace(Replace(ltrim(rtrim(Leave_Name)),'+','_'),'''','_'),',','_'),'.','_'),'  ',' '),'%',''),'-',' '),'@',''),'(',''),')',''),' ','_'),'__','_'),'__','_'),'/','') as varchar(4000))) 
...
set @ColsPivot_Leave_Null = STUFF((SELECT ',ISNULL(' + QUOTENAME(cast(Replace(Replace(Replace(Replace(REPLACE(Replace(REPLACE(Replace(REPLACE(replace(Replace(Replace(Replace(Replace(ltrim(rtrim(Leave_Name)),'+','_'),'''','_'),',','_'),'.','_'),'  ',' '),'%',''),'-',' '),'@',''),'(',''),')',''),' ','_'),'__','_'),'__','_'),'/','') as varchar(4000))) + ',0) AS ' + QUOTENAME(cast(Replace(Replace(Replace(Replace(REPLACE(Replace(REPLACE(Replace(REPLACE(replace(Replace(Replace(Replace(Replace(ltrim(rtrim(Leave_Name)),'+','_'),'''','_'),',','_'),'.','_'),'  ',' '),'%',''),'-',' '),'@',''),'(',''),')',''),' ','_'),'__','_'),'__','_'),'/','') as varchar(4000)))
								from #v_Leave_pvt3 as a
								cross apply ( select 'Leave_Name' col, 1 so ) c 
								group by col,a.Leave_Name,so 
								order by so 
...
set @ColsPivot_Leave_Total = STUFF((SELECT '+ISNULL(' + QUOTENAME(cast(Replace(Replace(Replace(Replace(REPLACE(Replace(REPLACE(Replace(REPLACE(replace(Replace(Replace(Replace(Replace(ltrim(rtrim(Leave_Name)),'+','_'),'''','_'),',','_'),'.','_'),'  ',' '),'%',''),'-',' '),'@',''),'(',''),')',''),' ','_'),'__','_'),'__','_'),'/','') as varchar(4000))) + ',0)'
								from #v_Leave_pvt3 as a
								cross apply ( select 'Leave_Name' col, 1 so ) c 
								group by col,a.Leave_Name,so 
								order by so 
...
--Deepal Drop table condition added 30062022
IF (EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'v_Leave'))
BEGIN
DROP TABLE v_Leave
END
--Deepal Drop table condition added 30062022
...
SELECT     Lt.Emp_ID,  cast(Replace(Replace(Replace(Replace(REPLACE(Replace(REPLACE(Replace(REPLACE(replace(Replace(Replace(Replace(Replace(ltrim(rtrim(Leave_Name)),'+','_'),'''','_'),',','_'),'.','_'),'  ',' '),'%',''),'-',' '),'@',''),'(',''),')',''),' ','_'),'__','_'),'__','_'),'/','') as varchar(4000)) as Leave_Name, SUM(Leave_Used) AS Leave_Used
INTO #v_Leave_pvt_u
FROM T0140_LEAVE_TRANSACTION LT  WITH (NOLOCK) 
			 inner join T0040_Leave_Master LM  WITH (NOLOCK) on lt.leave_ID = lm.leave_ID and isnull(lm.Default_Short_Name,'') <> 'COMP'
			 inner join #Emp_Cons1 Ec ON Ec.emp_id = Lt.Emp_ID  --added jimit 26042016
...
SELECT     lt.Emp_ID, cast(Replace(Replace(Replace(Replace(REPLACE(Replace(REPLACE(Replace(REPLACE(replace(Replace(Replace(Replace(Replace(ltrim(rtrim(Leave_Name)),'+','_'),'''','_'),',','_'),'.','_'),'  ',' '),'%',''),'-',' '),'@',''),'(',''),')',''),' ','_'),'__','_'),'__','_'),'/','') as varchar(4000)) as Leave_Name, SUM(isnull(CompOff_Used,0) - isnull(Leave_Encash_Days,0)) AS Leave_Used
INTO #v_Leave_pvt_u1
FROM         T0140_LEAVE_TRANSACTION LT  WITH (NOLOCK) 
			 inner join T0040_Leave_Master LM  WITH (NOLOCK) on lt.leave_ID = lm.leave_ID and isnull(lm.Default_Short_Name,'') = 'COMP'
			 inner join #Emp_Cons1 Ec ON Ec.emp_id = Lt.Emp_ID  --added jimit 26042016
...
set @ColsPivot_Leave_U = STUFF((SELECT ',' + QUOTENAME(cast(Replace(Replace(Replace(Replace(REPLACE(Replace(REPLACE(Replace(REPLACE(replace(Replace(Replace(Replace(Replace(ltrim(rtrim(Leave_Name)),'+','_'),'''','_'),',','_'),'.','_'),'  ',' '),'%',''),'-',' '),'@',''),'(',''),')',''),' ','_'),'__','_'),'__','_'),'/','') as varchar(4000))) 
...
set @ColsPivot_Leave_Null_U = STUFF((SELECT ',ISNULL(' + QUOTENAME(cast(Replace(Replace(Replace(Replace(REPLACE(Replace(REPLACE(Replace(REPLACE(replace(Replace(Replace(Replace(Replace(ltrim(rtrim(Leave_Name)),'+','_'),'''','_'),',','_'),'.','_'),'  ',' '),'%',''),'-',' '),'@',''),'(',''),')',''),' ','_'),'__','_'),'__','_'),'/','') as varchar(4000))) + ',0) AS ' + QUOTENAME(cast(Replace(Replace(Replace(Replace(REPLACE(Replace(REPLACE(Replace(REPLACE(replace(Replace(Replace(Replace(Replace(ltrim(rtrim(Leave_Name)),'+','_'),'''','_'),',','_'),'.','_'),'  ',' '),'%',''),'-',' '),'@',''),'(',''),')',''),' ','_'),'__','_'),'__','_'),'/','') as varchar(4000)))
								from #v_Leave_pvt_u2 as a
								cross apply ( select 'Leave_Name' col, 1 so ) c 
								group by col,a.Leave_Name,so 
								order by so 
...
set @ColsPivot_Leave_Total_U = STUFF((SELECT '+ISNULL(' + QUOTENAME(cast(Replace(Replace(Replace(Replace(REPLACE(Replace(REPLACE(Replace(REPLACE(replace(Replace(Replace(Replace(Replace(ltrim(rtrim(Leave_Name)),'+','_'),'''','_'),',','_'),'.','_'),'  ',' '),'%',''),'-',' '),'@',''),'(',''),')',''),' ','_'),'__','_'),'__','_'),'/','') as varchar(4000))) + ',0)'
								from #v_Leave_pvt_u2 as a
								cross apply ( select 'Leave_Name' col, 1 so ) c 
								group by col,a.Leave_Name,so 
								order by so 
...
DECLARE @colsPivot4 AS NVARCHAR(MAX), @colsPivot4_ntes AS NVARCHAR(MAX), @colsPivot5 AS NVARCHAR(MAX), @colsPivot5_ntes AS NVARCHAR(MAX), @colsPivot6 AS NVARCHAR(MAX), @colsPivot6_ntes AS NVARCHAR(MAX), @colsPivot7 AS NVARCHAR(MAX), @colsPivot8 AS NVARCHAR(MAX), @colsPivot9 AS NVARCHAR(MAX), @colsPivotArr1 AS NVARCHAR(MAX),  
		...
		@colsPivotArr3_ntes AS NVARCHAR(MAX), @colsPivotArr4_ntes AS NVARCHAR(MAX), @colsPivotArr1_ded_ntes AS NVARCHAR(MAX), @colsPivotArr2_ded_ntes AS NVARCHAR(MAX), @colsPivotArr3_ded_ntes AS NVARCHAR(MAX), @colsPivotArr4_ded_ntes AS NVARCHAR(MAX),@colsPivotArr3_ded_Dup AS NVARCHAR(MAX),@colsPivotArr4_ded_Dup AS NVARCHAR(MAX)
...
,isnull(m.M_AD_Amount,0) as  M_AD_Amount,
...
SELECT     m.Emp_ID,
(isnull(m.M_AD_Amount,0)  + isnull(MS_arear.ms_amount,0) + isnull(m.M_AREAR_AMOUNT,0)+ isnull(m.M_AREAR_AMOUNT_Cutoff,0)) as M_AD_Amount,
'Total_Emp_Contribution' as AD_Sort_NAME
INTO            #v_Ad_Name_E_PartOfCTC2
FROM         T0210_MONTHLY_AD_DETAIL AS m  WITH (NOLOCK) 
			INNER JOIN T0050_AD_MASTER AS a  WITH (NOLOCK) ON a.AD_ID = m.AD_ID AND a.CMP_ID = m.Cmp_ID
			INNER JOIN #Emp_Cons1 Ec ON Ec.emp_id = m.Emp_ID --added jimit 26042016
			Left outer JOIN
...
WHERE   (m.For_Date = @From_Date) --and  
--and (m.M_AD_Amount <> 0) 
AND (m.M_AD_Flag = 'I') and 
AD_NOT_EFFECT_SALARY = 1 and AD_PART_OF_CTC = 1 
...
Declare @colsPivotPartOfCTC2 nvarchar(max)
...
begin 
	...
	select @colsPivotPartOfCTC2 = STUFF((SELECT QUOTENAME(cast(AD_SORT_NAME as varchar(4000))) + ',0) as ' + QUOTENAME(cast(AD_SORT_NAME as varchar(4000))) + ', isnull('
								from #v_Ad_Name_E_PartOfCTC2 as a
								cross apply ( select 'add_sort_name' col, 1 so ) c 
								group by col,a.AD_SORT_NAME,so 
								order by so 
						FOR XML PATH(''), TYPE ).value('.', 'NVARCHAR(MAX)') ,1,1,'')
	...
	set @colsPivotPartOfCTC2 = 'isnull([' + @colsPivotPartOfCTC2
	set @colsPivotPartOfCTC2 = LEFT(@colsPivotPartOfCTC2,len(@colsPivotPartOfCTC2)-9)
...
IF exists(select * from #v_Ad_Name_E_PartOfCTC2)
BEGIN
	SET @query = 'select Emp_id, '+ @colsPivotPartOfCTC2 +' into v_Ad_Name_Calc_E_PartOfCTC2
	from (select emp_id,Ad_sort_name, M_Ad_Amount from #v_Ad_Name_E_PartOfCTC2) 
	as data pivot 
	( sum(M_Ad_Amount) 
	for Ad_sort_name in ([Total_Emp_Contribution]) ) p' 
	exec(@query)
END
else
begin
	select Distinct ve.Emp_id,0 as Total_Allowance into v_Ad_Name_Calc_E_PartOfCTC2
		from v_emp_cons ve
	inner join #Emp_Cons1 Ec ON Ec.emp_id = ve.Emp_ID --added jimit 26042016
	--dbo.split(@emp_id1,'#') as ds on emp_id = data
end
...
If Exists(select top 1 * from sysobjects where name = 'v_Ad_Name_Calc_E_PartOfCTC2' )
	begin
		select * into #v_Ad_Name_E_Calc_PartOfCTC2 from v_Ad_Name_Calc_E_PartOfCTC2
		drop table v_Ad_Name_Calc_E_PartOfCTC2
	end
...
(m.M_AD_Amount <> 0) 
--AND (m.M_AD_Flag = 'D') 
and (a.AD_FLAG = 'D') --Change by ronakk 03112022 for getting error of Ambigues column
...
and M_AD_Flag = 'I' and a.AD_ACTIVE = 1 
and (M_AREAR_AMOUNT <> 0 OR m.M_AREAR_AMOUNT_Cutoff <> 0 or MS_arear.ms_amount <> 0) 
and (AD_NOT_EFFECT_SALARY = 0 OR ReimShow = 1)
and m.Cmp_ID = @Company_ID
and	m.S_Sal_Tran_ID is NULL
order by a.AD_SORT_NAME

if exists (select top 1 * from sysobjects where name = '#v_Ad_Name_EmployerCont_Arr' and type = 'u') 
begin 
	drop table #v_Ad_Name_EmployerCont_Arr
end 

SELECT     m.Emp_ID, (isnull(m.M_AREAR_AMOUNT,0) + isnull(m.M_AREAR_AMOUNT_Cutoff,0) + isnull(MS_arear.ms_amount,0))as M_AREAR_AMOUNT  , replace(a.AD_NAME,' ','_') as AD_SORT_NAME
INTO       #v_Ad_Name_EmployerCont_Arr
FROM         T0210_MONTHLY_AD_DETAIL AS m  WITH (NOLOCK) 
			INNER JOIN T0050_AD_MASTER AS a WITH (NOLOCK) ON a.AD_ID = m.AD_ID AND a.CMP_ID = m.Cmp_ID
			INNER JOIN #Emp_Cons1 Ec ON Ec.emp_id = m.Emp_ID
			LEFT OUTER JOIN
			(
				...
				FROM t0210_monthly_ad_detail MAD WITH (NOLOCK)  
					...
					inner join T0050_AD_MASTER on MAD.Ad_Id = T0050_AD_MASTER.Ad_ID and MAD.Cmp_ID = T0050_AD_MASTER.Cmp_Id
				WHERE MAD.Cmp_ID = @Company_ID and month(MSS.S_Eff_Date) = Month(@To_Date) and Year(MSS.S_Eff_Date) = Year(@To_Date) 
					  and (AD_NOT_EFFECT_SALARY = 1) --- Added "ReimShow" condition by Hardik 30/07/2020 for Arkray
					  and Ad_Active = 1 
				GROUP BY MAD.AD_ID,MSS.Emp_ID
			) as MS_arear   on m.ad_id = MS_arear.AD_ID_arear and  m.emp_id = MS_arear.emp_id_arear
WHERE   (m.For_Date = @From_Date)
...
Declare @colsPivotArr5EmployerCont nvarchar(Max) = ''
Declare @colsPivotArr5EmployerCont1 nvarchar(Max) = ''
Declare @colsPivotArr5EmployerCont2 nvarchar(Max) = ''
...
begin 
	...
	select @colsPivotArr5EmployerCont2 = STUFF((SELECT ',isnull(' + QUOTENAME(cast(AD_SORT_NAME as varchar(4000)) + '_Arrear') + ',0) as' + QUOTENAME(cast(AD_SORT_NAME as varchar(4000)) + '_Arrear') --+ ', isnull('
			from #v_Ad_Name_EmployerCont_Arr as a
			cross apply ( select 'add_sort_name' col, 1 so ) c 
			group by col,a.AD_SORT_NAME,so 
			order by so 
	FOR XML PATH(''), TYPE ).value('.', 'NVARCHAR(MAX)') ,1,1,'')

	select @colsPivotArr5EmployerCont = STUFF((SELECT ',isnull(' + QUOTENAME(cast(AD_SORT_NAME as varchar(4000))) + ',0) as' + QUOTENAME(cast(AD_SORT_NAME as varchar(4000)) + '_Arrear') --+ ', isnull('
			from #v_Ad_Name_EmployerCont_Arr as a
			cross apply ( select 'add_sort_name' col, 1 so ) c 
			group by col,a.AD_SORT_NAME,so 
			order by so 
	...
	select @colsPivotArr5EmployerCont1 = STUFF((SELECT ',' + QUOTENAME(cast(AD_SORT_NAME as varchar(4000))) 
		from #v_Ad_Name_EmployerCont_Arr as a
		cross apply ( select 'add_sort_name' col, 1 so ) c 
		group by col,a.AD_SORT_NAME,so 
		order by so 
...
begin
	...
	from v_emp_cons ve
	inner join #Emp_Cons1 Ec ON Ec.emp_id = ve.Emp_ID 
	--dbo.split(@emp_id1,'#') as ds on emp_id = data
end
...
IF exists(select * from #v_Ad_Name_EmployerCont_Arr)
begin
set @query = 'select Emp_id, '+ @colsPivotArr5EmployerCont +' into #v_Ad_Name_EmployerCont_Arr
	from (select emp_id,Ad_sort_name, M_AREAR_AMOUNT from #v_Ad_Name_EmployerCont_Arr) 
	as data pivot 
	( sum(M_AREAR_AMOUNT) 
	for Ad_sort_name in ('+ @colsPivotArr5EmployerCont1 +') ) p' 
...
select * into #v_Ad_Calc_EmployerCont_Arr from #v_Ad_Name_EmployerCont_Arr
drop table #v_Ad_Name_EmployerCont_Arr
...
--and AD_NOT_EFFECT_SALARY = 0  -- Comment the changes to show the company ESIC as discussed with chintan bhai :- 02022022 Deepal
and m.Cmp_ID = @Company_ID and	m.S_Sal_Tran_ID is NULL    and A.AD_FLAG = 'D'
--added by jimit 25012017 to resolve WCL/RK issue
--and m.emp_id in (select data from dbo.split(@constraint,'#'))
order by a.AD_SORT_NAME
...
begin 
	...
	select 	@colsPivotArr3_ded_dup = STUFF((SELECT QUOTENAME(cast(AD_SORT_NAME as varchar(4000))) + ',0) as ' + QUOTENAME(cast(AD_SORT_NAME as varchar(4000))+'_Arrear_ded_Dup') + ', isnull('
								from #v_Ad_Name_Arr_ded as a
								cross apply ( select 'add_sort_name' col, 1 so ) c 
								group by col,a.AD_SORT_NAME,so 
								order by so 
	...
	select @colsPivotArr4_ded_dup = STUFF((SELECT '+ isnull(' + QUOTENAME(cast(AD_SORT_NAME as varchar(4000)) + '_Arrear_ded_Dup') +',0)'
							from #v_Ad_Name_Arr_ded as a
							cross apply ( select 'add_sort_name' col, 1 so ) c 
							group by col,a.AD_SORT_NAME,so 
							order by so 
...
set @colsPivotArr3_ded_dup = 'isnull([' + @colsPivotArr3_ded_dup

set @colsPivotArr3_ded_dup = LEFT(@colsPivotArr3_ded_dup,len(@colsPivotArr3_ded_dup)-9)
...
IF OBJECT_ID('tempdb..#v_Ad_Name_Arr_ded_dup') IS NOT NULL 
	DROP TABLE #v_Ad_Name_Arr_ded_dup


CREATE TABLE #v_Ad_Name_Arr_ded_dup
(
	EMP_ID  NUMERIC(18,0),
	M_AREAR_AMOUNT NUMERIC(18,0),
	AD_SORT_NAME VARCHAR(2000)
)

-- deepal 02082022 add new logic to remove the negative amount
IF ((select count(1) from #v_Ad_Name_Arr_ded) > 0)
BEGIN 

	insert into #v_Ad_Name_Arr_ded_dup
	select *  from #v_Ad_Name_Arr_ded
	UPDATE #V_AD_NAME_ARR_DED_DUP SET M_AREAR_AMOUNT = 0  WHERE M_AREAR_AMOUNT < 0
END
else
BEGIN
	insert into #v_Ad_Name_Arr_ded_dup
	select *  from #v_Ad_Name_Arr_ded where 1=0
END

--if exists(select * from #v_Ad_Name_Arr_ded_dup)
if ((select count(1) from #v_Ad_Name_Arr_ded_dup) > 0)
begin
set @query = 'select Emp_id, ' + @colsPivotArr3_ded_dup + ' into v_Ad_Calc_Arr_ded_Dup
	from (select emp_id,Ad_sort_name, M_AREAR_AMOUNT from #v_Ad_Name_Arr_ded_dup) 
	as data pivot 
	( sum(M_AREAR_AMOUNT) 
	for Ad_sort_name in ('+ @colsPivotArr1_ded +') ) p' 
exec (@query)
...
begin
	select Distinct ve.Emp_id,0 as Total_Deduction into v_Ad_Calc_Arr_ded_Dup
	from v_emp_cons ve
	inner join #Emp_Cons1 Ec ON Ec.emp_id = ve.Emp_ID  --added jimit 26042016
	--dbo.split(@emp_id1,'#') as ds on emp_id = data
end

select * into #v_Ad_Calc_Arr_ded_dup from v_Ad_Calc_Arr_ded_Dup
drop table v_Ad_Calc_Arr_ded_Dup
...
if exists (select top 1 * from sysobjects where name = '#v_Loan_pvt' and type = 'u') 
	...
	set @ColsPivot_Loan = STUFF((SELECT ',' + QUOTENAME(cast(Replace(Replace(Replace(Replace(REPLACE(Replace(REPLACE(Replace(REPLACE(replace(Replace(Replace(Replace(Replace(ltrim(rtrim(Loan_Name)),'+','_'),'''','_'),',','_'),'.','_'),'  ',' '),'%',''),'-',' '),'@',''),'(',''),')',''),' ','_'),'__','_'),'__','_'),'/','') as varchar(4000))) 
	...
	--					FOR XML PATH(''), TYPE ).value('.', 'NVARCHAR(MAX)') ,1,1,'')
		...
		begin
			...
			set @qry_Loan = 'select Emp_id, '+ replace(replace(@colsPivot_Loan , '(',''),')','') +' into v_Loan 							
						from (select emp_id,replace(replace(REPLACE(Loan_Name,'' '',''_''),''('',''''),'')'','''') As Loan_Name, IsNULL(Loan_Amount,0) as Loan_Amount from #v_Loan_pvt3) 
						as data pivot 
						( sum(Loan_Amount) 
						for Loan_Name in ('+ replace(replace(@colsPivot_Loan , '(',''),')','') +') ) p' 
...
SELECT	Distinct	''="'' + EM.Alpha_Emp_Code + ''"'' as EMP_CODE,		
			...
			--	ms.gross_salary - isnull(ms.Settelement_Amount,0) +(isnull(ms.Arear_Basic,0) + isnull(ms.Basic_Salary_arear_cutoff,0) + isnull(sett.S_Salary_Amount,0)) 
			--	+ isnull(' + isnull(@colsPivotArr3,0) + ',0)
			--Else
			--	ms.gross_salary
			--End As Gross_Salary,
			----ms.gross_salary As Gross_Salary,
			(Isnull(ms.salary_Amount,0) + IsNull(mADi.Allow_Amount,0) + isnull(ms.Arear_Basic,0) + isnull(ms.Basic_Salary_arear_cutoff,0) + isnull(sett.S_Salary_Amount,0)) + isnull(' + isnull(@colsPivotArr3,0) + ',0)  As Gross_Salary
			,ms.PT_Amount,
			...
			' + isnull(@colsPivot9,0) + ' + IsNull(ms.PT_Amount,0) + isnull(ms.loan_amount,0) + isnull(ms.Loan_Intrest_Amount,0) 
			+ Isnull(Advance_Amount,0)+ms.Revenue_Amount + isnull(ms.LWF_Amount,0) + Isnull(Other_Dedu_Amount,0) +isnull(ms.GatePass_Amount,0)
			+isnull(ms.Asset_Installment,0)+isnull(ms.Uniform_Dedu_Amount,0)+isnull(ms.Late_Dedu_Amount,0)    
			as Total_Deduction,
			' + isnull(@colsPivotArr4_ded,'0 as Arear_Deduction')+ ',
			...
			--ms.Total_Dedu_Amount  +' + isnull(@colsPivotArr4_ded_dup,0) + '   as Net_Total_Deduction, 
			--'+ isnull(@colsPivot9,0) + ' as colP ,
			-- IsNull(ms.PT_Amount,0) as pt1,
			-- isnull(ms.loan_amount,0)  as LA,
			-- isnull(ms.Loan_Intrest_Amount,0) as LIA,
			-- Isnull(Advance_Amount,0) as AD ,
			-- ms.Revenue_Amount  as RA,
			-- isnull(ms.LWF_Amount,0) as LWFA,
			-- Isnull(Other_Dedu_Amount,0) as ODA,
			-- isnull(ms.GatePass_Amount,0) as GPA,
			--  isnull(ms.Asset_Installment,0) as AI,
			--  isnull(ms.Uniform_Dedu_Amount,0) as UDA,
			--  isnull(ms.Late_Dedu_Amount,0)  as LDA,
			--' + isnull(@colsPivotArr4_ded_dup,0) + ' as ddp,
			--case when ' + isnull(@colsPivotArr4_ded_dup,0) + ' > 0 then ' + isnull(@colsPivotArr4_ded_dup,0) + ' else ' + isnull(@colsPivotArr3_ded,0) + ' END as  TAD,
			'+ isnull(@colsPivot9,0) + ' + IsNull(ms.PT_Amount,0) + isnull(ms.loan_amount,0) + isnull(ms.Loan_Intrest_Amount,0) 
			+ Isnull(Advance_Amount,0)+ms.Revenue_Amount + isnull(ms.LWF_Amount,0) + Isnull(Other_Dedu_Amount,0) +isnull(ms.GatePass_Amount,0)
			+ isnull(ms.Asset_Installment,0)+isnull(ms.Uniform_Dedu_Amount,0)+isnull(ms.Late_Dedu_Amount,0) +
			--' + isnull(@colsPivotArr4_ded_dup,0) + ' 
			case when ' + isnull(@colsPivotArr4_ded_dup,0) + ' > 0 then ' + isnull(@colsPivotArr4_ded_dup,0) + ' else ' + isnull(@colsPivotArr3_ded,0) + ' END
			as Net_Total_Deduction
			...
			'+ isnull(@colsPivotArr5EmployerCont2,'0 as Employer_PF_Contribution_Arear') + ',
			'+ isnull(@colsPivotPartOfCTC2,'0 as Total_Emp_Contribution') + ',
			(Isnull(ms.salary_Amount,0) + IsNull(mADi.Allow_Amount,0) + isnull(ms.Arear_Basic,0) + isnull(ms.Basic_Salary_arear_cutoff,0)
			+ isnull(sett.S_Salary_Amount,0)) + isnull(' + isnull(@colsPivotArr3,0) + ',0) 
			+  isnull(' + isnull(@colsPivotPartOfCTC_Sum,0) + ',0) as Total_CTC_Salary, 
...
FROM         V_Emp_Cons AS ec INNER JOIN
						   (select Max(TI.Increment_ID) Increment_Id,ti.Emp_ID,ti.Fix_OT_Hour_Rate_WD,ti.Fix_OT_Hour_Rate_WO_HO from t0095_increment TI WITH (NOLOCK)  inner join
                            ...
                            inner join t0040_General_Setting gs WITH (NOLOCK)  on ec.cmp_id = gs.cmp_id and ec.branch_id = gs.branch_id and  gs.For_Date = (select max(for_date) From T0040_General_Setting where Cmp_ID = ec.cmp_id and Branch_ID =ec.branch_id)
                            ...
                            inner join (select * from t0200_monthly_salary WITH (NOLOCK)  where  cmp_ID = ' + cast(@Company_id as nvarchar(max)) + ' And Month_St_Date = '''+convert(nvarchar(10),@From_Date,101)+''') as ms on ec.Emp_ID = ms.Emp_ID and ec.Cmp_ID = ms.Cmp_ID
                            ...
                            left join (select t1.* from T0095_INCREMENT t1 WITH (NOLOCK)  inner join (SELECT Emp_ID, MAX(Increment_ID) AS Increment_ID FROM T0095_INCREMENT WITH (NOLOCK)  where  cmp_ID = ' + cast(@Company_id as nvarchar(3)) + ' And increment_effective_date <= '''+convert(nvarchar(10),@To_Date,101)+''' and increment_type <> ''transfer'' GROUP BY Emp_ID) t2 
                            ...
                            left outer join (select Sal_Tran_ID,Emp_ID,SUM(case when ReimAmount <>0  then ReimAmount else M_AD_Amount end) as Allow_Amount from T0210_MONTHLY_AD_DETAIL WITH (NOLOCK)  where month(for_Date) = month('''+convert(nvarchar(10),@From_Date,101)+''') and year(for_date) = year('''+convert(nvarchar(10),@From_Date,101)+''') and M_AD_Flag = ''I'' and AD_ID in ( select distinct ad_id from t0050_AD_MASTER WITH (NOLOCK)  where (AD_NOT_EFFECT_SALARY = 0 OR (ReimShow = 1 and isnull(reimamount,0)<>0)  And cmp_ID = ' + cast(@Company_id as nvarchar(3)) + ' ) and s_Sal_Tran_Id is null and cmp_ID = ' + cast(@Company_id as nvarchar(3)) + ') group by Sal_Tran_ID,Emp_ID) as mADi ON ec.Emp_ID = mADi.Emp_id and  ms.Sal_Tran_ID = mADi.Sal_Tran_ID
							...
							left outer join #v_Ad_Name_E_Calc_PartOfCTC2 as epart1 on ec.Emp_ID = epart1.emp_id  
							left outer join #v_Ad_Calc_EmployerCont_Arr as Empcont on ec.Emp_ID = Empcont.emp_id  
                            left outer join #v_Ad_Calc_Arr_ded as mArr_ded on ec.Emp_ID = mArr_ded.Emp_ID
							left outer join #v_Ad_Calc_Arr_ded_dup as mArr_ded_Dup on ec.Emp_ID = mArr_ded_Dup.Emp_ID
...
set @query2 = 'LEFT OUTER JOIN 
			...
			LEFT OUTER JOIN (Select R.*, E.Alpha_Emp_Code As Manager_Code, E.Emp_Full_Name As Manager_Name From dbo.fn_getReportingManager(' + cast(@Company_id as nvarchar(3)) + ',Null,Getdate()) R Inner Join T0080_Emp_Master E WITH (NOLOCK) on R.R_Emp_Id = E.Emp_Id) As Qry_Reporting On EC.Emp_Id = Qry_Reporting.Emp_Id
			) Qry'
...
begin
		...
		begin
		--set @String = ' select CM.Designation as Designation, SUM(CM.Basic_Salary) as Basic_Salary '+ @sum_of_allownaces_earning +',SUM(CM.Gross_Salary)as Gross_Salary '+ @sum_of_allownaces_deduct +',SUM(CM.Other_Allow)as Other_Allowance,SUM(CM.Actual_CTC) as CTC,SUM(cm.advance_amount)as Advance_Amount,SUM(CM.arear_amount)as Arear_Amount,SUM(CM.PT_Amount)as PT_Amount,SUM(cm.Loan_Amount)as Loan_Amount,SUM(cm.ot_rate)as OT_Rate,SUM(cm.ot_hours)as OT_Hours,SUM(cm.ot_amount)as OT_Amount,SUM(cm.revenue_amount) as Revenue_Amount,SUM(cm.lwf_amount)as LWF_Amount,SUM(CM.Settl_Salary)as Settlement_Salary,SUM(cm.net_amount)as Net_Amount,SUM(CM.Present_Day) as Present_Days,SUM(CM.Arear_Day) as Arear_Days,SUM(CM.Absent_Day) as Absent_Day,SUM(CM.Holiday_Day)as Holidy_day,SUM(CM.WeekOff_Day)as Week_Off_Days,SUM(CM.Sal_Cal_Day)as Sal_cal_Day,SUM(cm.total_leave_days)as Total_leave_Days,SUM(CM.total_paid_leave_days)as Total_Paid_Leave_Days '
