...
CREATE PROCEDURE [dbo].[SP_GET_LEAVE_STATUS]  
  @Cmp_ID  Numeric  
 ,@From_Date  Datetime  
 ,@To_Date  Datetime  
 ,@Emp_ID  Numeric  
...
SET ARITHABORT ON   
  ...
  declare @Closing as numeric(18,2)  
  declare @Opening as numeric(18,2)  
  declare @Earn as numeric(18,2)  
  declare @Adj_LMark as numeric(18,2)  
  declare @Adj_Absent as numeric(18,2)   
  declare @Total_Adj as numeric(18,2)  
		...
		open curleavestaus
				...
				while @@fetch_status = 0
					begin
						   ...
						   update @Emp_Leave_Bal   
						   set Leave_Used = Q.Leave_Used + Q.BACKDATED_LEAVE
						   From @Emp_Leave_Bal  LB Inner join    
						   ( select Emp_ID , Leave_ID ,Sum(Leave_Used) as Leave_Used 
