-- EXEC  [dbo].[SP_Employee_BirthDay_Reminder] 119,'yogesh.p@orangewebtech.com'  
CREATE PROCEDURE [dbo].[SP_Employee_BirthDay_Reminder_Test]  
...
BEGIN     
 ...
 SELECT   
  ...
  CONVERT(varchar(7),date_of_birth,6) as Date_of_birth  
     ...
     ---ALTER dynamic template for Employee.      
        ...
        @TableTail varchar(max)     
          ...
          <td height="9" align="center" valign="middle" ></td>  
           ...
           <tr>  
          <td width="800" height="24" align="center" valign="middle" style="background:#0b0505;font-family:Arial, Helvetica, sans-serif; color:#FFFFFF;  text-decoration:none; font-weight:bold; text-align:center; font-size:13px;">Today''s Birthday Report (
 ' + @Date + ') </td>  
           </tr>  
            <tr>  
    ...
    ELSE  
     ...
     END  
              ...
              --select @profile = isnull(DB_Mail_Profile_Name,'') from t9999_Reminder_Mail_Profile where cmp_id = @cmp_id -- code commented by yogseh on 19122022  
        select @profile = isnull(DB_Mail_Profile_Name,'') from t9999_Reminder_Mail_Profile where cmp_id = @cmp_id_Pass  
