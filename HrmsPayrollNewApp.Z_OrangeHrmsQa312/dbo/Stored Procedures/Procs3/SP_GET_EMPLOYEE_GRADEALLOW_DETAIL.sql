...
CREATE PROCEDURE [dbo].[SP_GET_EMPLOYEE_GRADEALLOW_DETAIL]  
 @Cmp_ID numeric,  
 @Emp_ID numeric,
 @For_Date DateTime,
 @Grd_ID numeric  =0,
...
Insert into @Last_Increment  
	select I.Increment_Effective_Date,I.Increment_ID,I.Cmp_ID,I.Emp_ID,I.Grd_ID,I.Branch_ID  
	From T0095_Increment I WITH (NOLOCK) inner join     
	   (
			select max(Increment_effective_Date) as For_Date,Emp_ID 
			from T0095_Increment WITH (NOLOCK)   
			where Increment_Effective_date <= @For_Date and Cmp_ID = @Cmp_ID 
			group by emp_ID
		) Qry 
	...
	Where I.Emp_ID = @Emp_ID 
			...
			Else
				BEGIN
					 ...
					 Select @Branch_ID = Branch_Id From @Last_Increment Where Emp_Id = @Emp_ID and Cmp_ID = @Cmp_ID
