...
CREATE  PROCEDURE [dbo].[Set_Salary_Register_Amount_NIIT_Total_Rate]
 @Cmp_ID		numeric
,@From_Date		datetime
,@To_Date		datetime 
,@Branch_ID		numeric  
...
SET ARITHABORT ON
	...
	WHILE @@FETCH_STATUS = 0
		BEGIN
						...
						Declare @Salary1 as numeric(18,0)
						set @Salary1 =0
				...
				/*	INSERT INTO dbo.#Temp_Salary_Muster_Report
					...
					VALUES     (@Emp_ID, @Cmp_ID, @Transaction_ID, @Month, @Year,'Basic', @Basic_Salary,'',5,'I',@Salary1)
					...
					declare Cur_Dedu   cursor for
						...
						Case 
						     ...
						     Else   t0050_ad_master.AD_Amount
						   End from t0210_monthly_ad_detail MAD WITH (NOLOCK) inner join
							t0050_ad_master WITH (NOLOCK) on MAD.Ad_Id = t0050_ad_master.Ad_ID left outer join #Temp_Salary_Muster_Report
							on MAD.Emp_Id = #Temp_Salary_Muster_Report.Emp_ID 
							and MAD.Cmp_ID = t0050_ad_master.Cmp_Id
							and MAD.Emp_ID  = @Emp_ID
