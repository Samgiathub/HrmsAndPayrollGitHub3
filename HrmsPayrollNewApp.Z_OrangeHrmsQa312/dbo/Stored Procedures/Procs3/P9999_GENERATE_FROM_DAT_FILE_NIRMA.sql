...
CREATE PROCEDURE [dbo].[P9999_GENERATE_FROM_DAT_FILE_NIRMA]
	@Path as varchar(max) = 'E:\Nimesh\task\DAT_JOB' --Assign the folder path where all the .dat files are located
AS
BEGIN
SET NOCOUNT ON 
