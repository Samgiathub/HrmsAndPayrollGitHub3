...
-- =============================================
create PROCEDURE [dbo].[P0090_Ticket_Application_Aswini_20_12_2023]
...
SET ARITHABORT ON
	...
	if @Trantype = 'I'
		Begin
			...
			if Exists(SELECT 1 FROM T0090_Ticket_Application WITH (NOLOCK) Where Cmp_ID = @Cmp_ID AND Emp_ID = @Emp_ID AND Ticket_Type_ID = @Ticket_Type_ID AND Ticket_Status = 'O')
				BEGIN
