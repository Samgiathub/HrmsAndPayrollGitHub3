...
CREATE PROCEDURE [dbo].[P0130_CLAIM_SUBDETAIL]
		...
		BEGIN
					...
					if @Claim_Apr_Id = 0
						Begin
							...
							ISNULL(TAP.Claim_From_Loc_ID,0) as Claim_From_Loc_ID,ISNULL(TAP.Claim_To_Loc_ID,0) as Claim_To_Loc_ID
		...
		BEGIN
			...
			IF(@CLAIM_LIMIT_TYPE = 'D')
				BEGIN
					...
					INNER JOIN T0130_CLAIM_APPROVAL_DETAIL CAD ON CAD.Claim_App_ID=TAP.Claim_App_ID AND CAD.Claim_ID = TAP.Claim_ID
