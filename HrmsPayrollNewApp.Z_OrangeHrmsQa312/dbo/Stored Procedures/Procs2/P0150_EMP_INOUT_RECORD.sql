...
CREATE PROCEDURE [dbo].[P0150_EMP_INOUT_RECORD]    
 ...
 set @For_Date = cast(cast(@For_Date as varchar(11)) as smalldatetime)    
  ...
  If @tran_type ='I'     
   begin    
     ...
     Insert Into T0150_EMP_INOUT_RECORD(IO_Tran_Id,Emp_ID,Cmp_ID,For_Date,In_Time,Out_Time,Duration,Reason,Ip_Address,Skip_Count)    
     values(@IO_Tran_Id,@Emp_ID,@Cmp_ID,@For_Date,@In_Time,@Out_Time,dbo.F_Return_Hours(@Duration),@Reason,@Ip_Address,@Skip_Count)    
