...
CREATE PROCEDURE [dbo].[P0080_Grievance_Application_Admin_Side]  
   ...
   ,@EmpIDF int
   ,@NameF nvarchar(100)
   ,@AddressF nvarchar(1000)
   ,@EmailF nvarchar(500)
   ,@ContactF nvarchar(50)
   ,@RecieveFrom int 
   ,@tran_type  varchar(1) 
   ,@Griev_Against int 
   ,@EmpIDT int
   ...
   ,@LoginID int 
   ,@AppNo nvarchar(20)=''  -- Added by ronakk 11042022
AS  
SET NOCOUNT ON 
SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED
SET ARITHABORT ON
  
  --Created by Ronak Kumawat 07032022
