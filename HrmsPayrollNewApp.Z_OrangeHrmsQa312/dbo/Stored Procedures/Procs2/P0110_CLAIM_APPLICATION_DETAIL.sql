...
CREATE PROCEDURE [dbo].[P0110_CLAIM_APPLICATION_DETAIL]
	...
	,@Claim_Frm_Loc	NUMERIC(18,3) = NULL
	,@Claim_To_Loc	NUMERIC(18,3) = NULL
	...
	If UPPER(@Tran_Type) = 'I' or UPPER(@Tran_Type) = 'F' 
		Begin
			...
			Insert Into T0110_CLAIM_APPLICATION_DETAIL 
					...
					Claim_BookName,Claim_Subject,Claim_ActualPrice,Claim_PriceAfterDiscount,Claim_FamilyMember,Claim_Relation,Claim_Age,Claim_Limit,Claim_FamilyMeberId,Claim_UnitName,Claim_UnitFlag,
					Claim_ConversionRate,ClaimSelf_Value,Claim_Date_Label,Claim_From_Loc_ID,Claim_To_Loc_ID,City_name)
				...
				@BookName,@Subject,@ActualPrice,@PriceAfterDiscount,@FamilyMember,@Relation,@Age,@FamilyLimit,@RowId,@UnitName,@UnitFlag,@ConversionRate,@SelfAmount,
				@Claim_Date_Label,@Claim_Frm_Loc,@Claim_To_Loc,@City_Name)
		...
		begin
			...
			Insert Into T0110_CLAIM_APPLICATION_DETAIL 
					...
					Claim_From_Loc_ID,Claim_To_Loc_ID,City_name)
				...
				@Claim_Frm_Loc,@Claim_To_Loc,@City_Name) -- @Claim_Attachment ADDED ON 17022018 BY RAJPUT
