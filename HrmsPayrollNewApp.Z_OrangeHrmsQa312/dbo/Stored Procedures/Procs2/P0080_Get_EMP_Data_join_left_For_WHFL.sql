...
-- =============================================            
   -- exec P0080_Get_EMP_Data_join_left_For_WHFL  
         
CREATE  PROCEDURE [dbo].[P0080_Get_EMP_Data_join_left_For_WHFL]    
  AS            
  BEGIN   
...
DECLARE @URL NVARCHAR(MAX) = 'https://lapps-in21.leadsquared.com/executebylapptoken?name=da_68887_c39667a4&stage=Test&xapikey=c008734dc08b4ec0944894ec950b7665';  
...
buisness varchar(50),  
associatedPhoneNumber varchar(50),  
...
exec P0080_Get_EMP_Data_join_left   
...
from #EmpDetails where RNo=@counter FOR JSON AUTO)  
