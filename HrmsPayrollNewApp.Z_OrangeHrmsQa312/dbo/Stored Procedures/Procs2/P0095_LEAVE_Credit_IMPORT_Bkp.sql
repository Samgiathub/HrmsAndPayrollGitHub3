...
SET ARITHABORT ON
		...
		--Added by Deepali - 09012024
		print @LEAVE_Credit_DAYS
		Declare @tmpLEAVE_Credit_DAYS as numeric(18,0) 
		set @tmpLEAVE_Credit_DAYS = convert(decimal , @LEAVE_Credit_DAYS)
		print @tmpLEAVE_Credit_DAYS
		--return
		--Added by Deepali - 09012024
		SET @LEAVE_CF_ID=0
		SET @EMP_ID =0
	...
	------ended------
		...
		begin
				...
				Update T0100_LEAVE_CF_DETAIL
							set 
							CF_Leave_Days=@tmpLEAVE_Credit_DAYS
							,CF_Type=@Credit_Type
