...
CREATE PROCEDURE [dbo].[P0110_TRAVEL_OTHER_MODE_DETAIL_EMAIL_TEMPLATE]
	 @Cmp_ID					Numeric(18,0)
...
BEGIN
	...
	SET @HTML_TABLE = ''
			...
			IF EXISTS(	SELECT		1
						FROM		T0110_TRAVEL_APPLICATION_OTHER_DETAIL TOD WITH (NOLOCK)
						LEFT JOIN	T0110_TRAVEL_APPLICATION_MODE_DETAIL TAD WITH (NOLOCK) ON TOD.TRAVEL_APP_OTHER_DETAIL_ID = TAD.TRAVEL_APP_OTHER_DETAIL_ID AND TOD.TRAVEL_APP_ID = TAD.TRAVEL_APP_ID
						WHERE		TOD.CMP_ID = @CMP_ID AND TAD.TRAVEL_MODE = 1 AND TAD.TRAVEL_APP_ID = @Travel_App_ID)
		...
		IF EXISTS (	SELECT		1
					FROM		T0110_TRAVEL_APPLICATION_OTHER_DETAIL TOD WITH (NOLOCK)
					LEFT JOIN	T0110_TRAVEL_APPLICATION_MODE_DETAIL TAD WITH (NOLOCK) ON TOD.TRAVEL_APP_OTHER_DETAIL_ID = TAD.TRAVEL_APP_OTHER_DETAIL_ID AND TOD.TRAVEL_APP_ID = TAD.TRAVEL_APP_ID
					WHERE		TOD.CMP_ID = @CMP_ID AND TAD.TRAVEL_MODE = 2 AND TAD.TRAVEL_APP_ID = @Travel_App_ID)
						BEGIN
		...
		IF EXISTS(SELECT		TAD.MODE_NAME,TAD.CITY,CONVERT(VARCHAR, CONVERT(DATE,TAD.CHECK_OUT_DATE), 9) AS CHECK_OUT_DATE
					FROM		T0110_TRAVEL_APPLICATION_OTHER_DETAIL TOD WITH (NOLOCK)
					LEFT JOIN	T0110_TRAVEL_APPLICATION_MODE_DETAIL TAD WITH (NOLOCK) ON TOD.TRAVEL_APP_OTHER_DETAIL_ID = TAD.TRAVEL_APP_OTHER_DETAIL_ID AND TOD.TRAVEL_APP_ID = TAD.TRAVEL_APP_ID
					WHERE		TOD.CMP_ID = @CMP_ID AND TAD.TRAVEL_MODE = 6 AND TAD.TRAVEL_APP_ID = @Travel_App_ID)
					BEGIN
		...
		IF EXISTS(	SELECT		1
					FROM		T0110_TRAVEL_APPLICATION_OTHER_DETAIL TOD WITH (NOLOCK)
					LEFT JOIN	T0110_TRAVEL_APPLICATION_MODE_DETAIL TAD WITH (NOLOCK) ON TOD.TRAVEL_APP_OTHER_DETAIL_ID = TAD.TRAVEL_APP_OTHER_DETAIL_ID AND TOD.TRAVEL_APP_ID = TAD.TRAVEL_APP_ID
					WHERE		TOD.CMP_ID = @CMP_ID AND TAD.TRAVEL_MODE = 3 AND TAD.TRAVEL_APP_ID = @Travel_App_ID)
					BEGIN
						...
						set @HTML_TABLE = @HTML_TABLE +  '</table><table border=''1''  style=''margin-top: 10px;border-collapse: collapse;width:100%;''>
								...
								<tr>
								<td style=''font-family: Verdana;font-size: 9pt;text-align: Center;text-decoration: none;background-color: #e6e3da;width:100px;width:50px''>
									No Of Passengers
								</td>
								<td style=''font-family: Verdana;font-size: 9pt;text-align: Center;text-decoration: none;background-color: #e6e3da;width:100px;''>
									Booking Date
		...
		IF EXISTS(	SELECT		1
					FROM		T0110_TRAVEL_APPLICATION_OTHER_DETAIL TOD WITH (NOLOCK)
					LEFT JOIN	T0110_TRAVEL_APPLICATION_MODE_DETAIL TAD WITH (NOLOCK) ON TOD.TRAVEL_APP_OTHER_DETAIL_ID = TAD.TRAVEL_APP_OTHER_DETAIL_ID AND TOD.TRAVEL_APP_ID = TAD.TRAVEL_APP_ID
					WHERE		TOD.CMP_ID = @CMP_ID AND TAD.TRAVEL_MODE = 4 AND TAD.TRAVEL_APP_ID = @Travel_App_ID)
					BEGIN
		...
		IF EXISTS(	SELECT		1
					FROM		T0110_TRAVEL_APPLICATION_OTHER_DETAIL TOD WITH (NOLOCK)
					LEFT JOIN	T0110_TRAVEL_APPLICATION_MODE_DETAIL TAD WITH (NOLOCK) ON TOD.TRAVEL_APP_OTHER_DETAIL_ID = TAD.TRAVEL_APP_OTHER_DETAIL_ID AND TOD.TRAVEL_APP_ID = TAD.TRAVEL_APP_ID
					WHERE		TOD.CMP_ID = @CMP_ID AND TAD.TRAVEL_MODE = 5 AND TAD.TRAVEL_APP_ID = @Travel_App_ID)
					BEGIN
		...
		IF EXISTS(	SELECT		1
					FROM		T0110_TRAVEL_APPLICATION_OTHER_DETAIL TOD WITH (NOLOCK)
					LEFT JOIN	T0110_TRAVEL_APPLICATION_MODE_DETAIL TAD WITH (NOLOCK) ON TOD.TRAVEL_APP_OTHER_DETAIL_ID = TAD.TRAVEL_APP_OTHER_DETAIL_ID AND TOD.TRAVEL_APP_ID = TAD.TRAVEL_APP_ID
					WHERE		TOD.CMP_ID = @CMP_ID AND TAD.TRAVEL_MODE = 7 AND TAD.TRAVEL_APP_ID = @Travel_App_ID)
					BEGIN
