...
CREATE PROCEDURE [dbo].[P0160_user_right_View_Userside]  
  @Login_ID  numeric  
 ,@cmp_ID     numeric  
 ,@Form_ID   numeric  
...
declare @Login numeric  
 ...
 insert into @Data (login_ID,Cmp_ID,Form_ID)  
  
 select @Login_ID ,@cmp_ID ,Form_ID from T0000_Default_Form WITH (NOLOCK)
