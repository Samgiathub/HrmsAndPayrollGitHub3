...
CREATE PROCEDURE [dbo].[P0200_Manually_Salary_Mid_Increment]      
 @M_Sal_Tran_ID  Numeric       
,@Emp_Id   Numeric      
,@Cmp_ID   Numeric      
,@Sal_Generate_Date datetime      
,@Month_St_Date  Datetime      
,@Month_End_Date Datetime      
,@Present_Days  Numeric(18,1)    output   
...
,@Allo_On_Leave numeric(18,2)=1
,@Old_basic_Salary  numeric(18,2) =0 output 
,@Old_Actuall_Gross_Salary numeric(18,2) =0 output
,@Present_Days1 numeric(18,2)  =0  output
  	...
  	IF @Month_St_Date <= @Increment_Effective_Date
		Begin		
		   ...
		   If @Actual_Gross = 1
            ...
            End      		
		End
	     set @Present_Days1=@Present_Days
         set @Present_Days =@Old_Present_Days2
