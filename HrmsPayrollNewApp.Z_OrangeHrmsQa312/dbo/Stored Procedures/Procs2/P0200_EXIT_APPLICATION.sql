...
CREATE PROCEDURE [dbo].[P0200_EXIT_APPLICATION]
...
SET ARITHABORT ON
	...
	If UPPER(@tran_type) = 'I'
		BEGIN
			...
			IF @STATUS = 'P' AND @IS_PROCESS = 'Y'
				...
				END
				--ronakb 081024
               exec P9999_Audit_get @table='ExitApplication' ,@key_column='exit_id',@key_Values=@exit_id,@String=@String output      
	...
	--	end
	--Ronakb 081024
	 EXEC P9999_Audit_Trail @Cmp_ID,@Tran_Type,'ExitApplication',@OldValue,@exit_id,@User_Id,@IP_Address  
