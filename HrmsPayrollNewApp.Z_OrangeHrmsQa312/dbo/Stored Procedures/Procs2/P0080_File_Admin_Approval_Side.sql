...
CREATE PROCEDURE [dbo].[P0080_File_Admin_Approval_Side]  
	...
	,@Rpt_Level			INT--added
	,@FileTypeNumber  nvarchar(max)--added by mansi 19-08-22
AS  
SET NOCOUNT ON 
  ...
  if exists (Select File_Apr_Id   from T0080_File_Approval WITH (NOLOCK) Where File_Apr_Id =  @FA_Id and cmp_id=@Cmp_ID  )   
	...
	--added for  adding application start
	 ...
	 declare @ApplicationDate as datetime=getdate()
	  ...
	  DECLARE @FileTypeName as nvarchar(max)--added on 30-09-22
	  set @FileTypeName=(select isnull(TypeTitle,'') from T0040_File_Type_Master where Cmp_ID=@Cmp_ID and F_TypeID=@FileType_Id)--added on 30-09-22
     exec P0080_File_Application_Admin_Side @File_App_Id OUTPUT,@Cmp_ID,@ApplicationDate,@Branch_Id,@Dept_Id,@Desig_Id,@Emp_Id,@S_Emp_Id,@FileNumber,@FileType_Id,'I',@Subject,@Description,@ProcessDate,@FileName,@LoginID,@IP_Address,@Comment,@FileTypeNumber --added on 30-09-22 @FileTypeName parameter remove by Manisha on 11-11-2024 for Bug #31751
		...
		-- print 11--mansi
		   ...
		   INSERT INTO dbo.T0115_File_Level_Approval
					...
					VALUES (@tran_Id,@ApproveDate,0,@Cmp_ID,@File_App_Id,@Emp_ID,@FileNumber,@FileStatus_Id,@FileType_Id,@Subject,@Description,@ProcessDate,@FileName,@Forward_Emp_Id,@Submit_Emp_Id,@Comment,@S_Emp_Id,@Rpt_Level,getDate(),@LoginID,@Review_Emp_Id,@Reviewed_by_Emp_Id,@FileTypeNumber)	
				-- Add for audit(start)
					...
					VALUES (@Cmp_ID,@File_App_Id,0,@Emp_ID,@FileNumber,@FileStatus_Id,@FileType_Id,@Subject,@Description,@S_Emp_Id,@ProcessDate,@FileName,@Forward_Emp_Id,@Submit_Emp_Id,@Comment,@Review_Emp_Id,@Reviewed_by_Emp_Id,@Rpt_Level,getDate(),@LoginID,@tran_type,@Tran_ID,'T0115_File_Level_Approval',@FileTypeNumber)	
					--for History end
					...
					if not exists(select 1 from T0115_File_Level_Approval_Forward where File_App_Id=@File_App_Id and Cmp_Id=@Cmp_ID and Rpt_Level=@Rpt_Level)
							begin 
								...
								INSERT INTO dbo.T0115_File_Level_Approval_Forward
									   (Tran_Id,Approve_Date,File_Apr_Id,Cmp_Id,File_App_Id,Emp_Id,File_Number,F_StatusId,F_TypeId,Subject,Description,Process_Date,File_App_Doc,Forward_Emp_Id,Submit_Emp_Id,Approval_Comments,S_Emp_Id,Rpt_Level,System_Date,[User ID],Review_Emp_Id,Reviewed_by_Emp_Id,File_Type_Number)
								VALUES (@tran_id_fw_i,@ApproveDate,0,@Cmp_ID,@File_App_Id,@Emp_ID,@FileNumber,@FileStatus_Id,@FileType_Id,@Subject,@Description,@ProcessDate,@FileName,@Forward_Emp_Id,@Submit_Emp_Id,@Comment,@S_Emp_Id,@Rpt_Level,getDate(),@LoginID,@Review_Emp_Id,@Reviewed_by_Emp_Id,@FileTypeNumber)	
							end
   ...
   -- Add for audit(start)
			...
			INSERT INTO T0080_File_Approval (Approve_Date,Branch_Id,Dept_Id,Desig_Id,Emp_Id,S_Emp_Id,File_Number,F_StatusId,F_TypeId,Subject,Description,Process_Date,File_App_Doc,Cmp_ID,CreatedDate,[User ID],Forward_Emp_Id,Submit_Emp_Id,CreatedBy,Approval_Comments,File_App_Id,Review_Emp_Id,Reviewed_by_Emp_Id,File_Type_Number)
			 ...
			 --for History start
				...
				INSERT INTO dbo.T0115_File_Level_Approval_History
					...
					VALUES (@Cmp_ID,@File_App_Id,@FA_Id,@Emp_ID,@FileNumber,@FileStatus_Id,@FileType_Id,@Subject,@Description,@S_Emp_Id,@ProcessDate,@FileName,@Forward_Emp_Id,@Submit_Emp_Id,@Comment,@Review_Emp_Id,@Reviewed_by_Emp_Id,getDate(),@LoginID,@tran_type,'T0080_File_Approval',@FileTypeNumber)	
					--for History end
		-- Add for audit(start)
		...
		--for History start
						INSERT INTO dbo.T0115_File_Level_Approval_History
						   (Cmp_Id,File_App_Id,File_Apr_Id,Emp_Id,H_File_Number,H_F_StatusId,H_F_TypeId,H_Subject,H_Description,H_S_Emp_Id,H_Process_Date,H_File_App_Doc,H_Forward_Emp_Id,H_Submit_Emp_Id,H_Approval_Comments,H_Review_Emp_Id,H_Reviewed_by_Emp_Id,Rpt_Level,CreatedDate,[User ID],H_Trans_Type,H_Tran_Id,Tbl_Type,File_Type_Number)
					VALUES (@Cmp_ID,@File_App_Id,0,@Emp_ID,@FileNumber,@FileStatus_Id,@FileType_Id,@Subject,@Description,@S_Emp_Id,@ProcessDate,@FileName,@Forward_Emp_Id,@Submit_Emp_Id,@Comment,@Review_Emp_Id,@Reviewed_by_Emp_Id,@Rpt_Level,getDate(),@LoginID,'U',@Tran_ID,'T0115_File_Level_Approval',@FileTypeNumber
					)	
					--for History end
			-- Add for audit(start)
				...
				and Rpt_Level=(select max(Rpt_Level)from T0115_File_Level_Approval 
                 where File_App_Id=@File_App_Id and cmp_id=@Cmp_ID)
				   --for History start
						INSERT INTO dbo.T0115_File_Level_Approval_History
						   (Cmp_Id,File_App_Id,File_Apr_Id,Emp_Id,H_File_Number,H_F_StatusId,H_F_TypeId,H_Subject,H_Description,H_S_Emp_Id,H_Process_Date,H_File_App_Doc,H_Forward_Emp_Id,H_Submit_Emp_Id,H_Approval_Comments,H_Review_Emp_Id,H_Reviewed_by_Emp_Id,Rpt_Level,CreatedDate,[User ID],H_Trans_Type,H_Tran_Id,Tbl_Type,File_Type_Number)
					VALUES (@Cmp_ID,@File_App_Id,@FA_Id,@Emp_ID,@FileNumber,@FileStatus_Id,@FileType_Id,@Subject,@Description,@S_Emp_Id,@ProcessDate,@FileName,@Forward_Emp_Id,@Submit_Emp_Id,@Comment,@Review_Emp_Id,@Reviewed_by_Emp_Id,@Rpt_Level,getDate(),@LoginID,'U',@Tran_ID,'T0115_File_Level_Approval',@FileTypeNumber)	
					--for History end
						 	-- Add for audit(start)
			exec P9999_Audit_get @table = 'T0080_File_Application' ,@key_column='File_App_Id',@key_Values=@File_App_Id,@String=@String_app output
			set @OldValue_app = @OldValue_app + 'New Value' + '#' + cast(@String_app as varchar(max))
  ...
  declare @t_id as numeric
	 ...
	 begin 
		...
		-- Add for audit(end)	
			...
			CreatedDate,[User ID],Forward_Emp_Id,Submit_Emp_Id,CreatedBy,File_App_Id,Approval_Comments,Review_Emp_Id,Reviewed_by_Emp_Id,File_Type_Number)
			VALUES(@ApproveDate,@Branch_Id,@Dept_Id,@Desig_Id,@Emp_Id,@S_Emp_Id,@FileNumber,
			 @FileStatus_Id,@FileType_Id,@Subject,@Description,@ProcessDate,
			 @FileName,@Cmp_ID,GETDATE(),@LoginID,@Forward_Emp_Id,@Submit_Emp_Id,@LoginID,@File_App_Id,@Comment,@Review_Emp_Id,@Reviewed_by_Emp_Id,@FileTypeNumber)
    		 
			 --for History start
				SELECT @FA_Id = ISNULL(MAX(File_Apr_Id),0)  FROM dbo.T0080_File_Approval WITH (NOLOCK)
						INSERT INTO dbo.T0115_File_Level_Approval_History
						   (Cmp_Id,File_App_Id,File_Apr_Id,Emp_Id,H_File_Number,H_F_StatusId,H_F_TypeId,H_Subject,H_Description,H_S_Emp_Id,H_Process_Date,H_File_App_Doc,H_Forward_Emp_Id,H_Submit_Emp_Id,H_Approval_Comments,H_Review_Emp_Id,H_Reviewed_by_Emp_Id,Rpt_Level,CreatedDate,[User ID],H_Trans_Type,H_Tran_Id,Tbl_Type,File_Type_Number)
					VALUES (@Cmp_ID,@File_App_Id,@FA_Id,@Emp_ID,@FileNumber,@FileStatus_Id,@FileType_Id,@Subject,@Description,@S_Emp_Id,@ProcessDate,@FileName,@Forward_Emp_Id,@Submit_Emp_Id,@Comment,@Review_Emp_Id,@Reviewed_by_Emp_Id,@Rpt_Level,getDate(),@LoginID,@tran_type,@Tran_ID,'T0080_File_Approval',@FileTypeNumber)	
					--for History end
			 	-- Add for audit(start)
			 exec P9999_Audit_Trail @Cmp_ID,@Tran_Type,'File Approval',@OldValue,@Emp_ID,@LoginId,@IP_Address
		-- Add for audit(end)	
	...
	ELSE
		...
		-- Add for Audit(end)	
				...
				--for History start
					INSERT INTO dbo.T0115_File_Level_Approval_History
						   (Cmp_Id,File_App_Id,File_Apr_Id,Emp_Id,H_File_Number,H_F_StatusId,H_F_TypeId,H_Subject,H_Description,H_S_Emp_Id,H_Process_Date,H_File_App_Doc,H_Forward_Emp_Id,H_Submit_Emp_Id,H_Approval_Comments,H_Review_Emp_Id,H_Reviewed_by_Emp_Id,CreatedDate,[User ID],H_Trans_Type,Tbl_Type,File_Type_Number)
					VALUES (@Cmp_ID,@File_App_Id,0,@Emp_ID,@FileNumber,@FileStatus_Id,@FileType_Id,@Subject,@Description,@S_Emp_Id,@ProcessDate,@FileName,@Forward_Emp_Id,@Submit_Emp_Id,@Comment,@Review_Emp_Id,@Reviewed_by_Emp_Id,getDate(),@LoginID,@tran_type,'T0080_File_Approval',@FileTypeNumber)	
