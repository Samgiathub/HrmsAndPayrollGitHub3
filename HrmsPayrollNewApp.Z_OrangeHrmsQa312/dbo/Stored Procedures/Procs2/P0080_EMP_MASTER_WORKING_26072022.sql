...
CREATE PROCEDURE [dbo].[P0080_EMP_MASTER_WORKING_26072022]  
   ...
   -- end   
    ...
    -- end  
     ...
     INSERT INTO dbo.T0080_EMP_MASTER_Clone  
           ...
           ,SubVertical_ID,GroupJoiningDate,subBranch_ID,Bank_ID_Two,Ifsc_Code_Two,Code_Date  
           ,Code_Date_Format,EmpName_Alias_PrimaryBank,EmpName_Alias_SecondaryBank,EmpName_Alias_PF,EmpName_Alias_PT             ,EmpName_Alias_Tax,EmpName_Alias_ESIC,EmpName_Alias_Salary,Emp_Notice_Period,Emp_Dress_Code,Emp_Shirt_Size,Emp_Pent_Size,Emp_Shoe_Size,Emp_Canteen_Code  
           ...
           Salary_Depends_on_Production,Training_Month,Is_On_Training , Aadhar_card_no,Induction_Training,HolidayCompOffAvail_After_Days,WeekOffCompOffAvail_After_Days
		   ,WeekdayCompOffAvail_After_Days,Emp_Cast_Join
		    ,Emp_Fav_Sport_id ,Emp_Fav_Sport_Name ,Emp_Hobby_id ,Emp_Hobby_Name ,Emp_Fav_Food  --Added by ronakk 30052022
		    ,Emp_Fav_Restro ,Emp_Fav_Trv_Destination ,Emp_Fav_Festival ,Emp_Fav_SportPerson ,Emp_Fav_Singer)   --Added by ronakk 30052022
		    -- Added By Ali 03042014  
