...
CREATE PROCEDURE [dbo].[P0090_EMP_PRIVILEGE_DETAILS_GET]
...
SET ARITHABORT ON
	...
	IF @PBranch_ID = '0' or @PBranch_ID = ''
		set @PBranch_ID = null   	
	if @PVertical_ID ='0' or @PVertical_ID = ''		-- added By Gadriwala 21102013
		set @PVertical_ID = null
	if @PsubVertical_ID ='0' or @PsubVertical_ID = ''	-- added By Gadriwala 21102013
...
--End By Ronak 09022022
	...
	if @Constraint <> ''
		...
		begin
			Insert Into @Emp_Cons(Emp_ID,Vertical_ID,SubVertical_ID,Dept_ID)

			select I.Emp_Id,I.Vertical_ID,I.SubVertical_ID,I.Dept_ID from T0095_Increment I WITH (NOLOCK) inner join   --Change By Jaina 24-09-2015
