...
Create PROCEDURE [dbo].[P0080_File_Admin_Approval_Side_backup_11/11/2024]  
 ...
 If @tran_type  = 'I'  
  ...
  if exists (Select File_Apr_Id   from T0080_File_Approval WITH (NOLOCK) Where File_Apr_Id =  @FA_Id and cmp_id=@Cmp_ID  )   
	...
	--added for  adding application start
     ...
     exec P0080_File_Application_Admin_Side @File_App_Id OUTPUT,@Cmp_ID,@ApplicationDate,@Branch_Id,@Dept_Id,@Desig_Id,@Emp_Id,@S_Emp_Id,@FileNumber,@FileType_Id,'I',@Subject,@Description,@ProcessDate,@FileName,@LoginID,@IP_Address,@Comment,@FileTypeNumber,@FileTypeName --added on 30-09-22
	 end
