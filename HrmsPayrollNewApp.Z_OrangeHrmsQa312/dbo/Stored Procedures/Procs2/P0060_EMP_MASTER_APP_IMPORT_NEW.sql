...
CREATE PROCEDURE [dbo].[P0060_EMP_MASTER_APP_IMPORT_NEW] 
	@Cmp_ID numeric,  
...
BEGIN
    ...
    select Sheet1OLE.value('(Emp_x0020_Code/text())[1]','numeric(18,0)') as Emp_Code,
    Sheet1OLE.value('(Initial_x0020_Name/text())[1]','Varchar(100)') as Emp_int_Name,
    Sheet1OLE.value('(First_x0020_Name/text())[1]','Varchar(100)') as Emp_First_Name,
    Sheet1OLE.value('(Second_x0020_Name/text())[1]','Varchar(100)') as Emp_Second_Name,
    Sheet1OLE.value('(Last_x0020_Name/text())[1]','Varchar(100)') as Emp_Last_Name,
    Sheet1OLE.value('(Branch/text())[1]','Varchar(100)') as Branch,
    Sheet1OLE.value('(Grade/text())[1]','Varchar(100)') as Garde,
    Sheet1OLE.value('(Department/text())[1]','Varchar(100)') as Dept,
    Sheet1OLE.value('(Category/text())[1]','Varchar(100)') as Category,
    Sheet1OLE.value('(Designation/text())[1]','Varchar(100)') as Designation,
    Sheet1OLE.value('(TYPE/text())[1]','Varchar(100)') as Type,
    Sheet1OLE.value('(Gerenal_x0020_Shift/text())[1]','Varchar(100)') as Shift,
    Sheet1OLE.value('(BANK_x0020_NAME/text())[1]','Varchar(100)') as Bank_name,
    Sheet1OLE.value('(CURR_x0020_NAME/text())[1]','Varchar(100)') as Curr_name,
    --Sheet1OLE.value('(DOJ/text())[1]','datetime') as DOJ,
    Sheet1OLE.value('substring((DOJ/text())[1], 1, 19)','datetime') as DOJ,
    isnull(Sheet1OLE.value('(Pan_x0020_No/text())[1]','Varchar(100)'),'') as Pan_No,
    isnull(Sheet1OLE.value('(Esic_x0020_No/text())[1]','Varchar(100)'),'') as EsicNo,
    isnull(Sheet1OLE.value('(PF_x0020_no/text())[1]','Varchar(100)'),'') as PFno,
    --Sheet1OLE.value('(DOB/text())[1]','datetime') as BOD,
    Sheet1OLE.value('substring((DOB/text())[1], 1, 19)','datetime') as BOD,
    Sheet1OLE.value('(MARITAL_x0020_STATUS/text())[1]','Varchar(100)') as Marital_status,
    Sheet1OLE.value('(GENDER/text())[1]','Varchar(100)') as Gender,
    Sheet1OLE.value('(NATIONALITY/text())[1]','Varchar(100)') as Nationality,
    Sheet1OLE.value('(LOCATION/text())[1]','Varchar(100)') as Location,
    isnull(Sheet1OLE.value('(ADDRESS/text())[1]','Varchar(500)'),'') as Address,
    isnull(Sheet1OLE.value('(CITY/text())[1]','Varchar(100)'),'') as City,
    isnull(Sheet1OLE.value('(STATE/text())[1]','Varchar(100)'),'') as State,
    isnull(Sheet1OLE.value('(POST_x0020_BOX/text())[1]','Varchar(100)'),'') as PostBox,
    isnull(Sheet1OLE.value('(Tel_x0020_No/text())[1]','Varchar(100)'),'') as Tel_No,
    isnull(Sheet1OLE.value('(MOBILE_x0020_NO/text())[1]','Varchar(100)'),'') as Mobile,
    isnull(Sheet1OLE.value('(Work_x0020_Tel_x0020_No/text())[1]','Varchar(100)'),'') as Work_Tel_No,
    isnull(Sheet1OLE.value('(Work_x0020_Email/text())[1]','Varchar(100)'),'') as Work_Email,
    isnull(Sheet1OLE.value('(Other_x0020_Email/text())[1]','Varchar(100)'),'') as Other_Email,
	isnull(Sheet1OLE.value('(ADDRESS1/text())[1]','Varchar(100)'),'') as Present_ADDRESS,
	isnull(Sheet1OLE.value('(CITY1/text())[1]','Varchar(100)'),'') as Present_City,
    isnull(Sheet1OLE.value('(State1/text())[1]','Varchar(100)'),'') as Present_State,
    isnull(Sheet1OLE.value('(Post_x0020_Box1/text())[1]','Varchar(100)'),'') as Present_Postbox,
    isnull(Sheet1OLE.value('(SALARY/text())[1]','Numeric(18,2)'),0) as Salary,
    ...
    Sheet1OLE.value('(Wages_Type/text())[1]','Varchar(100)') as Wages,
    Sheet1OLE.value('(Salary_Basis_On/text())[1]','Varchar(100)') as Salary_Basic_on,
    Sheet1OLE.value('(Payment_Mode/text())[1]','Varchar(100)') as Payment_mode,
    isnull(Sheet1OLE.value('(Emp_Bank_Ac_No/text())[1]','Varchar(100)'),'') as Bank_Acc_No,
    Sheet1OLE.value('(Emp_OT/text())[1]','Varchar(100)') as Emp_OT,
    Sheet1OLE.value('(Min_x0020_limit/text())[1]','Varchar(100)') as Min_Limit,
    Sheet1OLE.value('(Max_x0020_Limit/text())[1]','Varchar(100)') as Max_Limit,
    Sheet1OLE.value('(Late_x0020_Mark/text())[1]','Varchar(100)') as Late_Mark,
    Sheet1OLE.value('(Full_x0020_PF/text())[1]','Varchar(100)') as Full_PF,
    Sheet1OLE.value('(Prof._x0020_Tax/text())[1]','Varchar(100)') as Prof_Tax,
    Isnull(Sheet1OLE.value('(Fix_x0020_Salary/text())[1]','Numeric(1,0)'),0) as Fix_Salary,
    isnull(Sheet1OLE.value('(Blood_Group/text())[1]','Varchar(100)'),'') as Blood_Group,
    isnull(Sheet1OLE.value('(Enroll_No/text())[1]','Varchar(100)'),'0') as Enroll_No,
    isnull(Sheet1OLE.value('(Father_Name/text())[1]','Varchar(100)'),'') as Father_Name,
    isnull(Sheet1OLE.value('(Bank_IFSC_NO/text())[1]','Varchar(100)'),'') as Bank_IFSC_NO,
    --Sheet1OLE.value('(Confirmation_Date/text())[1]','DateTime') as Confirmation_Date,
    Sheet1OLE.value('substring((Confirmation_Date/text())[1], 1, 19)','datetime') as Confirmation_Date,
    --Sheet1OLE.value('(Probation/text())[1]','DateTime') as Probation,
	Sheet1OLE.value('(Probation/text())[1]','Varchar(100)') as Probation,
	Sheet1OLE.value('(Old_Ref_No/text())[1]','Varchar(100)') as Old_Ref_No,
	Sheet1OLE.value('(Alpha_Code/text())[1]','Varchar(100)') as Alpha_Code,
	Sheet1OLE.value('(Emp_Superior/text())[1]','Varchar(100)') as Emp_Superior,
    isnull(Sheet1OLE.value('(Is_LWF/text())[1]','Numeric(18,0)'),0) as IS_LWF,
    isnull(Sheet1OLE.value('(Weekday_OT_Rate/text())[1]','Numeric(18,2)'),0) as Weekday_OT_Rate,
    Isnull(Sheet1OLE.value('(Weekoff_OT_Rate/text())[1]','Numeric(18,2)'),0) as Weekoff_OT_Rate,
    Isnull(Sheet1OLE.value('(Holiday_OT_Rate/text())[1]','Numeric(18,2)'),0) as Holiday_OT_Rate,
    Sheet1OLE.value('(Business_x0020_Segment/text())[1]','Varchar(100)') as Business,
    Sheet1OLE.value('(Vertical/text())[1]','Varchar(100)') as Vertical,
    Sheet1OLE.value('(sub_Vertical/text())[1]','Varchar(100)') as sub_Vertical,
    ---Sheet1OLE.value('(Group_x0020_of_x0020_Joining/text())[1]','datetime') as Group_Of_Join,
   Sheet1OLE.value('substring((Group_x0020_of_x0020_Joining/text())[1], 1, 19)','datetime') as Group_Of_Join,
    Sheet1OLE.value('(sub_Branch/text())[1]','Varchar(100)') as sub_Branch,
    Sheet1OLE.value('(Salary_Cycle/text())[1]','Varchar(100)') as Salary_Cycle,
    Sheet1OLE.value('(Company_x0020_Full_x0020_PF/text())[1]','Varchar(100)') as Company_Full_PF,
    Sheet1OLE.value('(Pay_Scale_Name/text())[1]','Varchar(100)') as Pay_Scale_Name,
    isnull(Sheet1OLE.value('(Customer_Audit/text())[1]','Numeric(18,0)'),0) as Customer_Audit,   --Added By Jaina 09-09-2016
    isnull(Sheet1OLE.value('(Password/text())[1]','Varchar(500)'),0) as EssPassword
	...
	open curXml                        
		...
		Begin                     
			 BEGIN TRY
							...
							BEGIN  
							 IF @Branch_Name is not NULL
								BEGIN 
									...
									EXEC P0030_BRANCH_MASTER @Branch_ID OUTPUT ,@Cmp_ID,@State_ID,@Branch_Code,@Branch_Name,'','','','I',0,0,'',0,'','','','',1,NULL,NULL,NULL,'',1 
								END  
							ELSE  
								BEGIN  
				...
				if @Esic_no Is Not Null or @Pf_No Is Not Null or @Pan_No Is Not Null 
					BEGIN
			...
			--Added by Nilesh Patel on 29032019 -- For Kataria Client
			   ...
			   if @Alpha_Code = '' --Added by nilesh patel on 30072015
				...
				BEGIN  
						...
						Select * From T0080_EMP_MASTER WITH (NOLOCK) Where Emp_ID = @Emp_ID
						...
						if @Increment_ID <> 0 
							Begin
						        ...
						        Set @NewValue = 'New Value'
									  ...
									  + '#Enroll_No      ' + ' : ' + isnull(Cast(@Enroll_No as varchar(10)),'')	 
						...
						---Added By Jimit 02052019 For Inserting Default Scheme to Employees
							...
							select  ROW_NUMBER() Over(Order By Scheme_Id asc) + @Tran_ID,@Cmp_ID, @Emp_ID,SCHEME_ID,SCHEME_TYPE,GETDATE()
