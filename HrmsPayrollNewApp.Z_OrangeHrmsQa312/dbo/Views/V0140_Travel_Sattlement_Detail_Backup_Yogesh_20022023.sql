...
Create VIEW [dbo].[V0140_Travel_Sattlement_Detail_Backup_Yogesh_20022023]
AS
SELECT 				  
       ...
       ,tmm.Travel_Mode_Name,isnull(TAD.State_ID,0)as State_ID,isnull(TAD.City_ID,0) as City_ID
	   ...
	   ,TT.Travel_Type_Name,TT.Travel_Type_Id
