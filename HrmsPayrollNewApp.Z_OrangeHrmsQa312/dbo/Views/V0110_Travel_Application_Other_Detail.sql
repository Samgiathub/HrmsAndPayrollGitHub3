...
CREATE  VIEW [dbo].[V0110_Travel_Application_Other_Detail]    
AS    
SELECT        
distinct    
...
,TAD.SGST,TAD.CGST,TAD.IGST,TAD.GST_No, TAD.GST_Company_Name,tm.Mode_Type as TRAVEL_MODE--TAMD.TRAVEL_MODE    
FROM dbo.T0110_Travel_Application_Other_Detail AS TAD WITH (NOLOCK) INNER JOIN    
   ...
   TAD.TRAVEL_APP_ID = TAMD.TRAVEL_APP_ID --and  tm.Cmp_ID=TAMD.Cmp_ID    
