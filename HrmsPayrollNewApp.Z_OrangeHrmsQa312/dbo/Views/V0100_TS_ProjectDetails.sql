...
CREATE VIEW [dbo].[V0100_TS_ProjectDetails]        
AS 
...
EM.Emp_Superior,ERD.R_Emp_ID,EM.Dept_ID,EM.Desig_Id,TTA.Project_Status_ID,TTA.Project_ID,TTA.Task_ID,TTA.Cmp_ID,PS.Project_Status,
