...
CREATE VIEW [dbo].[VIEW_TRAINEE_FINAL_APPROVAL_ESS]
AS
SELECT  ET.Cmp_ID,ET.Emp_ID, ET.Emp_Full_Name, ET.Alpha_Emp_code, ET.Emp_first_name, ET.Branch_Name, ET.Branch_ID,
		...
		qry.Major_Strength,qry.Major_Weakness,qry.Appraiser_Remarks,qry.Appraisal_Reviewer_Remarks,ET.Desig_Name,ET.Dept_Name,ET.[Type_Name],qry.Extend_Period,qry.New_Probation_EndDate
