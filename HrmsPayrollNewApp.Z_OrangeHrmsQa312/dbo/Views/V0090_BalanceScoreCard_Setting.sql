...
CREATE VIEW [dbo].[V0090_BalanceScoreCard_Setting]
AS
SELECT     dbo.T0090_BalanceScoreCard_Setting.BSC_SettingId, dbo.T0090_BalanceScoreCard_Setting.Cmp_Id, dbo.T0090_BalanceScoreCard_Setting.Emp_Id, 
                      dbo.T0090_BalanceScoreCard_Setting.BSC_Status, dbo.T0090_BalanceScoreCard_Setting.FinYear, dbo.T0080_EMP_MASTER.Emp_Full_Name, 
                      ...
                      dbo.T0095_INCREMENT.Dept_ID, dbo.T0095_INCREMENT.Desig_Id, DG.Desig_Name, D.Dept_Name
FROM         dbo.T0090_BalanceScoreCard_Setting WITH (NOLOCK) INNER JOIN
                      dbo.T0080_EMP_MASTER WITH (NOLOCK)  ON dbo.T0090_BalanceScoreCard_Setting.Emp_Id = dbo.T0080_EMP_MASTER.Emp_ID INNER JOIN
