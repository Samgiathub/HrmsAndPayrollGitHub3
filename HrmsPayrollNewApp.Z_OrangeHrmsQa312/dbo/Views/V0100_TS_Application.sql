...
CREATE  VIEW [dbo].[V0100_TS_Application]                  
as                  
...
TTA.Cmp_ID,isnull(PS.Project_Status,'Not Submitted')AS 'Project_Status',PS.Status_Type,TTA.Description ,EM.Emp_Superior,EM.Alpha_Emp_Code,EM.Emp_Full_Name,        
