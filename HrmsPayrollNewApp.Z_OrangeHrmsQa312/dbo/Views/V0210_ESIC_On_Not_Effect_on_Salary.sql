...
CREATE VIEW [dbo].[V0210_ESIC_On_Not_Effect_on_Salary]
AS
SELECT ES.Tran_Id,ES.For_Date,ES.Cmp_Id,ES.Emp_Id,ES.Hours,ES.Amount,ES.Esic,ES.Net_Amount,ES.Ad_Id,ES.Modify_Date,ES.Comp_Esic,ES.TDS,
ES.Loan_Amount,ES.Working_Days,ES.Calculate_on
,Em.Alpha_Emp_Code,Em.Emp_Full_Name,Am.AD_NAME,AM.AD_NOT_EFFECT_SALARY 
,I.Branch_Id,I.Grd_ID,I.Desig_Id,I.Dept_ID,I.Vertical_ID,I.SubVertical_ID,I.Segment_ID,
Bm.Branch_Name,Am.Hide_In_Reports,I.Cat_ID,I.Type_ID,I.subBranch_ID
,GM.Grd_Name,DEM.Desig_Name,CM.Cmp_Name,DM.Dept_Name,BAM.Bank_Name,I.Inc_Bank_AC_No,TM.Type_Name
,I.Basic_Salary AS Rate
FROM T0210_ESIC_On_Not_Effect_on_Salary ES WITH (NOLOCK)
