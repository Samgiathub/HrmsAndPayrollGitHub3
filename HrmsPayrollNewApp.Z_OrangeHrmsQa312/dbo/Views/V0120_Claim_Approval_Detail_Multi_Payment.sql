...
CREATE VIEW [dbo].[V0120_Claim_Approval_Detail_Multi_Payment]
As
...
--INNER JOIN dbo.T0110_CLAIM_APPLICATION_DETAIL on dbo.T0100_CLAIM_APPLICATION.Claim_App_ID=dbo.T0100_CLAIM_APPLICATION.Claim_App_ID
                      ...
                      left join T0130_CLAIM_APPROVAL_DETAIL CLM WITH (NOLOCK) on CLM.Claim_Apr_ID=T0120_CLAIM_APPROVAL.Claim_Apr_ID
