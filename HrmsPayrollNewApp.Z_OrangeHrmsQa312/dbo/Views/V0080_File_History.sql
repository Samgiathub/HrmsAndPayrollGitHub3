...
CREATE View [dbo].[V0080_File_History]
As
    ...
    ELSE 'Deleted' END)as Trans_Type,fsc.S_Name   as Status,
	--	 isnull(fa.File_Type_Name,'')as FileType--added by mansi 30-09-22
	ft.TypeTitle as FileType--commented by mansi 30-09-22
	...
	,fh.H_File_App_Doc
	 ...
	 ,isnull(fa.File_Type_Number,'')as File_Type_Number --added 20-08-22
	 ,isnull(fa.File_Type_Name,'')as File_Type_Name--added by mansi 30-09-22
  ...
  --where fh.Tbl_Type<>'T0080_File_Approval'																																																																				
