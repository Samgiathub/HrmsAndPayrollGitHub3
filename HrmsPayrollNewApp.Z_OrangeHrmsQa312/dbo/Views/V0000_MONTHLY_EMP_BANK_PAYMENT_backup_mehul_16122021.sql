...
create  VIEW [dbo].[V0000_MONTHLY_EMP_BANK_PAYMENT_backup_mehul_16122021]
AS
SELECT    MEBP.Emp_ID, MEBP.Cmp_ID, MEBP.For_Date, MEBP.Payment_Date, MEBP.Emp_Bank_ID, MEBP.Payment_Mode, MEBP.Net_Amount, MEBP.Emp_Bank_AC_No,
		  ...
		  I.Grd_ID,I.Cat_ID,I.Type_ID,I.subBranch_ID , BOND.Bond_Id , BOND.Bond_Apr_Id --added by jimit 28072017
