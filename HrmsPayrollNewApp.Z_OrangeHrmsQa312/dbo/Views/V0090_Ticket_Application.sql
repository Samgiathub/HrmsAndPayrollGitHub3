...
CREATE VIEW dbo.V0090_Ticket_Application
AS
...
FROM        dbo.T0090_Ticket_Application AS TA WITH (NOLOCK) INNER JOIN
                  ...
                  dbo.T0040_Ticket_Priority AS TP WITH (NOLOCK) ON TP.Tran_ID = TA.Ticket_Priority LEFT OUTER JOIN
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'   End
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V0090_Ticket_Application';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V0090_Ticket_Application';
