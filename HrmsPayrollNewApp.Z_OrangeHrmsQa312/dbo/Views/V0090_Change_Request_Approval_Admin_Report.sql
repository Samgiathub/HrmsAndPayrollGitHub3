...
CREATE VIEW [dbo].[V0090_Change_Request_Approval_Admin_Report]
AS
SELECT     dbo.T0090_Change_Request_Approval.Cmp_id, dbo.T0090_Change_Request_Approval.Emp_ID, dbo.T0090_Change_Request_Approval.Request_Type_id, 
                      dbo.T0090_Change_Request_Approval.Change_Reason, dbo.T0090_Change_Request_Approval.Request_Date, dbo.T0090_Change_Request_Approval.Effective_Date, 
                      ...
                      ,T0090_Change_Request_Application.Request_Date as Application_Request_date
					  ,T0090_Change_Request_Approval.Child_Birth_Date   --added by mansi
FROM         dbo.T0090_Change_Request_Approval WITH (NOLOCK) INNER JOIN
                      ...
                      dbo.T0090_Change_Request_Approval.Cmp_id = dbo.T0040_Change_Request_Master.Cmp_ID Left Outer JOIN
                      T0090_Change_Request_Application WITH (NOLOCK)  On T0090_Change_Request_Application.Request_id = T0090_Change_Request_Approval.Request_id
