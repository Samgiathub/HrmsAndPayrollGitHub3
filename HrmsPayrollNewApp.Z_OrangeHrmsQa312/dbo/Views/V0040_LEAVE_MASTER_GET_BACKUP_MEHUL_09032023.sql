...
CREATE VIEW [dbo].[V0040_LEAVE_MASTER_GET_BACKUP_MEHUL_09032023]
AS
	SELECT	Leave_ID,Leave_Code, Leave_Name, Leave_Type, Leave_Count, Leave_Paid_Unpaid, Leave_Min, Leave_Max,Leave_Min_Bal, Leave_Max_Bal,Leave_Min_Encash, 
			...
			,Max_Leave_Lifetime,ISNULL(Is_Auto_Leave_From_Salary,0) as Is_Auto_Leave_From_Salary,ISNULL(IsDoubleDeduct,0) as IsDoubleDeduct,isnull(Multi_Allowance_ID,'') as Multi_Allowance_ID
