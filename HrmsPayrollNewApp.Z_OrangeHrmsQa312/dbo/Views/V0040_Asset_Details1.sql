...
CREATE VIEW [dbo].[V0040_Asset_Details1]
AS
SELECT DISTINCT 
                      dbo.T0040_ASSET_MASTER.Asset_Name, dbo.T0040_BRAND_MASTER.BRAND_Name, dbo.T0040_Asset_Details.Warranty_Starts, 
                      dbo.T0040_Asset_Details.Warranty_Ends, dbo.T0040_Asset_Details.Vendor, dbo.T0040_Asset_Details.Type_of_Asset, 
                      ...
                      dbo.T0040_Asset_Details.Asset_Code, dbo.T0130_Asset_Approval_Det.Cmp_ID, dbo.T0120_Asset_Approval.Emp_ID, 
                      ...
                      END AS Purchase_date, CASE WHEN T0130_Asset_Approval_Det.Return_Date = '01/01/1900' THEN '' ELSE CONVERT(varchar(11), 
                      dbo.T0130_Asset_Approval_Det.Return_Date, 103) END AS Return_Date, 
                      CASE WHEN T0130_Asset_Approval_Det.Application_Type = 0 THEN 'Application' ELSE 'Return' END AS Type
FROM         dbo.T0130_Asset_Approval_Det WITH (NOLOCK) INNER JOIN
                      ...
                      dbo.T0120_Asset_Approval.Cmp_ID = dbo.T0130_Asset_Approval_Det.Cmp_ID
...
Begin DesignProperties = 
   ...
   Begin DataPane = 
      ...
      Begin ColumnWidths = 16
         ...
         Width = 1500
         Width = 1500
 ', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V0040_Asset_Details1';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V0040_Asset_Details1';
