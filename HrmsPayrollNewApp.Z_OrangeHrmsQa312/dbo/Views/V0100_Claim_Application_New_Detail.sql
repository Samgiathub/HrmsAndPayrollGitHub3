...
CREATE VIEW [dbo].[V0100_Claim_Application_New_Detail]
AS
SELECT     dbo.T0100_CLAIM_APPLICATION.Claim_App_ID, dbo.T0100_CLAIM_APPLICATION.Cmp_ID, CD.Claim_ID, 
...
FROM         dbo.T0100_CLAIM_APPLICATION WITH (NOLOCK) INNER JOIN
				T0110_CLAIM_APPLICATION_DETAIL CD WITH(NOLOCK) on dbo.T0100_CLAIM_APPLICATION.Claim_App_ID = cd.Claim_App_ID LEFT OUTER JOIN
