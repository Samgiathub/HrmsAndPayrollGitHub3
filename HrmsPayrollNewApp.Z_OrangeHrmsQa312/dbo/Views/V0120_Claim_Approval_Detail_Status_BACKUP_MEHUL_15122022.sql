...
CREATE VIEW [dbo].[V0120_Claim_Approval_Detail_Status_BACKUP_MEHUL_15122022]  
As  
select distinct CA.Emp_ID,CA.Claim_Apr_ID,CA.Cmp_ID,  
    isnull(CA.Claim_App_ID,0)Claim_App_ID,em.Emp_First_Name,em.Emp_Full_Name,ca.Claim_Apr_Pending_Amount,Em.Emp_Left,CAPD.For_Date  
...
,isnull(cm1.Claim_Type,0)as Claim_Type,CAPD.Claim_Date_Label 
from T0120_CLAIM_APPROVAL CA WITH (NOLOCK)  
 ...
 LEFT OUTER JOIN t0040_designation_master DGM   
  ...
  Inner join dbo.T0110_CLAIM_APPLICATION_DETAIL CAPD on CAP.Claim_App_ID = CAPD.Claim_App_ID
