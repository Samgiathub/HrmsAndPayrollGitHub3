...
CREATE VIEW [dbo].[VIEW_INCREMENT_APPROVED_FINAL_N_LEVEL_APPROVAL_BACKUP_MEHUL_31052022]
AS
SELECT		IA.Cmp_ID, IA.App_ID, IA.Emp_ID, IA.Increment_Date, IA.Increment_Effective_Date,
			...
			,qry.Customer_Audit , ISNULL(qry.Sales_Code,'') AS Sales_Code,Ia.Remarks --Added By Jaina 04-10-2016 --RAMIZ (SALES_CODE ON 08122016)
