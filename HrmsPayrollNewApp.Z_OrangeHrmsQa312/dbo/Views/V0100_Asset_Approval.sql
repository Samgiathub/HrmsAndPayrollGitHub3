...
CREATE VIEW [dbo].[V0100_Asset_Approval]  
AS  
SELECT  distinct   *, LEFT(Asset_Name1, len(Asset_Name1) - 1) AS Asset_Name  
FROM         (SELECT DISTINCT   
                                              ...
                                              CASE WHEN AD.Application_Type = 0 THEN 'Allocation' 
											  WHEN AD.Application_Type = 1 THEN 'Return' 
											  WHEN AD.Application_Type = 2 THEN 'Sell' 
											  WHEN AA.Application_Type   = 3 THEN 'Transfer' END AS [Application_Type1], 
											  0 AS AssetM_ID, EE.Alpha_Emp_Code AS Applied_ByEmp_Code,   
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[5] 4[5] 2[45] 3) )"
      End
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V0100_Asset_Approval';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'V0100_Asset_Approval';
