...
CREATE VIEW [dbo].[V0030_Emp_Master_Detail]
AS
SELECT     e.Emp_ID, e.Emp_code, e.Emp_Full_Name, e.Cmp_ID, e.Basic_Salary, e.Date_Of_Join, e.Emp_Left, d.Desig_Name, de.Dept_Name, s.Shift_Name, 
                      ...
                      e.Present_State, e.Present_Post_Box, e.Emp_Left_Date, dbo.T0030_BRANCH_MASTER.Branch_Name
FROM         dbo.T0080_EMP_MASTER AS e WITH (NOLOCK) INNER JOIN
                      ...
                      dbo.T0040_GRADE_MASTER WITH (NOLOCK)  ON e.Grd_ID = dbo.T0040_GRADE_MASTER.Grd_ID AND e.Cmp_ID = dbo.T0040_GRADE_MASTER.Cmp_ID INNER JOIN
                      dbo.T0030_BRANCH_MASTER WITH (NOLOCK)  ON e.Branch_ID = dbo.T0030_BRANCH_MASTER.Branch_ID AND c.Cmp_Id = dbo.T0030_BRANCH_MASTER.Cmp_ID
