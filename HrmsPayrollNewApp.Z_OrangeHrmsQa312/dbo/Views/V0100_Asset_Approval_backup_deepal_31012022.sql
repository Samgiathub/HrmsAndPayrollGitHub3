...
create VIEW [dbo].[V0100_Asset_Approval_backup_deepal_31012022]
AS
...
FROM         (SELECT DISTINCT 
                       ...
                       FROM          T0120_Asset_Approval AA WITH (NOLOCK) LEFT JOIN
                                             ...
                                             -- dbo.T0130_Asset_Approval_Det ATD ON AA.Asset_Approval_ID = ATD.Transfer_Id AND ATD.Cmp_ID = AA.Cmp_ID LEFT OUTER JOIN
											  ...
											  INNER JOIN dbo.T0080_EMP_MASTER E WITH (NOLOCK) ON AA.Emp_ID = E.Emp_ID AND E.Cmp_ID = AA.Cmp_ID LEFT OUTER JOIN
