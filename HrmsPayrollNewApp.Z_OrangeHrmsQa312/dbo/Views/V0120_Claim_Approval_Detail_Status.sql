...
CREATE VIEW [dbo].[V0120_Claim_Approval_Detail_Status]  
As  
	...
	--,CAPD.For_Date  commented by Mr.Mehul on 20122022 for duplication of records issue
	...
	,isnull(cm1.Claim_Type,0)as Claim_Type
	--,CAPD.Claim_Date_Label commented by Mr.Mehul on 20122022 for duplication of records issue
	...
	left join T0040_CLAIM_MASTER cm1 WITH (NOLOCK) on cm1.Claim_ID=cad.Claim_ID and CM1.Cmp_ID=cad.Cmp_ID  
	...
	--Inner join dbo.T0110_CLAIM_APPLICATION_DETAIL CAPD on CAP.Claim_App_ID = CAPD.Claim_App_ID commented by Mr.Mehul on 20122022 for duplication of records issue
