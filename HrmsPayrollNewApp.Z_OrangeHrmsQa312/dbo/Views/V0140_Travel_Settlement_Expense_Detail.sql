...
CREATE view [dbo].[V0140_Travel_Settlement_Expense_Detail]    
AS    
 select distinct  TSE.int_Id,TSE.Travel_Approval_Id,TSE.For_Date, TSE.Amount as Amount,    
   ETP.Expense_Type_name,TSE.Comments,TSE.Missing,0 as int_Exp_ID,0 as Travel_Settlement_ID,0 as Approved_Amount,    
   TSE.From_Time,TSE.To_Time,TSE.Duration,'' as Appr_From_Time,'' as Appr_To_Time,'' as Appr_Duration,isnull(TravelAllowance,0) as TravelAllowance,    
   TSE.Limit_Amount as Limit_Amnt,Grp_Emp,Grp_Emp_ID,TSE.Amount as Exp_Amount,ETP.is_overlimit,    
   ...
   ,etp.GST_Applicable ,TSE.SGST,TSE.CGST,TSE.IGST,TSE.GST_No,TSE.GST_Company_Name,TSM.travel_mode,TSE.selfpay,TSLE.Rpt_Level as Rpt_Level,tse.No_of_Days,tse.GuestName    
   ...
   left join T0115_Travel_Settlement_Level_Expense TSLE on  tsle.int_Id=tse.int_Id    
   --where TSLE.Rpt_Level=4    
