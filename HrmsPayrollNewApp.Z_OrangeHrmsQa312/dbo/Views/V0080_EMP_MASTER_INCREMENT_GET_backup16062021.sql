...
create VIEW [dbo].[V0080_EMP_MASTER_INCREMENT_GET_backup16062021]
AS
SELECT     e.Emp_code, e.Initial, e.Emp_First_Name, e.Emp_Second_Name, e.Emp_Last_Name, e.Date_Of_Join, e.SSN_No, e.SIN_No, e.Dr_Lic_No, e.Pan_No, e.Date_Of_Birth, 
                      ...
                      i.Desig_Id, i.Type_ID, i.Bank_ID, i.Curr_ID, i.Wages_Type, i.Salary_Basis_On, i_q.Basic_Salary, i_q.Gross_Salary, i.Increment_Effective_Date, i.Payment_Mode, 
                      ...
                      e.Alpha_Emp_Code, (CASE WHEN ISNULL(e.Alpha_Code, '') = '' THEN NULL ELSE e.Alpha_Code END) AS Alpha_Code, e.Leave_In_Probation, e.Is_LWF, ISNULL(i_q.CTC,
					  ...
					  Isnull(e.WeekdayCompOffAvail_After_Days,0) WeekdayCompOffAvail_After_Days,Cat_Name,
					  Is_VBA,I.Is_Piece_Trans_Salary
FROM        dbo.T0080_EMP_MASTER AS e WITH (NOLOCK) INNER JOIN
			T0095_INCREMENT I WITH (NOLOCK)  ON e.Emp_ID = I.Emp_ID INNER JOIN 
				...
				INNER JOIN T0095_INCREMENT I_Q WITH (NOLOCK)  ON e.Emp_ID = I_Q.Emp_ID INNER JOIN 
				 (SELECT	MAX(I2.Increment_ID) AS Increment_ID, I2.Emp_ID
				  FROM	T0095_INCREMENT I2  WITH (NOLOCK) 
						INNER JOIN (SELECT	MAX(INCREMENT_EFFECTIVE_DATE) AS INCREMENT_EFFECTIVE_DATE, I3.EMP_ID
									FROM	T0095_INCREMENT I3 WITH (NOLOCK)  INNER JOIN T0080_EMP_MASTER EM WITH (NOLOCK)  ON EM.Emp_ID = I3.EMp_ID									
