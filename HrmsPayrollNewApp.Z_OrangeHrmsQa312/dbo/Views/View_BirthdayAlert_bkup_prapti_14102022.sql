...
create VIEW [dbo].[View_BirthdayAlert_bkup_prapti_14102022]
...
(CASE WHEN Actual_Date_Of_Birth IS NOT NULL THEN Actual_Date_Of_Birth ELSE Date_Of_Birth END) AS 'DATE', -- added by Niraj (08082022) Sajid's Bday
