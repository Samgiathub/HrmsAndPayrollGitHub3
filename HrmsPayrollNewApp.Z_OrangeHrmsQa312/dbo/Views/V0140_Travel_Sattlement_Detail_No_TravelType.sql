...
CREATE VIEW [dbo].[V0140_Travel_Sattlement_Detail_No_TravelType]          
AS          
SELECT  Distinct               
       ...
       ,TAD.From_Date,TAD.Instruct_Emp_ID,cast(tad.Period as Numeric(18,2))as Period,tad.Place_Of_Visit,tad.Remarks,tad.To_Date,tad.Travel_Approval_Detail_ID,tad.Travel_Mode_ID,tad.Travel_Purpose          
