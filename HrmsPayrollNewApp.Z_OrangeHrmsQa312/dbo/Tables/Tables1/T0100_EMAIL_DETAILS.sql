CREATE TABLE [dbo].[T0100_EMAIL_DETAILS] (
    ...
    CONSTRAINT [PK_T0100_EMAIL_DETAILS] PRIMARY KEY CLUSTERED ([EmailId] ASC) WITH (FILLFACTOR = 80),
    CONSTRAINT [FK_T0100_EMAIL_DETAILS_T0010_COMPANY_MASTER] FOREIGN KEY ([Cmp_Id]) REFERENCES [dbo].[T0010_COMPANY_MASTER] ([Cmp_Id])
);
