CREATE TABLE [dbo].[T0001_LEAVECF_NightProcess_History_backup] (
    ...
    [Advance_Leave_Recover_balance] NUMERIC (18, 2) NOT NULL,
    [Is_Advance_Leave_Balance]      TINYINT         NOT NULL,
    [Month]                         TINYINT         NULL,
    [Year]                          INT             NULL
);
