CREATE TABLE [dbo].[T0080_EMP_MASTER_Clone] (
    ...
    [CompOff_Min_hrs]                VARCHAR (10)    CONSTRAINT [DF_T0080_EMP_MASTER_Clone_CompOff_Min_hrs] DEFAULT ('00:00') NOT NULL,
    ...
    [Emp_Notice_Period]              NUMERIC (18)    CONSTRAINT [DF_T0080_EMP_MASTER_Clone_Emp_Notice_Period] DEFAULT ((0)) NOT NULL,
    ...
    [Thana_Id]                       NUMERIC (18)    CONSTRAINT [DF_T0080_EMP_MASTER_Clone_Thana_Id] DEFAULT ((0)) NOT NULL,
    [Tehsil]                         VARCHAR (50)    NULL,
    [District]                       VARCHAR (50)    NULL,
    [Thana_Id_Wok]                   NUMERIC (18)    CONSTRAINT [DF_T0080_EMP_MASTER_Clone_Thana_Id_Wok] DEFAULT ((0)) NOT NULL,
    [Tehsil_Wok]                     VARCHAR (50)    NULL,
    [District_Wok]                   VARCHAR (50)    NULL,
    [SkillType_ID]                   INT             CONSTRAINT [DF_T0080_EMP_MASTER_Clone_SkillType_ID] DEFAULT ((0)) NULL,
    [CompOff_WO_App_Days]            NUMERIC (18, 2) CONSTRAINT [DF_T0080_EMP_MASTER_Clone_CompOff_WO_App_Days] DEFAULT ((0)) NOT NULL,
    [CompOff_WO_Avail_Days]          NUMERIC (18, 2) CONSTRAINT [DF_T0080_EMP_MASTER_Clone_CompOff_WO_Avail_Days] DEFAULT ((0)) NOT NULL,
    [CompOff_WD_App_Days]            NUMERIC (18, 2) CONSTRAINT [DF_T0080_EMP_MASTER_Clone_CompOff_WD_App_Days] DEFAULT ((0)) NOT NULL,
    [CompOff_WD_Avail_Days]          NUMERIC (18, 2) CONSTRAINT [DF_T0080_EMP_MASTER_Clone_CompOff_WD_Avail_Days] DEFAULT ((0)) NOT NULL,
    [CompOff_HO_App_Days]            NUMERIC (18, 2) CONSTRAINT [DF_T0080_EMP_MASTER_Clone_CompOff_HO_Appl_Days] DEFAULT ((0)) NOT NULL,
    [CompOff_HO_Avail_Days]          NUMERIC (18, 2) CONSTRAINT [DF_T0080_EMP_MASTER_Clone_CompOff_HO_Avail_Days] DEFAULT ((0)) NOT NULL,
    [Date_of_Retirement]             DATETIME        NULL,
    [Salary_Depends_on_Production]   NUMERIC (1)     CONSTRAINT [DF_T0080_EMP_MASTER_Clone_Salary_Depends_on_Production] DEFAULT ((0)) NOT NULL,
