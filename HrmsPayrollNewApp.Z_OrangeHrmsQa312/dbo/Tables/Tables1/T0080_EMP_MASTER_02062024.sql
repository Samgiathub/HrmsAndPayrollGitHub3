CREATE TABLE [dbo].[T0080_EMP_MASTER_02062024] (
    ...
    [Is_On_Traning]                  NUMERIC (2)     NOT NULL,
    [Traning]                        NUMERIC (2)     NOT NULL,
    [Signature_Image_Name]           VARCHAR (200)   NULL,
    [Leave_Encash_Working_Days]      NUMERIC (18, 2) NOT NULL,
    [Rejoin_Emp_Id]                  NUMERIC (18)    NOT NULL,
    ...
    [HolidayCompOffAvail_After_Days] NUMERIC (18)    NULL,
    [WeekOffCompOffAvail_After_Days] NUMERIC (18)    NULL,
    [WeekdayCompOffAvail_After_Days] NUMERIC (18)    NULL,
    [Is_MobileWorkplan_Enable]       TINYINT         NOT NULL,
    [Is_MobileStock_Enable]          TINYINT         NOT NULL,
    [Is_VBA]                         TINYINT         NOT NULL,
