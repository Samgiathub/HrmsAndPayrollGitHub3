CREATE TABLE [dbo].[T0210_Retaining_Monthwise_Payment] (
    ...
    [Modify_Date]     DATETIME        CONSTRAINT [DF_T0210_Retaining_Monthwise_Payment_Modify_Date] DEFAULT (getdate()) NULL,
