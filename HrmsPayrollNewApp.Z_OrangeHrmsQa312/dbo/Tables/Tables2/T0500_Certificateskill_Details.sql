CREATE TABLE [dbo].[T0500_Certificateskill_Details] (
    ...
    CONSTRAINT [PK_T0500_Certificateskill_Detail1] PRIMARY KEY CLUSTERED ([Certi_Detail_Id] ASC) WITH (FILLFACTOR = 95),
    CONSTRAINT [unique_Certi_Id] UNIQUE NONCLUSTERED ([Certi_Id] ASC) WITH (FILLFACTOR = 95)
);
