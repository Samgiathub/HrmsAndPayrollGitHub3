...
public partial class V0080EmployeeMasterBackupDivyaraj07022024
{
    ...
    public string EmpSuperiorAlphaCode { get; set; } = null!;
    ...
    public byte ShowNewJoinEmployee { get; set; }
    ...
    public string EmpPhoto { get; set; } = null!;

    public string EmpSignature { get; set; } = null!;
