...
public partial class V0060EmpMasterApp
{
    ...
    public string Expr15 { get; set; } = null!;
    ...
    public byte Expr17 { get; set; }

    public byte Expr18 { get; set; }
    ...
    public long? RefEmpTranId { get; set; }
