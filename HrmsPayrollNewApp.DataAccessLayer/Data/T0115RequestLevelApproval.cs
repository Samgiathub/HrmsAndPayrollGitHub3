...
public partial class T0115RequestLevelApproval
{
    ...
    public string? RequestAprRemarks { get; set; }

    public decimal? RptLevel { get; set; }

    public string? RequestAprStatus { get; set; }
    ...
    public virtual T0090ChangeRequestApplication? Request { get; set; }
}
