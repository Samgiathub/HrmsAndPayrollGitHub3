...
public partial class T0090ChangeRequestApplication
{
    ...
    public virtual ICollection<T0115RequestLevelApproval> T0115RequestLevelApprovals { get; set; } = new List<T0115RequestLevelApproval>();
}
